...
\r\f \v\uFEFF`];function ci(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var i in t)if(t[i])r=r?r+" "+i:i;else if(r.length)for(var s=i.length,l=0;(l=r.indexOf(i,l))>=0;){var f=l+s;(l===0||lr.includes(r[l-1]))&&(f===r.length||lr.includes(r[f]))?r=(l===0?"":r.substring(0,l))+r.substring(f+1):l=f}}return r===""?null:r}function cr(e,n=!1){var t=n?" !important;":";",r="";for(var i in e){var s=e[i];s!=null&&s!==""&&(r+=" "+i+": "+s+t)}return r}function ct(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var t="",r,i;if(Array.isArray(n)?(r=n[0],i=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];r&&a.push(...Object.keys(r).map(ct)),i&&a.push(...Object.keys(i).map(ct));var c=0,p=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&p===-1)p=_;else if(u===";"||_===F-1){if(p!==-1){var g=ct(e.substring(c,p).trim());if(!a.includes(g)){u!==";"&&_++;var v=e.substring(c,_).trim();t+=" "+v+";"}}c=_+1,p=-1}}}}return r&&(t+=cr(r)),i&&(t+=cr(i,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function It(e,n,t,r,i,s){var l=e.__className;if(l!==t||l===void 0){var f=ci(t,r,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=t}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function ut(e,n={},t,r){for(var i in t){var s=t[i];n[i]!==s&&(t[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,r))}}function fi(e,n,t,r){var i=e.__style;if(i!==n){var s=ui(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(ut(e,t==null?void 0:t[0],r[0]),ut(e,t==null?void 0:t[1],r[1],"important")):ut(e,t,r));return r}const fn=Symbol("class"),cn=Symbol("style"),Kr=Symbol("is custom element"),Zr=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function yt(e,n,t,r){var i=Gr(e);i[n]!==(i[n]=t)&&(n==="loading"&&(e[Xo]=t),t==null?e.removeAttribute(n):typeof t!="string"&&Wr(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function _i(e,n,t,r,i=!1){var s=Gr(e),l=s[Kr],f=!s[Zr],a=n||{},c=e.tagName==="OPTION";for(var p in n)p in t||(t[p]=null);t.class?t.class=Hr(t.class):t.class=null,t[cn]&&(t.style??(t.style=null));var _=Wr(e);for(const M in t){let D=t[M];if(c&&M==="value"&&D==null){e.value=e.__value="",a[M]=D;continue}if(M==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";It(e,u,D,r,n==null?void 0:n[fn],t[fn]),a[M]=D,a[fn]=t[fn];continue}if(M==="style"){fi(e,D,n==null?void 0:n[cn],t[cn]),a[M]=D,a[cn]=t[cn];continue}var g=a[M];if(D!==g){a[M]=D;var v=M[0]+M[1];if(v!=="$$")if(v==="on"){const x={},ee="$$"+M;let S=M.slice(2);var F=qs(S);if(Bs(S)&&(S=S.slice(0,-7),x.capture=!0),!F&&g){if(D!=null)continue;e.removeEventListener(S,a[ee],x),a[ee]=null}if(D!=null)if(F)e[`__${S}`]=D,Xs([S]);else{let $=function(Y){a[M].call(this,Y)};var U=$;a[ee]=Ws(S,e,$,x)}else F&&(e[`__${S}`]=void 0)}else if(M==="style")yt(e,M,D);else if(M==="autofocus")Zs(e,!!D);else if(!l&&(M==="__value"||M==="value"&&D!=null))e.value=e.__value=D;else if(M==="selected"&&c)di(e,D);else{var A=M;f||(A=Us(A));var z=A==="defaultValue"||A==="defaultChecked";if(D==null&&!l&&!z)if(s[M]=null,A==="value"||A==="checked"){let x=e;const ee=n===void 0;if(A==="value"){let S=x.defaultValue;x.removeAttribute(A),x.defaultValue=S,x.value=x.__value=ee?S:null}else{let S=x.defaultChecked;x.removeAttribute(A),x.defaultChecked=S,x.checked=ee?S:!1}}else e.removeAttribute(M);else z||_.includes(A)&&(l||typeof D!="string")?e[A]=D:typeof D!="function"&&yt(e,A,D)}}}for(let M of Object.getOwnPropertySymbols(t))M.description===hs&&ai(e,()=>t[M]);return a}function Gr(e){return e.__attributes??(e.__attributes={[Kr]:e.nodeName.includes("-"),[Zr]:e.namespaceURI===vs})}var ur=new Map;function Wr(e){var n=ur.get(e.nodeName);if(n)return n;ur.set(e.nodeName,n=[]);for(var t,r=e,i=Element.prototype;i!==r;){t=gr(r);for(var s in t)t[s].set&&n.push(s);r=Dt(r)}return n}function Lt(e=!1){const n=q,t=n.l.u;if(!t)return;let r=()=>gt(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});r=()=>O(l)}t.b.length&&xs(()=>{fr(n,r),dt(t.b)}),or(()=>{const i=Bn(()=>t.m.map(Ko));return()=>{for(const s of i)typeof s=="function"&&s()}}),t.a.length&&or(()=>{fr(n,r),dt(t.a)})}function fr(e,n){if(e.l.s)for(const t of e.l.s)O(t);n()}let Sn=!1;function mi(e){var n=Sn;try{return Sn=!1,[e(),Sn]}finally{Sn=n}}const pi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Er)),e.special[n](t),tr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),tr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},pi)}const gi={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let i=e.props[r];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const i=je(r,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===Ge||n===br)return!1;for(let t of e.props)if(ln(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(ln(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function vi(...e){return new Proxy({props:e},gi)}function dr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,t,r){var ee;var i=(t&fs)!==0,s=!vn||(t&ds)!==0,l=(t&_s)!==0,f=(t&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var p=Ge in e||br in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(p&&n in e&&(S=>e[n]=S)))||void 0,u=r,g=!0,v=!1,F=()=>(v=!0,g&&(g=!1,f?u=Bn(r):u=r),u);c===void 0&&r!==void 0&&(_&&s&&rs(),c=F(),_&&_(c));var A;if(s)A=()=>{var S=e[n];return S===void 0?F():(g=!0,v=!1,S)};else{var z=(i?mn:St)(()=>e[n]);z.f|=Go,A=()=>{var S=O(z);return S!==void 0&&(u=void 0),S===void 0?u:S}}if((t&Er)===0)return A;if(_){var U=e.$$legacy;return function(S,$){return arguments.length>0?((!s||!$||U||a)&&_($?A():S),S):A()}}var M=!1,D=Kn(c),x=mn(()=>{var S=A(),$=O(D);return M?(M=!1,$):D.v=S});return l&&O(x),i||(x.equals=Mt),function(S,$){if(arguments.length>0){const Y=$?O(x):s&&l?Ze(S):S;if(!x.equals(Y)){if(M=!0,ce(D,Y),v&&u!==void 0&&(u=Y),dr(x))return S;Bn(()=>O(x))}return S}return dr(x)?x.v:O(x)}}function hi(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function bi(){const e=q;return e===null&&Dr(),(n,t,r)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=qn(i)?i.slice():[i],f=hi(n,t,r);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){q===null&&Dr(),q.l===null&&ts(),wi(q).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var pr;typeof window<"u"&&((pr=window.__svelte??(window.__svelte={})).v??(pr.v=new Set)).add(Ei);ls();const Di={__category__:"External libraries",EnzymeForward:"error",EnzymeReverse:"wrong",FiniteDifferences:96.77707317073173,ForwardDiff:1.9672568088943678,MooncakeForward:23.75333735251055,MooncakeReverse:6.103938999964861,ReverseDiff:56.59219597550306,ReverseDiffCompiled:7.067059866357562,Zygote:751.0732491870914},Ri={__category__:"Distributions",EnzymeForward:3.4731075673243286,EnzymeReverse:2.487238386932108,FiniteDifferences:34.98953322643863,ForwardDiff:1.9958510457405205,MooncakeForward:3.8413077437467678,MooncakeReverse:3.3801806755878254,ReverseDiff:74.08970814132104,ReverseDiffCompiled:5.802941535159394,Zygote:3371.523906079607},xi={__category__:"Base Julia features",EnzymeForward:3.617028743615568,EnzymeReverse:1.792710913821068,FiniteDifferences:79.49681877266197,ForwardDiff:2.394931334493085,MooncakeForward:8.455520873606089,MooncakeReverse:4.659725185213918,ReverseDiff:57.73126544057096,ReverseDiffCompiled:"wrong",Zygote:6661.503380329539},Mi={__category__:"External libraries",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.42579351591709,ForwardDiff:"wrong",MooncakeForward:"error",MooncakeReverse:"wrong",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Ti={__category__:"DynamicPPL demo models",EnzymeForward:5.326556995019667,EnzymeReverse:3.687085258055318,FiniteDifferences:79.76353550634943,ForwardDiff:2.5240516735173224,MooncakeForward:8.083308577652858,MooncakeReverse:5.909608790600698,ReverseDiff:146.1012412723041,ReverseDiffCompiled:13.36318018898664,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:4.212372409269967,EnzymeReverse:2.9767009961168327,FiniteDifferences:65.00365202411716,ForwardDiff:2.1871301273026194,MooncakeForward:7.669428054909907,MooncakeReverse:5.386328300452615,ReverseDiff:104.16226988684345,ReverseDiffCompiled:9.686430419183404,Zygote:8525.380875481032},Si={__category__:"DynamicPPL demo models",EnzymeForward:5.035535264313003,EnzymeReverse:5.969699155905057,FiniteDifferences:85.22898895259404,ForwardDiff:1.6705884681225818,MooncakeForward:10.435956949552551,MooncakeReverse:4.9927400191674,ReverseDiff:69.66740497284938,ReverseDiffCompiled:6.322221588641158,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:4.04823747008051
zymeReverse:4.707007390594988,FiniteDifferences:1118.8692068889054,ForwardDiff:50.13371403976199,MooncakeForward:213.2206258331964,MooncakeReverse:4.60091540605519,ReverseDiff:2800.816151118569,ReverseDiffCompiled:342.0942028579434,Zygote:138.9806517694375},Xi={__category__:"DynamicPPL arXiV paper",EnzymeForward:149.58381534280178,EnzymeReverse:.9878294744530832,FiniteDifferences:2850.5953708210977,ForwardDiff:133.20729724344073,MooncakeForward:432.6383433629067,MooncakeReverse:4.060734581745467,ReverseDiff:150.18365908658086,ReverseDiffCompiled:21.90168963558174,Zygote:5387.647746716515},Ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:230.4644814733611,EnzymeReverse:4.553851709864711,FiniteDifferences:6371.851613606628,ForwardDiff:112.80077286979484,MooncakeForward:1391.4089682889232,MooncakeReverse:4.349320696833571,ReverseDiff:107.1660899653979,ReverseDiffCompiled:10.263872905380751,Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:3.62624425727412,EnzymeReverse:3.1381149709046023,FiniteDifferences:58.85841971112999,ForwardDiff:1.5564420302155832,MooncakeForward:6.856174181381793,MooncakeReverse:3.7266258569745103,ReverseDiff:65.94995945398026,ReverseDiffCompiled:6.906632884384585,Zygote:4985.825335371031},Qi={__category__:"External libraries",EnzymeForward:"error",EnzymeReverse:"wrong",FiniteDifferences:254.14121971595657,ForwardDiff:"wrong",MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Core Turing syntax",EnzymeForward:3.4303958368879033,EnzymeReverse:2.701305986274611,FiniteDifferences:69.67352491072947,ForwardDiff:1.2559799817368928,MooncakeForward:11.226050942224063,MooncakeReverse:4.457584862999434,ReverseDiff:48.00427046263345,ReverseDiffCompiled:4.494416134246786,Zygote:"error"},na={__category__:"Base Julia features",EnzymeForward:5.528492369612611,EnzymeReverse:19.336821228286144,FiniteDifferences:14.352639697467284,ForwardDiff:.9652413988390202,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ta={__category__:"Effect of model size",EnzymeForward:5.417376144032252,EnzymeReverse:2.3927063987844,FiniteDifferences:179.04401228249742,ForwardDiff:2.5366171637579558,MooncakeForward:28.032277960526315,MooncakeReverse:3.9279329992448684,ReverseDiff:54.04091678203354,ReverseDiffCompiled:4.560121146962804,Zygote:"error"},ra={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:4.678931927062057,FiniteDifferences:46.66039830933448,ForwardDiff:.943308129316375,MooncakeForward:18.916527908492,MooncakeReverse:10.706117111406142,ReverseDiff:19.427486434385262,ReverseDiffCompiled:1.3079535661783344,Zygote:827.8763293189661},oa={__category__:"Effect of model size",EnzymeForward:21.778948818626436,EnzymeReverse:4.443984261751916,FiniteDifferences:667.3643117562082,ForwardDiff:12.798500085222429,MooncakeForward:127.58920020376975,MooncakeReverse:3.910464919695689,ReverseDiff:51.70324648751875,ReverseDiffCompiled:4.420877521314202,Zygote:"error"},sa={__category__:"Effect of model size",EnzymeForward:52.677270395074395,EnzymeReverse:4.150816291459014,FiniteDifferences:1266.0298687584855,ForwardDiff:18.81333963410518,MooncakeForward:284.2373585542983,MooncakeReverse:3.8085719125868205,ReverseDiff:51.02669166524629,ReverseDiffCompiled:4.563311023084278,Zygote:"error"},ia={__category__:"Effect of model size",EnzymeForward:268.38344021124107,EnzymeReverse:4.3694817300521995,FiniteDifferences:6212.716909642032,ForwardDiff:74.78089675960814,MooncakeForward:1331.0140429236535,MooncakeReverse:3.6603515699153344,ReverseDiff:47.13536585365854,ReverseDiffCompiled:4.4231987929083365,Zygote:"error"},aa={__category__:"Distributions",EnzymeForward:3.0626349586801567,EnzymeReverse:2.7925701412281265,FiniteDifferences:29.400018558040273,ForwardDiff:1.8799885712179027,MooncakeForward:3.689265970270469,MooncakeReverse:3.777414012616907,ReverseDiff:71.24842284739982,ReverseDiffCompiled:6.011209219135592,Zygote:"error"},la={__category__:"Distributions",EnzymeForward:1.8673586347427409,EnzymeReverse:7.177666530445443,FiniteDifferences:20.29124643306877,ForwardDiff:1.2027481598679233,MooncakeForward:3.7090151894796866,MooncakeReverse:7.1731622036500085,ReverseDiff:41.77521080414068,ReverseDiffCompiled:3.6690726385300025,Zygote:"error"},ca={__category__:"Core Turing syntax",EnzymeForward:8.956825772335096,EnzymeReverse:4.727148232772174,FiniteDifferences:114.02018233233797,ForwardDiff:3.6974689483586283,MooncakeForward:8.55712242911489,MooncakeReverse:11.928569359557397,ReverseDiff:353.42784274695197,ReverseDiffCompiled:33.037512201924415,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:12.3563486700274,EnzymeReverse:5.651771527477282,FiniteDifferences:155.15333581811402,ForwardDiff:3.385319561159171,MooncakeForward:9.4416561423651,MooncakeReverse:11.514793068881568,ReverseDiff:313.7786124300191,ReverseDiffCompiled:25.451107963335886,Zygote:23186.74359975855},fa={__category__:"Core Turing syntax",EnzymeForward:3.654628603104213,EnzymeReverse:4.245562586664316,FiniteDifferences:77.05726013340174,ForwardDiff:1.7419889711520722,MooncakeForward:9.471361048818354,MooncakeReverse:4.859185881013378,ReverseDiff:65.18670076726343,ReverseDiffCompiled:5.37623619860462,Zygote:"error"},da={__category__:"Core Turing syntax",EnzymeForward:12.659181218329625,EnzymeReverse:5.700562675638325,FiniteDifferences:152.4701010839118,ForwardDiff:3.6981607307235365,MooncakeForward:9.543990376872184,MooncakeReverse:11.033964723880219,ReverseDiff:303.2407143353968,ReverseDiffCompiled:25.676994070760752,Zygote:39154.87480347972},_a={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:29.29185634800202,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:5.493099448772146,Zygote:3592.943007646559},ma={__category__:"Distributions",EnzymeForward:12.815607264926477,EnzymeReverse:4.035143977892344,FiniteDifferences:153.35740485204448,ForwardDiff:3.3227888444063014,MooncakeForward:10.124694289866374,MooncakeReverse:10.723800809360604,ReverseDiff:177.98609136428263,ReverseDiffCompiled:15.575905432002735,Zygote:18098.107084019768},pa={__category__:"External libraries",EnzymeForward:"wrong",EnzymeReverse:"wrong",FiniteDifferences:63.14191023060874,ForwardDiff:"wrong",MooncakeForward:"error",MooncakeReverse:"wrong",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ga={__category__:"PosteriorDB",EnzymeForward:6.752904000282455,EnzymeReverse:4.365312006590238,FiniteDifferences:167.5178896717649,ForwardDiff:3.750942115090816,MooncakeForward:28.546118721461188,MooncakeReverse:4.834008204769021,ReverseDiff:110.22850364345025,ReverseDiffCompiled:9.230294568363696,Zygote:"error"},va={__category__:"PosteriorDB",EnzymeForward:6.1766733026704195,EnzymeReverse:4.019430714163968,FiniteDifferences:180.5613467692517,ForwardDiff:3.817012925492319,MooncakeForward:28.807073288664782,MooncakeReverse:4.9211045231238355,ReverseDiff:107.26379947952336,ReverseDiffCompiled:8.661056982580455,Zygote:"error"},ha={__category__:"Core Turing syntax",EnzymeForward:6.6291744488138304,EnzymeReverse:3.4077779521281872,FiniteDifferences:99.72689624503182,ForwardDiff:2.204993092160129,MooncakeForward:9.476681292874357,MooncakeReverse:6.8681231469955115,ReverseDiff:117.6161545215101,ReverseDiffCompiled:10.003984449913975,Zygote:14697.824939402099},ba={__category__:"Distributions",EnzymeForward:8.613464855541181,EnzymeReverse:9.614696837389422,FiniteDifferences:45.64124604593591,ForwardDiff:1.0200680630109111,MooncakeForward:16.211290855067677,MooncakeReverse:10.475298187452704,ReverseDiff:32.905941295188185,ReverseDiffCompiled:2.6846758349705304,Zygote:408.53601577636306},ya={__category__:"Core Turing syntax",EnzymeForward:5.006220816833146,EnzymeReverse:3.688859101638952,FiniteDifferences:73.94252639670805,ForwardDiff:1.6090573963719095,MooncakeForward:7.698080378250591,MooncakeReverse:5.656898001039418,ReverseDiff:132.95718495406481,ReverseDiffCompiled:11.281682618355838,Zygote:"error"},wa={__category__:"Base Julia features",EnzymeForward:6.611763472426086,EnzymeReverse:3.396392106969084,FiniteDifferences:81.0355070944293,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Ea={abstractgps:Di,assume_beta:Ri,control_flow:xi,delaydiffeq:Mi,demo_assume_dot_observe:Ti,demo_assume_dot_observe_literal:Fi,demo_assume_index_observe:Si,demo_assume_matrix_observe_matrix_index:Ni,demo_assume_multivariate_observe:Ci,demo_assume_multivariate_observe_literal:Ai,demo_assume_observe_literal:ki,demo_assume_submodel_observe_index_literal:Oi,assume_dirichlet:Ii,demo_dot_assume_observe:Li,demo_dot_assume_observe_index:Pi,demo_dot_assume_observe_index_literal:zi,demo_dot_assume_observe_matrix_index:Vi,demo_dot_assume_observe_submodel:Bi,dot_assume:ji,dot_observe:qi,dppl_gauss_unknown:$i,dppl_hier_poisson:Ui,dppl_high_dim_gauss:Hi,assume_lkjcholu:Ki,dppl_hmm_semisup:Zi,dppl_lda:Gi,dppl_logistic_regression:Wi,dppl_naive_bayes:Xi,dppl_sto_volatility:Ji,dynamic_constraint:Yi,lux_nn:Qi,multiple_constraints_same_var:ea,multithreaded:na,n010:ta,assume_mvnormal:ra,n050:oa,n100:sa,n500:ia,observe_bernoulli:aa,observe_categorical:la,observe_index:ca,observe_literal:ua,observe_multivariate:fa,observe_submodel:da,observe_von_mises:_a,assume_normal:ma,ordinarydiffeq:pa,pdb_eight_schools_centered:ga,pdb_eight_schools_noncentered:va,assume_submodel:ha,assume_wishart:ba,broadcast_macro:ya,call_C:wa},Da=`#=
