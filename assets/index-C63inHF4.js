...
\r\f \v\uFEFF`];function ci(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var i in t)if(t[i])r=r?r+" "+i:i;else if(r.length)for(var s=i.length,l=0;(l=r.indexOf(i,l))>=0;){var u=l+s;(l===0||lr.includes(r[l-1]))&&(u===r.length||lr.includes(r[u]))?r=(l===0?"":r.substring(0,l))+r.substring(u+1):l=u}}return r===""?null:r}function cr(e,n=!1){var t=n?" !important;":";",r="";for(var i in e){var s=e[i];s!=null&&s!==""&&(r+=" "+i+": "+s+t)}return r}function lt(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function fi(e,n){if(n){var t="",r,i;if(Array.isArray(n)?(r=n[0],i=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,u=!1,a=[];r&&a.push(...Object.keys(r).map(lt)),i&&a.push(...Object.keys(i).map(lt));var c=0,p=-1;const S=e.length;for(var _=0;_<S;_++){var f=e[_];if(u?f==="/"&&e[_-1]==="*"&&(u=!1):s?s===f&&(s=!1):f==="/"&&e[_+1]==="*"?u=!0:f==='"'||f==="'"?s=f:f==="("?l++:f===")"&&l--,!u&&s===!1&&l===0){if(f===":"&&p===-1)p=_;else if(f===";"||_===S-1){if(p!==-1){var v=lt(e.substring(c,p).trim());if(!a.includes(v)){f!==";"&&_++;var g=e.substring(c,_).trim();t+=" "+g+";"}}c=_+1,p=-1}}}}return r&&(t+=cr(r)),i&&(t+=cr(i,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function It(e,n,t,r,i,s){var l=e.__className;if(l!==t||l===void 0){var u=ci(t,r,s);u==null?e.removeAttribute("class"):n?e.className=u:e.setAttribute("class",u),e.__className=t}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function ct(e,n={},t,r){for(var i in t){var s=t[i];n[i]!==s&&(t[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,r))}}function ui(e,n,t,r){var i=e.__style;if(i!==n){var s=fi(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(ct(e,t==null?void 0:t[0],r[0]),ct(e,t==null?void 0:t[1],r[1],"important")):ct(e,t,r));return r}const un=Symbol("class"),cn=Symbol("style"),Kr=Symbol("is custom element"),Zr=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function bt(e,n,t,r){var i=Gr(e);i[n]!==(i[n]=t)&&(n==="loading"&&(e[Xo]=t),t==null?e.removeAttribute(n):typeof t!="string"&&Wr(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function _i(e,n,t,r,i=!1){var s=Gr(e),l=s[Kr],u=!s[Zr],a=n||{},c=e.tagName==="OPTION";for(var p in n)p in t||(t[p]=null);t.class?t.class=Hr(t.class):t.class=null,t[cn]&&(t.style??(t.style=null));var _=Wr(e);for(const x in t){let D=t[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var f=e.namespaceURI==="http://www.w3.org/1999/xhtml";It(e,f,D,r,n==null?void 0:n[un],t[un]),a[x]=D,a[un]=t[un];continue}if(x==="style"){ui(e,D,n==null?void 0:n[cn],t[cn]),a[x]=D,a[cn]=t[cn];continue}var v=a[x];if(D!==v){a[x]=D;var g=x[0]+x[1];if(g!=="$$")if(g==="on"){const M={},ee="$$"+x;let F=x.slice(2);var S=Us(F);if(Vs(F)&&(F=F.slice(0,-7),M.capture=!0),!S&&v){if(D!=null)continue;e.removeEventListener(F,a[ee],M),a[ee]=null}if(D!=null)if(S)e[`__${F}`]=D,Xs([F]);else{let $=function(Y){a[x].call(this,Y)};var q=$;a[ee]=Ws(F,e,$,M)}else S&&(e[`__${F}`]=void 0)}else if(x==="style")bt(e,x,D);else if(x==="autofocus")Zs(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var A=x;u||(A=qs(A));var z=A==="defaultValue"||A==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,A==="value"||A==="checked"){let M=e;const ee=n===void 0;if(A==="value"){let F=M.defaultValue;M.removeAttribute(A),M.defaultValue=F,M.value=M.__value=ee?F:null}else{let F=M.defaultChecked;M.removeAttribute(A),M.defaultChecked=F,M.checked=ee?F:!1}}else e.removeAttribute(x);else z||_.includes(A)&&(l||typeof D!="string")?e[A]=D:typeof D!="function"&&bt(e,A,D)}}}for(let x of Object.getOwnPropertySymbols(t))x.description===hs&&ai(e,()=>t[x]);return a}function Gr(e){return e.__attributes??(e.__attributes={[Kr]:e.nodeName.includes("-"),[Zr]:e.namespaceURI===gs})}var fr=new Map;function Wr(e){var n=fr.get(e.nodeName);if(n)return n;fr.set(e.nodeName,n=[]);for(var t,r=e,i=Element.prototype;i!==r;){t=vr(r);for(var s in t)t[s].set&&n.push(s);r=Et(r)}return n}function Lt(e=!1){const n=U,t=n.l.u;if(!t)return;let r=()=>pt(n.s);if(e){let i=0,s={};const l=mn(()=>{let u=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],u=!0);return u&&i++,i});r=()=>I(l)}t.b.length&&Ms(()=>{ur(n,r),ut(t.b)}),or(()=>{const i=Vn(()=>t.m.map(Ko));return()=>{for(const s of i)typeof s=="function"&&s()}}),t.a.length&&or(()=>{ur(n,r),ut(t.a)})}function ur(e,n){if(e.l.s)for(const t of e.l.s)I(t);n()}let Fn=!1;function mi(e){var n=Fn;try{return Fn=!1,[e(),Fn]}finally{Fn=n}}const pi={get(e,n){if(!e.exclude.includes(n))return I(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Ve({get[n](){return e.props[n]}},n,Er)),e.special[n](t),tr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),tr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},pi)}const vi={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let i=e.props[r];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const i=je(r,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===Ge||n===br)return!1;for(let t of e.props)if(ln(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(ln(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function gi(...e){return new Proxy({props:e},vi)}function dr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Ve(e,n,t,r){var ee;var i=(t&us)!==0,s=!gn||(t&ds)!==0,l=(t&_s)!==0,u=(t&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var p=Ge in e||br in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(p&&n in e&&(F=>e[n]=F)))||void 0,f=r,v=!0,g=!1,S=()=>(g=!0,v&&(v=!1,u?f=Vn(r):f=r),f);c===void 0&&r!==void 0&&(_&&s&&rs(),c=S(),_&&_(c));var A;if(s)A=()=>{var F=e[n];return F===void 0?S():(v=!0,g=!1,F)};else{var z=(i?mn:St)(()=>e[n]);z.f|=Go,A=()=>{var F=I(z);return F!==void 0&&(f=void 0),F===void 0?f:F}}if((t&Er)===0)return A;if(_){var q=e.$$legacy;return function(F,$){return arguments.length>0?((!s||!$||q||a)&&_($?A():F),F):A()}}var x=!1,D=Ft(c),M=mn(()=>{var F=A(),$=I(D);return x?(x=!1,$):D.v=F});return l&&I(M),i||(M.equals=Mt),function(F,$){if(arguments.length>0){const Y=$?I(M):s&&l?Ze(F):F;if(!M.equals(Y)){if(x=!0,ue(D,Y),g&&f!==void 0&&(f=Y),dr(M))return F;Vn(()=>I(M))}return F}return dr(M)?M.v:I(M)}}function hi(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function bi(){const e=U;return e===null&&Dr(),(n,t,r)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=Un(i)?i.slice():[i],u=hi(n,t,r);for(const a of l)a.call(e.x,u);return!u.defaultPrevented}return!0}}function yi(e){U===null&&Dr(),U.l===null&&ts(),wi(U).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var pr;typeof window<"u"&&((pr=window.__svelte??(window.__svelte={})).v??(pr.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:2.671419291559552,EnzymeReverse:2.9502633673902907,FiniteDifferences:17.037687426499414,ForwardDiff:1.6022397906510686,MooncakeForward:9.463667214778015,MooncakeReverse:5.599729726183759,ReverseDiff:31.79716061769828,ReverseDiffCompiled:2.7692528236667084,Zygote:1669.8053375989225},Ri={__category__:"Distributions",EnzymeForward:2.5675580560764972,EnzymeReverse:2.6903517962329166,FiniteDifferences:21.460621497707592,ForwardDiff:1.329669326504673,MooncakeForward:8.903607749559685,MooncakeReverse:7.062011087667693,ReverseDiff:30.369159508169112,ReverseDiffCompiled:2.862465512610787,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:3.050002573574537,EnzymeReverse:2.668127283145907,FiniteDifferences:37.08311219615752,ForwardDiff:1.3945943994196561,MooncakeForward:20.07621529624508,MooncakeReverse:6.479541778462826,ReverseDiff:30.41096242923314,ReverseDiffCompiled:2.984311144974718,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:2.899534611059268,EnzymeReverse:2.53818244287923,FiniteDifferences:36.832004512974805,ForwardDiff:1.3147389033942558,MooncakeForward:19.18823052247336,MooncakeReverse:6.237572604497024,ReverseDiff:28.014899287049214,ReverseDiffCompiled:2.9085909724308854,Zygote:2059.994693452099},Ti={__category__:"DynamicPPL demo models",EnzymeForward:3.556689479815681,EnzymeReverse:3.219907584937496,FiniteDifferences:60.130129273456156,ForwardDiff:1.2636632067097804,MooncakeForward:24.45928862224127,MooncakeReverse:4.532943643179364,ReverseDiff:22.73298429319372,ReverseDiffCompiled:2.185706798878638,Zygote:"error"},Si={__category__:"DynamicPPL demo models",EnzymeForward:3.9659931544661586,EnzymeReverse:4.2030434653385464,FiniteDifferences:64.43149942227357,ForwardDiff:1.4648662274710387,MooncakeForward:39.86514765243255,MooncakeReverse:7.238610405016098,ReverseDiff:50.2596685082873,ReverseDiffCompiled:2.889306369752528,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",Enzym
686799,MooncakeReverse:5.116167915424978,ReverseDiff:63.68322427793619,ReverseDiffCompiled:7.00146796780636,Zygote:173.72965757295748},Gi={__category__:"DynamicPPL arXiV paper",EnzymeForward:219.93371576778944,EnzymeReverse:1.6941368840648878,FiniteDifferences:2761.093768622812,ForwardDiff:141.11356840120882,MooncakeForward:436.0030901622797,MooncakeReverse:8.949934839981402,ReverseDiff:254.7134944213525,ReverseDiffCompiled:18.94881700427538,Zygote:4826.03694745399},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:234.7304829745097,EnzymeReverse:1.7476637828556334,FiniteDifferences:6787.63059476015,ForwardDiff:86.19254307542262,MooncakeForward:1074.0379435019267,MooncakeReverse:3.2773787107422647,ReverseDiff:32.12444663059517,ReverseDiffCompiled:3.269472407815819,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:2.638955043417726,EnzymeReverse:2.427293620837849,FiniteDifferences:36.2326812553257,ForwardDiff:1.2741614423648926,MooncakeForward:18.21957512989997,MooncakeReverse:5.66297674491173,ReverseDiff:28.387371370077044,ReverseDiffCompiled:2.5304943929063746,Zygote:1569.6046618616776},Ji={__category__:"Integrations with other packages",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.377847489901068,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:3.0466505885317305,EnzymeReverse:2.2958382924832,FiniteDifferences:59.50438679782748,ForwardDiff:1.2622674925404018,MooncakeForward:23.072081145241345,MooncakeReverse:12.067728266812466,ReverseDiff:29.206371287473047,ReverseDiffCompiled:2.315473255711053,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:2.854905047722129,EnzymeReverse:12.318185331169333,FiniteDifferences:13.565590829506789,ForwardDiff:1.0246143540548909,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:4.108935300954461,EnzymeReverse:1.6864327200639933,FiniteDifferences:141.97551278893854,ForwardDiff:1.697406642634655,MooncakeForward:34.81291806020067,MooncakeReverse:4.480406487088467,ReverseDiff:19.234551401540465,ReverseDiffCompiled:1.8548051587851895,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:18.079220255761975,EnzymeReverse:1.6141216949025765,FiniteDifferences:634.8655465301732,ForwardDiff:8.923491717604476,MooncakeForward:119.36074711158687,MooncakeReverse:4.173770674803252,ReverseDiff:20.295945945945945,ReverseDiffCompiled:1.839275147928994,Zygote:"error"},ta={__category__:"Effect of model size",EnzymeForward:36.803364485981305,EnzymeReverse:1.5470915153760654,FiniteDifferences:1238.0824035941596,ForwardDiff:20.100074156470153,MooncakeForward:229.6552760045062,MooncakeReverse:4.1150550795593634,ReverseDiff:19.897184284720442,ReverseDiffCompiled:1.8194051751905802,Zygote:"error"},ra={__category__:"Distributions",EnzymeForward:3.0150532598468294,EnzymeReverse:2.2960401623808866,FiniteDifferences:28.302474597359506,ForwardDiff:1.4091772536254767,MooncakeForward:11.826053422332324,MooncakeReverse:6.448824751760694,ReverseDiff:20.985067974147537,ReverseDiffCompiled:2.241692528953145,Zygote:2068.317697742547},oa={__category__:"Effect of model size",EnzymeForward:181.3319314417399,EnzymeReverse:1.5360418168709444,FiniteDifferences:6724.288546034835,ForwardDiff:79.92937697103577,MooncakeForward:1124.9786709830828,MooncakeReverse:4.084428118697781,ReverseDiff:20.05005763688761,ReverseDiffCompiled:1.8960569866167796,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:2.6286127403395145,EnzymeReverse:2.8824580297395683,FiniteDifferences:22.515455950540957,ForwardDiff:1.6642393901467742,MooncakeForward:10.236242003164339,MooncakeReverse:5.848358615987728,ReverseDiff:33.09225757260692,ReverseDiffCompiled:3.237775688151821,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:2.0095351609058403,EnzymeReverse:6.074111692604324,FiniteDifferences:18.33907284768212,ForwardDiff:1.2643326680307463,MooncakeForward:6.819092916595889,MooncakeReverse:7.561689875097042,ReverseDiff:12.23508668311156,ReverseDiffCompiled:2.5191166629489183,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:3.07502982785069,EnzymeReverse:2.5071370479178077,FiniteDifferences:28.04235615502817,ForwardDiff:1.636840599547317,MooncakeForward:12.470596552487274,MooncakeReverse:7.160768668369604,ReverseDiff:53.36003654668322,ReverseDiffCompiled:5.088524026610727,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:2.933193809201804,EnzymeReverse:2.439487292601034,FiniteDifferences:28.97516509837468,ForwardDiff:1.5163410147844798,MooncakeForward:12.394367007084368,MooncakeReverse:7.341835675226691,ReverseDiff:36.167472447494276,ReverseDiffCompiled:3.458544165861239,Zygote:2789.8466138228346},ca={__category__:"Core Turing syntax",EnzymeForward:2.7920781027926806,EnzymeReverse:2.600553562806098,FiniteDifferences:52.28162443007104,ForwardDiff:1.4058171501074965,MooncakeForward:18.891450064395272,MooncakeReverse:5.445798845378034,ReverseDiff:24.76224628346621,ReverseDiffCompiled:2.405619846618334,Zygote:"error"},fa={__category__:"Core Turing syntax",EnzymeForward:2.597113494326038,EnzymeReverse:2.260774370395751,FiniteDifferences:24.86599023240148,ForwardDiff:1.4600809248242925,MooncakeForward:9.72417004897667,MooncakeReverse:5.614996213946444,ReverseDiff:27.625189722463137,ReverseDiffCompiled:2.516957980954073,Zygote:3420.0094787557164},ua={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.95278677347878,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:2.9188956506790444,Zygote:1980.1881980640358},da={__category__:"Integrations with other packages",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:62.589328329659516,ForwardDiff:5.414610755923279,MooncakeForward:"error",MooncakeReverse:57.101727640570175,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:5.672739611609939,EnzymeReverse:2.3159237026249424,FiniteDifferences:135.43873292191344,ForwardDiff:1.8108683109764891,MooncakeForward:50.07276962899051,MooncakeReverse:5.181630231554724,ReverseDiff:30.258852476553862,ReverseDiffCompiled:3.2079676136567192,Zygote:"error"},ma={__category__:"Core Turing syntax",EnzymeForward:2.3242896627971255,EnzymeReverse:1.8433087433771898,FiniteDifferences:35.69830411037655,ForwardDiff:1.2893299039998305,MooncakeForward:16.491944203193956,MooncakeReverse:4.694168129510435,ReverseDiff:12.424324517002924,ReverseDiffCompiled:1.289883841938414,Zygote:1931.1155923790056},pa={__category__:"PosteriorDB",EnzymeForward:5.745181975125956,EnzymeReverse:2.255936129726152,FiniteDifferences:137.5536241724665,ForwardDiff:1.8088793360552053,MooncakeForward:51.25119567477646,MooncakeReverse:5.5967993754879,ReverseDiff:30.1421950820566,ReverseDiffCompiled:2.568538007407136,Zygote:"error"},va={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:10.748011384368384,FiniteDifferences:44.022308843490066,ForwardDiff:1.1199001660003274,MooncakeForward:19.79517268032182,MooncakeReverse:11.822200732195897,ReverseDiff:15.837653027462224,ReverseDiffCompiled:4.09461319246542,Zygote:412.35675140543793},ga={__category__:"Core Turing syntax",EnzymeForward:3.0813220265275056,EnzymeReverse:2.768834010628321,FiniteDifferences:23.79142620309983,ForwardDiff:1.4047619047619047,MooncakeForward:20.709437598953674,MooncakeReverse:6.386634990253412,ReverseDiff:29.077280478891872,ReverseDiffCompiled:2.79908660000692,Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:3.0942616847158435,EnzymeReverse:2.233584755855498,FiniteDifferences:27.24164997453743,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ba={__category__:"Base Julia features",EnzymeForward:2.898844218516546,EnzymeReverse:2.6193329666811684,FiniteDifferences:40.95267296731837,ForwardDiff:1.5892352509404533,MooncakeForward:23.581963075147847,MooncakeReverse:7.18750603989784,ReverseDiff:19.555861499277206,ReverseDiffCompiled:"wrong",Zygote:1858.3570867754488},ya={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Si,demo_assume_multivariate_observe:Fi,demo_assume_multivariate_observe_literal:Ni,demo_assume_observe_literal:Ci,demo_assume_submodel_observe_index_literal:Ai,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Oi,assume_lkjcholu:Ii,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Bi,dot_observe:Vi,dppl_gauss_unknown:ji,dppl_hier_poisson:Ui,dppl_high_dim_gauss:$i,dppl_hmm_semisup:qi,dppl_lda:Hi,assume_mvnormal:Ki,dppl_logistic_regression:Zi,dppl_naive_bayes:Gi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ta,assume_normal:ra,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:fa,observe_von_mises:ua,ordinary_diffeq:da,pdb_eight_schools_centered:_a,assume_submodel:ma,pdb_eight_schools_noncentered:pa,assume_wishart:va,broadcast_macro:ga,call_C:ha,control_flow:ba},wa=`@model function assume_beta()
    a ~ Beta(2, 2)
end
