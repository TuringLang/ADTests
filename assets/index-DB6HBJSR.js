...
\r\f \v\uFEFF`];function ci(e,n,r){var t=e==null?"":""+e;if(n&&(t=t?t+" "+n:n),r){for(var i in r)if(r[i])t=t?t+" "+i:i;else if(t.length)for(var s=i.length,l=0;(l=t.indexOf(i,l))>=0;){var f=l+s;(l===0||lt.includes(t[l-1]))&&(f===t.length||lt.includes(t[f]))?t=(l===0?"":t.substring(0,l))+t.substring(f+1):l=f}}return t===""?null:t}function ct(e,n=!1){var r=n?" !important;":";",t="";for(var i in e){var s=e[i];s!=null&&s!==""&&(t+=" "+i+": "+s+r)}return t}function lr(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var r="",t,i;if(Array.isArray(n)?(t=n[0],i=n[1]):t=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];t&&a.push(...Object.keys(t).map(lr)),i&&a.push(...Object.keys(i).map(lr));var c=0,g=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&g===-1)g=_;else if(u===";"||_===F-1){if(g!==-1){var v=lr(e.substring(c,g).trim());if(!a.includes(v)){u!==";"&&_++;var p=e.substring(c,_).trim();r+=" "+p+";"}}c=_+1,g=-1}}}}return t&&(r+=ct(t)),i&&(r+=ct(i,!0)),r=r.trim(),r===""?null:r}return e==null?null:String(e)}function Or(e,n,r,t,i,s){var l=e.__className;if(l!==r||l===void 0){var f=ci(r,t,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=r}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function cr(e,n={},r,t){for(var i in r){var s=r[i];n[i]!==s&&(r[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,t))}}function fi(e,n,r,t){var i=e.__style;if(i!==n){var s=ui(n,t);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else t&&(Array.isArray(t)?(cr(e,r==null?void 0:r[0],t[0]),cr(e,r==null?void 0:r[1],t[1],"important")):cr(e,r,t));return t}const fn=Symbol("class"),cn=Symbol("style"),Gt=Symbol("is custom element"),Kt=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function br(e,n,r,t){var i=qt(e);i[n]!==(i[n]=r)&&(n==="loading"&&(e[Xo]=r),r==null?e.removeAttribute(n):typeof r!="string"&&Wt(e).includes(n)?e[n]=r:e.setAttribute(n,r))}function _i(e,n,r,t,i=!1){var s=qt(e),l=s[Gt],f=!s[Kt],a=n||{},c=e.tagName==="OPTION";for(var g in n)g in r||(r[g]=null);r.class?r.class=Zt(r.class):r.class=null,r[cn]&&(r.style??(r.style=null));var _=Wt(e);for(const x in r){let D=r[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";Or(e,u,D,t,n==null?void 0:n[fn],r[fn]),a[x]=D,a[fn]=r[fn];continue}if(x==="style"){fi(e,D,n==null?void 0:n[cn],r[cn]),a[x]=D,a[cn]=r[cn];continue}var v=a[x];if(D!==v){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let N=x.slice(2);var F=$s(N);if(Bs(N)&&(N=N.slice(0,-7),M.capture=!0),!F&&v){if(D!=null)continue;e.removeEventListener(N,a[ee],M),a[ee]=null}if(D!=null)if(F)e[`__${N}`]=D,Xs([N]);else{let U=function(Y){a[x].call(this,Y)};var H=U;a[ee]=Ws(N,e,U,M)}else F&&(e[`__${N}`]=void 0)}else if(x==="style")br(e,x,D);else if(x==="autofocus")Ks(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var C=x;f||(C=Hs(C));var z=C==="defaultValue"||C==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,C==="value"||C==="checked"){let M=e;const ee=n===void 0;if(C==="value"){let N=M.defaultValue;M.removeAttribute(C),M.defaultValue=N,M.value=M.__value=ee?N:null}else{let N=M.defaultChecked;M.removeAttribute(C),M.defaultChecked=N,M.checked=ee?N:!1}}else e.removeAttribute(x);else z||_.includes(C)&&(l||typeof D!="string")?e[C]=D:typeof D!="function"&&br(e,C,D)}}}for(let x of Object.getOwnPropertySymbols(r))x.description===hs&&ai(e,()=>r[x]);return a}function qt(e){return e.__attributes??(e.__attributes={[Gt]:e.nodeName.includes("-"),[Kt]:e.namespaceURI===ps})}var ut=new Map;function Wt(e){var n=ut.get(e.nodeName);if(n)return n;ut.set(e.nodeName,n=[]);for(var r,t=e,i=Element.prototype;i!==t;){r=vt(t);for(var s in r)r[s].set&&n.push(s);t=Er(t)}return n}function Lr(e=!1){const n=$,r=n.l.u;if(!r)return;let t=()=>gr(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});t=()=>O(l)}r.b.length&&Ms(()=>{ft(n,t),fr(r.b)}),ot(()=>{const i=Bn(()=>r.m.map(Go));return()=>{for(const s of i)typeof s=="function"&&s()}}),r.a.length&&ot(()=>{ft(n,t),fr(r.a)})}function ft(e,n){if(e.l.s)for(const r of e.l.s)O(r);n()}let Nn=!1;function mi(e){var n=Nn;try{return Nn=!1,[e(),Nn]}finally{Nn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,r){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Et)),e.special[n](r),rt(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),rt(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},gi)}const vi={get(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t)return t[n]}},set(e,n,r){let t=e.props.length;for(;t--;){let i=e.props[t];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(r),!0}return!1},getOwnPropertyDescriptor(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t){const i=je(t,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===qe||n===bt)return!1;for(let r of e.props)if(ln(r)&&(r=r()),r!=null&&n in r)return!0;return!1},ownKeys(e){const n=[];for(let r of e.props)if(ln(r)&&(r=r()),!!r){for(const t in r)n.includes(t)||n.push(t);for(const t of Object.getOwnPropertySymbols(r))n.includes(t)||n.push(t)}return n}};function pi(...e){return new Proxy({props:e},vi)}function dt(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,r,t){var ee;var i=(r&fs)!==0,s=!pn||(r&ds)!==0,l=(r&_s)!==0,f=(r&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var g=qe in e||bt in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(g&&n in e&&(N=>e[n]=N)))||void 0,u=t,v=!0,p=!1,F=()=>(p=!0,v&&(v=!1,f?u=Bn(t):u=t),u);c===void 0&&t!==void 0&&(_&&s&&ts(),c=F(),_&&_(c));var C;if(s)C=()=>{var N=e[n];return N===void 0?F():(v=!0,p=!1,N)};else{var z=(i?mn:Fr)(()=>e[n]);z.f|=qo,C=()=>{var N=O(z);return N!==void 0&&(u=void 0),N===void 0?u:N}}if((r&Et)===0)return C;if(_){var H=e.$$legacy;return function(N,U){return arguments.length>0?((!s||!U||H||a)&&_(U?C():N),N):C()}}var x=!1,D=Nr(c),M=mn(()=>{var N=C(),U=O(D);return x?(x=!1,U):D.v=N});return l&&O(M),i||(M.equals=Mr),function(N,U){if(arguments.length>0){const Y=U?O(M):s&&l?Ke(N):N;if(!M.equals(Y)){if(x=!0,fe(D,Y),p&&u!==void 0&&(u=Y),dt(M))return N;Bn(()=>O(M))}return N}return dt(M)?M.v:O(M)}}function hi(e,n,{bubbles:r=!1,cancelable:t=!1}={}){return new CustomEvent(e,{detail:n,bubbles:r,cancelable:t})}function bi(){const e=$;return e===null&&Dt(),(n,r,t)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=$n(i)?i.slice():[i],f=hi(n,r,t);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){$===null&&Dt(),$.l===null&&rs(),wi($).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var gt;typeof window<"u"&&((gt=window.__svelte??(window.__svelte={})).v??(gt.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.126919469149527,ForwardDiff:1.641057447890188,MooncakeForward:13.581333683576645,MooncakeReverse:5.620643880528178,ReverseDiff:32.06300458342058,ReverseDiffCompiled:2.7575572519083966,Zygote:1842.6897292504943},Ri={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.603515337075468,ForwardDiff:1.3319384088964927,MooncakeForward:11.812032936617769,MooncakeReverse:7.390881688018085,ReverseDiff:33.36240474174428,ReverseDiffCompiled:2.8113298322886666,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.112592848505784,ForwardDiff:1.3915136809656794,MooncakeForward:24.18103913873186,MooncakeReverse:6.448801144492132,ReverseDiff:28.166708810461298,ReverseDiffCompiled:2.9937638580931263,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.912386187940214,ForwardDiff:1.3633862433862434,MooncakeForward:23.12029041694569,MooncakeReverse:6.3852852046492,ReverseDiff:28.217228464419478,ReverseDiffCompiled:2.814767567864149,Zygote:2234.200594456349},Ti={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.371230791533776,ForwardDiff:1.359749568841621,MooncakeForward:29.20071600902794,MooncakeReverse:5.277103348697728,ReverseDiff:21.39391185824625,ReverseDiffCompiled:2.1350054420382714,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:61.51702876210511,ForwardDiff:1.4661843295686408,MooncakeForward:45.801323540106175,MooncakeReverse:7.455375405337989,ReverseDiff:49.77983859549766,ReverseDiffCompiled:2.7290865974323326,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.83353101861835,ForwardDiff:1.385365006598597,MooncakeForward:41.37074842743606,MooncakeReverse:7.261652271730633,ReverseDiff:50.90769230769231,ReverseDiffCompiled:2.8430275006084207,Zygote:1635.9220367709368},Si={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:64.18964757709252,ForwardDiff:1.400526816594483,MooncakeForward:41.71412815705305,MooncakeReverse:7.228310765021034,ReverseDiff:51.040912396188155,ReverseDiffCompiled:2.8027774927313156,Zygote:1458.3611283890089},Ai={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.41604255616994,ForwardDiff:1.3996278098077695,MooncakeForward:25.890015232844917,MooncakeReverse:6.394562468386444,ReverseDiff:30.91234328461592,ReverseDiffCompiled:3.2787105671435963,Zygote:2182.0834091157103},Ci={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.505953209859356,ForwardDiff:1.231762509335325,MooncakeForward:26.692458130355934,MooncakeReverse:4.597560803167421,ReverseDiff:29.39727891156463,ReverseDiffCompiled:2.0903478474593813,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.1368016810376,ForwardDiff:1.3260817441938388,MooncakeForward:32.71350005573929,MooncakeReverse:6.2912600459242265,ReverseDiff:40.00035244774963,ReverseDiffCompiled:2.1344885481931057,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.489210690980606,ForwardDiff:1.339163901179941,MooncakeForward:34.205128205128204,MooncakeReverse:5.768703290475685,ReverseDiff:32.30837417123091,ReverseDiffCompiled:2.539251757677316,Zygote:"error"},Oi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:150.7196917094848,ForwardDiff:2.6429811128126595,MooncakeForward:56.329627740948496,MooncakeReverse:6.340284983053193,ReverseDiff:55.749574105621804,ReverseDiffCompiled:6.655380141254673,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.700337188644355,ForwardDiff:1.3383788891610962,MooncakeForward:36.455408239434114,MooncakeReverse:6.171335948868136,ReverseDiff:34.62271193740578,ReverseDiffCompiled:2.629868138607789,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.59676764395354,ForwardDiff:1.3963119644213038,MooncakeForward:37.422759059122704,MooncakeReverse:6.304296262290064,ReverseDiff:41.803615447822516,ReverseDiffCompiled:2.389244383934649,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:56.97821698012963,ForwardDiff:1.2493491449316898,MooncakeForward:30.378498816320846,MooncakeReverse:5.203490847169008,ReverseDiff:33.12791943432612,ReverseDiffCompiled:1.8795038587436979,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:77.29172380564101,ForwardDiff:1.4210779945564533,MooncakeForward:29.544013121924547,MooncakeReverse:5.16841745081266,ReverseDiff:20.49179869198755,ReverseDiffCompiled:2.312163564718714,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.808569971093355,ForwardDiff:1.5447997452324753,MooncakeForward:16.620085689802913,MooncakeReverse:7.434468844150054,ReverseDiff:56.54379574468085,ReverseDiffCompiled:5.159312123817712,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:28.100734843845682,ForwardDiff:4.099643551523007,MooncakeForward:8.262590470446321,MooncakeReverse:42.00202960840497,ReverseDiff:10.940139174442512,ReverseDiffCompiled:4.848664929990231,Zygote:239.0185155369506},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:166.3923008369498,ForwardDiff:3.1414879666769515,MooncakeForward:56.759467566554186,MooncakeReverse:3.845180269549155,ReverseDiff:23.2329584975655,ReverseDiffCompiled:1.9740875701312974,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:132921.58221761658,ForwardDiff:12036.121846874119,MooncakeForward:27563.496779689896,MooncakeReverse:16.323716509504564,ReverseDiff:4.809137035477207,ReverseDiffCompiled:1.9310429048278108,Zygote:19.321808792841228},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:17.41199867165507,MooncakeForward:425.54091434346503,MooncakeReverse:36.044385870343135,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:7224.97377072819,ForwardDiff:148.77255991663773,MooncakeForward:469.2257049954517,MooncakeReverse:10.212427100583195,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Gi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:36.87104860047347,ForwardDiff:1.2021195996899006,MooncakeForward:24.883341780706203,MooncakeReverse:9.506562683181691,ReverseDiff:13.097592758906087,ReverseDiffCompiled:1.2687602937438411,Zygote:902.9099099099097},Ki={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"wrong",ForwardDiff:35.56055795631596,MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:47.38743015677806,ReverseDiffCompiled:5.59032456712309,Zygote:"error"},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1394.4146940098105,ForwardDiff:531.1541062801932,MooncakeForward:1947.0072442681453,MooncakeReverse:26.09314422233647,ReverseDiff:20.44597383653264,ReverseDiffCompiled:4.2333389289911025,Zygote:75.8548731736933},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6571.695580732354,ForwardDiff:84.41632943369386,MooncakeForward:1113.8200796457988,MooncakeReverse:3.5744308732127323,ReverseDiff:32.6851738938106,ReverseDiffCompiled:3.055343741705075,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.974402161517276,ForwardDiff:1.327187147469561,MooncakeForward:26.87219382468744,MooncakeReverse:6.2207502176463905,ReverseDiff:32.35363741339492,ReverseDiffCompiled:2.6403632782875857,Zygote:1632.063034109999},Ji={__category__:"Miscellaneous features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.315943249648193,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.01028312881333,ForwardDiff:1.237870516336258,MooncakeForward:25.838862559241708,MooncakeReverse:14.104486262993161,ReverseDiff:29.874057649667407,ReverseDiffCompiled:2.2973743435858966,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:15.538236792933583,ForwardDiff:.880979472941605,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"wrong",ReverseDiffCompiled:.29631573534574773,Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:134.83687746761794,ForwardDiff:1.7963960258601852,MooncakeForward:41.935620350456574,MooncakeReverse:4.573075834748161,ReverseDiff:20.145703138487036,ReverseDiffCompiled:1.9068128150001764,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:612.4452695569873,ForwardDiff:8.790327380952382,MooncakeForward:128.06177981742906,MooncakeReverse:4.1424130273871205,ReverseDiff:20.459783692001032,ReverseDiffCompiled:1.781246666429613,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1239.0614764703707,ForwardDiff:14.141507693443046,MooncakeForward:233.12784431137723,MooncakeReverse:4.005126109728465,ReverseDiff:20.63118719761816,ReverseDiffCompiled:1.9017594494088916,Zygote:"error"},ta={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.522020509977825,ForwardDiff:1.4295618422343002,MooncakeForward:16.635347494328727,MooncakeReverse:7.110438431238226,ReverseDiff:20.22169140647216,ReverseDiffCompiled:2.208249496981891,Zygote:2382.0210401490767},oa={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6603.320715203859,ForwardDiff:78.69200193754274,MooncakeForward:1220.7435758445895,MooncakeReverse:4.004112337011033,ReverseDiff:20.261764705882353,ReverseDiffCompiled:1.867881582317854,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.750953116950026,ForwardDiff:1.606138573389004,MooncakeForward:12.398987826562713,MooncakeReverse:5.748054278090047,ReverseDiff:33.75795383655646,ReverseDiffCompiled:3.184529324878246,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:17.69377156475652,ForwardDiff:1.269992748733124,MooncakeForward:8.86178295113961,MooncakeReverse:7.665189125295509,ReverseDiff:12.602400137150694,ReverseDiffCompiled:2.4745016847318637,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.773260161207343,ForwardDiff:1.6299856938483546,MooncakeForward:17.435221154501466,MooncakeReverse:7.5553893759669934,ReverseDiff:56.62989439758623,ReverseDiffCompiled:5.192020562831925,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.2334646343552,ForwardDiff:1.5082017165202377,MooncakeForward:18.29697177074423,MooncakeReverse:7.136502488415994,ReverseDiff:37.39681947588667,ReverseDiffCompiled:3.2799331548263355,Zygote:3581.8197159909446},ca={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:49.08012731801826,ForwardDiff:1.3595320761567613,MooncakeForward:23.143878462913314,MooncakeReverse:5.386198229077407,ReverseDiff:25.30533905579399,ReverseDiffCompiled:2.269201228878648,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:22.730083234244944,ForwardDiff:1.3695718491310638,MooncakeForward:13.222229820991982,MooncakeReverse:5.61338460850512,ReverseDiff:27.534301950380033,ReverseDiffCompiled:2.5230670771920374,Zygote:3316.188767743263},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:19.91408266530218,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:3.0133538777606574,Zygote:2332.0915901821722},da={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:133.736470014627,ForwardDiff:1.7910487381870954,MooncakeForward:57.08755625480223,MooncakeReverse:5.201029814201354,ReverseDiff:29.724216265333936,ReverseDiffCompiled:2.6084257525565318,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135.80643532212682,ForwardDiff:1.9276698421963268,MooncakeForward:60.3384971183143,MooncakeReverse:5.200234128770824,ReverseDiff:29.012982277003868,ReverseDiffCompiled:2.54391079367393,Zygote:"error"},ma={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:33.746320778248936,ForwardDiff:1.1690364320680917,MooncakeForward:20.700865963855424,MooncakeReverse:5.279079183295737,ReverseDiff:13.019455252918288,ReverseDiffCompiled:1.1198152730479947,Zygote:1633.0687025620923},ga={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:43.210895431246655,ForwardDiff:1.1163134549038936,MooncakeForward:22.97430850876885,MooncakeReverse:11.757824143070046,ReverseDiff:16.44941455964704,ReverseDiffCompiled:3.9222342771147582,Zygote:443.317888955392},va={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.30890375707668,ForwardDiff:1.3987966580851827,MooncakeForward:28.778809318377913,MooncakeReverse:6.49415193752102,ReverseDiff:29.450660776869157,ReverseDiffCompiled:2.925827012783534,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.349478721586056,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:38.34086596515439,ForwardDiff:1.5225182440736216,MooncakeForward:28.197671194898806,MooncakeReverse:7.310788253477589,ReverseDiff:19.33481630309989,ReverseDiffCompiled:"wrong",Zygote:2120.383257166597},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Fi,demo_assume_multivariate_observe:Ni,demo_assume_multivariate_observe_literal:Si,demo_assume_observe_literal:Ai,demo_assume_submodel_observe_index_literal:Ci,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Ii,assume_lkjcholu:Oi,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:$i,dppl_high_dim_gauss:Ui,dppl_hmm_semisup:Hi,dppl_lda:Zi,assume_mvnormal:Gi,dppl_logistic_regression:Ki,dppl_naive_bayes:qi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ra,assume_normal:ta,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:ua,observe_von_mises:fa,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:ga,broadcast_macro:va,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
