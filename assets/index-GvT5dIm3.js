...
\r\f \v\uFEFF`];function ci(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var i in t)if(t[i])r=r?r+" "+i:i;else if(r.length)for(var s=i.length,l=0;(l=r.indexOf(i,l))>=0;){var f=l+s;(l===0||lr.includes(r[l-1]))&&(f===r.length||lr.includes(r[f]))?r=(l===0?"":r.substring(0,l))+r.substring(f+1):l=f}}return r===""?null:r}function cr(e,n=!1){var t=n?" !important;":";",r="";for(var i in e){var s=e[i];s!=null&&s!==""&&(r+=" "+i+": "+s+t)}return r}function ct(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var t="",r,i;if(Array.isArray(n)?(r=n[0],i=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];r&&a.push(...Object.keys(r).map(ct)),i&&a.push(...Object.keys(i).map(ct));var c=0,p=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&p===-1)p=_;else if(u===";"||_===F-1){if(p!==-1){var g=ct(e.substring(c,p).trim());if(!a.includes(g)){u!==";"&&_++;var v=e.substring(c,_).trim();t+=" "+v+";"}}c=_+1,p=-1}}}}return r&&(t+=cr(r)),i&&(t+=cr(i,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function It(e,n,t,r,i,s){var l=e.__className;if(l!==t||l===void 0){var f=ci(t,r,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=t}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function ut(e,n={},t,r){for(var i in t){var s=t[i];n[i]!==s&&(t[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,r))}}function fi(e,n,t,r){var i=e.__style;if(i!==n){var s=ui(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(ut(e,t==null?void 0:t[0],r[0]),ut(e,t==null?void 0:t[1],r[1],"important")):ut(e,t,r));return r}const fn=Symbol("class"),cn=Symbol("style"),Kr=Symbol("is custom element"),Zr=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function yt(e,n,t,r){var i=Gr(e);i[n]!==(i[n]=t)&&(n==="loading"&&(e[Xo]=t),t==null?e.removeAttribute(n):typeof t!="string"&&Wr(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function _i(e,n,t,r,i=!1){var s=Gr(e),l=s[Kr],f=!s[Zr],a=n||{},c=e.tagName==="OPTION";for(var p in n)p in t||(t[p]=null);t.class?t.class=Hr(t.class):t.class=null,t[cn]&&(t.style??(t.style=null));var _=Wr(e);for(const M in t){let D=t[M];if(c&&M==="value"&&D==null){e.value=e.__value="",a[M]=D;continue}if(M==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";It(e,u,D,r,n==null?void 0:n[fn],t[fn]),a[M]=D,a[fn]=t[fn];continue}if(M==="style"){fi(e,D,n==null?void 0:n[cn],t[cn]),a[M]=D,a[cn]=t[cn];continue}var g=a[M];if(D!==g){a[M]=D;var v=M[0]+M[1];if(v!=="$$")if(v==="on"){const x={},ee="$$"+M;let S=M.slice(2);var F=qs(S);if(Bs(S)&&(S=S.slice(0,-7),x.capture=!0),!F&&g){if(D!=null)continue;e.removeEventListener(S,a[ee],x),a[ee]=null}if(D!=null)if(F)e[`__${S}`]=D,Xs([S]);else{let $=function(Y){a[M].call(this,Y)};var U=$;a[ee]=Ws(S,e,$,x)}else F&&(e[`__${S}`]=void 0)}else if(M==="style")yt(e,M,D);else if(M==="autofocus")Zs(e,!!D);else if(!l&&(M==="__value"||M==="value"&&D!=null))e.value=e.__value=D;else if(M==="selected"&&c)di(e,D);else{var A=M;f||(A=Us(A));var z=A==="defaultValue"||A==="defaultChecked";if(D==null&&!l&&!z)if(s[M]=null,A==="value"||A==="checked"){let x=e;const ee=n===void 0;if(A==="value"){let S=x.defaultValue;x.removeAttribute(A),x.defaultValue=S,x.value=x.__value=ee?S:null}else{let S=x.defaultChecked;x.removeAttribute(A),x.defaultChecked=S,x.checked=ee?S:!1}}else e.removeAttribute(M);else z||_.includes(A)&&(l||typeof D!="string")?e[A]=D:typeof D!="function"&&yt(e,A,D)}}}for(let M of Object.getOwnPropertySymbols(t))M.description===hs&&ai(e,()=>t[M]);return a}function Gr(e){return e.__attributes??(e.__attributes={[Kr]:e.nodeName.includes("-"),[Zr]:e.namespaceURI===vs})}var ur=new Map;function Wr(e){var n=ur.get(e.nodeName);if(n)return n;ur.set(e.nodeName,n=[]);for(var t,r=e,i=Element.prototype;i!==r;){t=gr(r);for(var s in t)t[s].set&&n.push(s);r=Dt(r)}return n}function Lt(e=!1){const n=q,t=n.l.u;if(!t)return;let r=()=>gt(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});r=()=>O(l)}t.b.length&&xs(()=>{fr(n,r),dt(t.b)}),or(()=>{const i=Bn(()=>t.m.map(Ko));return()=>{for(const s of i)typeof s=="function"&&s()}}),t.a.length&&or(()=>{fr(n,r),dt(t.a)})}function fr(e,n){if(e.l.s)for(const t of e.l.s)O(t);n()}let Sn=!1;function mi(e){var n=Sn;try{return Sn=!1,[e(),Sn]}finally{Sn=n}}const pi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Er)),e.special[n](t),tr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),tr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},pi)}const gi={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let i=e.props[r];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const i=je(r,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===Ge||n===br)return!1;for(let t of e.props)if(ln(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(ln(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function vi(...e){return new Proxy({props:e},gi)}function dr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,t,r){var ee;var i=(t&fs)!==0,s=!vn||(t&ds)!==0,l=(t&_s)!==0,f=(t&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var p=Ge in e||br in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(p&&n in e&&(S=>e[n]=S)))||void 0,u=r,g=!0,v=!1,F=()=>(v=!0,g&&(g=!1,f?u=Bn(r):u=r),u);c===void 0&&r!==void 0&&(_&&s&&rs(),c=F(),_&&_(c));var A;if(s)A=()=>{var S=e[n];return S===void 0?F():(g=!0,v=!1,S)};else{var z=(i?mn:St)(()=>e[n]);z.f|=Go,A=()=>{var S=O(z);return S!==void 0&&(u=void 0),S===void 0?u:S}}if((t&Er)===0)return A;if(_){var U=e.$$legacy;return function(S,$){return arguments.length>0?((!s||!$||U||a)&&_($?A():S),S):A()}}var M=!1,D=Kn(c),x=mn(()=>{var S=A(),$=O(D);return M?(M=!1,$):D.v=S});return l&&O(x),i||(x.equals=Mt),function(S,$){if(arguments.length>0){const Y=$?O(x):s&&l?Ze(S):S;if(!x.equals(Y)){if(M=!0,ce(D,Y),v&&u!==void 0&&(u=Y),dr(x))return S;Bn(()=>O(x))}return S}return dr(x)?x.v:O(x)}}function hi(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function bi(){const e=q;return e===null&&Dr(),(n,t,r)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=qn(i)?i.slice():[i],f=hi(n,t,r);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){q===null&&Dr(),q.l===null&&ts(),wi(q).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var pr;typeof window<"u"&&((pr=window.__svelte??(window.__svelte={})).v??(pr.v=new Set)).add(Ei);ls();const Di={__category__:"External libraries",EnzymeForward:"error",EnzymeReverse:"wrong",FiniteDifferences:95.01973571305989,ForwardDiff:2.109764079284732,MooncakeForward:22.242169068273387,MooncakeReverse:6.895033247387706,ReverseDiff:63.18846729905142,ReverseDiffCompiled:8.251423597257988,Zygote:725.0512857245183},Ri={__category__:"Distributions",EnzymeForward:3.5228062130466173,EnzymeReverse:"error",FiniteDifferences:36.12502259580622,ForwardDiff:2.0566530301969452,MooncakeForward:3.789632233097122,MooncakeReverse:3.631246148983332,ReverseDiff:71.89568862073044,ReverseDiffCompiled:5.721162439594252,Zygote:3325.261149737154},xi={__category__:"Base Julia features",EnzymeForward:3.4449236388293856,EnzymeReverse:1.8118389401408266,FiniteDifferences:79.84944090830898,ForwardDiff:2.405831029850055,MooncakeForward:8.448860520094563,MooncakeReverse:5.1636036861487495,ReverseDiff:60.08881523032466,ReverseDiffCompiled:"wrong",Zygote:6045.183301669155},Mi={__category__:"External libraries",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:61.89254278490422,ForwardDiff:"wrong",MooncakeForward:"error",MooncakeReverse:"wrong",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Ti={__category__:"DynamicPPL demo models",EnzymeForward:5.187063949253099,EnzymeReverse:4.067761875011833,FiniteDifferences:76.22249388753058,ForwardDiff:2.61404126838402,MooncakeForward:7.891198565818678,MooncakeReverse:5.894276038994357,ReverseDiff:142.50604982206403,ReverseDiffCompiled:13.113807925535896,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:4.293266425370216,EnzymeReverse:3.220186648978621,FiniteDifferences:64.28244733678324,ForwardDiff:2.1758204086186947,MooncakeForward:7.65999177631579,MooncakeReverse:5.158689108773872,ReverseDiff:105.2455534772998,ReverseDiffCompiled:9.809689950890567,Zygote:7340.243568595794},Si={__category__:"DynamicPPL demo models",EnzymeForward:4.869467775003334,EnzymeReverse:5.9219950961638785,FiniteDifferences:83.46607839809944,ForwardDiff:1.7034193654660041,MooncakeForward:11.954952869887224,MooncakeReverse:4.941768856614373,ReverseDiff:69.82378100940974,ReverseDiffCompiled:6.053659539473685,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:4.36207504973945,EnzymeReverse:5.003565376533587,FiniteDifferences:80.26479337658148,ForwardDiff:1.4361140974619164,MooncakeForward:14.806360745115855,MooncakeReverse:7.545045469367052,ReverseDiff:56.14274761274133,ReverseDiffCompiled:4.894525387693847,Zygote:"error"},Ci={__category__:"DynamicPPL demo models",EnzymeForward:5.145952842741866,EnzymeReverse:4.749260183460444,FiniteDifferences:89.05790533736152,ForwardDiff:1.5435350980233729,MooncakeForward:15.214665681566311,MooncakeReverse:6.85919961211009,ReverseDiff:66.26063551401869,ReverseDiffCompiled:6.008041442417978,Zygote:3283.0230666443967},Ai={__category__:"DynamicPPL demo models",EnzymeForward:4.721376993474148,EnzymeReverse:4.602078629414502,FiniteDifferences:87.1136298729116,ForwardDiff:1.5799504832390536,MooncakeForward:14.798989442455005,MooncakeReverse:7.160954874947816,ReverseDiff:68.31420137750082,ReverseDiffCompiled:5.742318132437229,Zygote:2882.996978851964},ki={__category__:"DynamicPPL demo models",EnzymeForward:5.459246965734594,EnzymeReverse:3.8798132162743415,FiniteDifferences:78.95292797482705,ForwardDiff:1.9209775157602924,MooncakeForward:8.221117354371227,MooncakeReverse:5.9458022800748696,ReverseDiff:142.98069491348397,ReverseDiffCompiled:13.466521658570382,Zygote:10107.578933015167},Oi={__category__:"DynamicPPL demo models",EnzymeForward:5.241461439241682,EnzymeReverse:6.387532294357864,FiniteDifferences:83.73343105433986,ForwardDiff:1.4380402635954106,MooncakeForward:12.493165648156351,MooncakeReverse:5.931301565920189,ReverseDiff:71.21872184099257,ReverseDiffCompiled:6.486670645333122,Zygote:"error"},Ii={__category__:"Distributions",EnzymeForward:2.8456478947621107,EnzymeReverse:2.7649692297288158,FiniteDifferences:27.163876204972098,ForwardDiff:1.1892920540997465,MooncakeForward:3.8155064155064156,MooncakeReverse:6.1592614770459075,ReverseDiff:46.446616439285954,ReverseDiffCompiled:4.3141138795594784,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:5.195040588091837,EnzymeReverse:6.149607469965505,FiniteDifferences:81.00041088854648,ForwardDiff:1.4832665329430537,MooncakeForward:14.626008586736686,MooncakeReverse:6.560078920174973,ReverseDiff:61.25072886297376,ReverseDiffCompiled:5.816585995482414,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:5.154620640057534,EnzymeReverse:5.8386630972661635,FiniteDifferences:83.46356061894237,ForwardDiff:1.8568614478877845,MooncakeForward:12.493787742069825,MooncakeReverse:5.637937154544379,ReverseDiff:70.46724460309366,ReverseDiffCompiled:6.426315235320956,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:5.318269015758688,EnzymeReverse:4.776287763459419,FiniteDifferences:83.90039354995994,ForwardDiff:1.5727698278805975,MooncakeForward:12.333086367485182,MooncakeReverse:5.407909154675918,ReverseDiff:70.44345740728231,ReverseDiffCompiled:7.1830861670518305,Zygote:"error"},Vi={__category__:"DynamicPPL demo models",EnzymeForward:5.09303263283786,EnzymeReverse:5.6846887521869185,FiniteDifferences:76.10271542607627,ForwardDiff:1.4660375419606768,MooncakeForward:14.537539740767915,MooncakeReverse:6.616648942529748,ReverseDiff:57.154359380300804,ReverseDiffCompiled:5.196442498460696,Zygote:"error"},Bi={__category__:"DynamicPPL demo models",EnzymeForward:4.8925658086214145,EnzymeReverse:6.871215789352331,FiniteDifferences:79.53173300506086,ForwardDiff:1.401885035124432,MooncakeForward:13.7230077345746,MooncakeReverse:5.724444480593422,ReverseDiff:60.074640518093,ReverseDiffCompiled:5.58501642885044,Zygote:"error"},ji={__category__:"Core Turing syntax",EnzymeForward:3.904475785896347,EnzymeReverse:2.4501392011411234,FiniteDifferences:115.7481595617189,ForwardDiff:1.5746057557125195,MooncakeForward:15.390569586770383,MooncakeReverse:4.137986735913003,ReverseDiff:54.073622113601886,ReverseDiffCompiled:4.782906527883091,Zygote:"error"},qi={__category__:"Core Turing syntax",EnzymeForward:9.086223840993442,EnzymeReverse:4.962584999261735,FiniteDifferences:114.09887575670221,ForwardDiff:3.7248904741426734,MooncakeForward:6.040389097791973,MooncakeReverse:13.331678409325981,ReverseDiff:402.16364203089285,ReverseDiffCompiled:32.06022622774076,Zygote:"error"},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:.6761402751243437,EnzymeReverse:2.264911044492347,FiniteDifferences:29.094022012804835,ForwardDiff:1.6398198383554659,MooncakeForward:4.14538569424965,MooncakeReverse:4.951620551154748,ReverseDiff:128.42425438445963,ReverseDiffCompiled:13.58182217292402,Zygote:17.435186442757193},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:7.559134462397908,EnzymeReverse:3.0237898220935038,FiniteDifferences:180.8815475354585,ForwardDiff:5.779891304347826,MooncakeForward:36.12211151155395,MooncakeReverse:7.251682793437105,ReverseDiff:88.1595847416707,ReverseDiffCompiled:9.60441927526665,Zygote:1970.9499876119348},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:10608.094272169115,EnzymeReverse:2.3270263578883217,FiniteDifferences:121939.652683707,ForwardDiff:1061.9257156865644,MooncakeForward:7942.955105596754,MooncakeReverse:4.211506742990201,ReverseDiff:88.62202981256456,ReverseDiffCompiled:5.155557309016152,Zygote:3.572480322275522},Ki={__category__:"Distributions",EnzymeForward:4.225595772604821,EnzymeReverse:16.678866148939516,FiniteDifferences:159.24728407763266,ForwardDiff:2.490259849119866,MooncakeForward:20.00022075055188,MooncakeReverse:4.952193751288926,ReverseDiff:67.26170468187274,ReverseDiffCompiled:8.195900725983455,Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:33.40315793986685,EnzymeReverse:5.890291788370623,FiniteDifferences:"NaN",ForwardDiff:28.033233992036205,MooncakeForward:188.10174007285426,MooncakeReverse:5.069609161184999,ReverseDiff:71.64212270973962,ReverseDiffCompiled:12.913180503520739,Zygote:"error"},Gi={__category__:"DynamicPPL arXiV paper",EnzymeForward:242.90437593174897,EnzymeReverse:1.6127534002411048,FiniteDifferences:4446.261849278161,ForwardDiff:152.45563438376504,MooncakeForward:500.5342182225586,MooncakeReverse:7.284752363747273,ReverseDiff:91.3994615704075,ReverseDiffCompiled:9.985785827614801,Zygote:"error"},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:41.20597048052381,EnzymeReverse:3.2802393421329583,FiniteDifferences:1194.051161411695,ForwardDiff:54.61906689864714,MooncakeForward:162.4429241434803,MooncakeReverse:"wrong",ReverseDiff:3773.491711132227,ReverseDiffCompiled:359.50208011620447,Zygote:161.47256152827165},Xi={__category__:"DynamicPPL arXiV paper",EnzymeForward:138.39729215818858,EnzymeReverse:.9861799955270809,FiniteDifferences:2831.5607112375164,ForwardDiff:136.17928249724085,MooncakeForward:431.3214390415897,MooncakeReverse:7.634869211551279,ReverseDiff:140.59326197578523,ReverseDiffCompiled:19.456576905234687,Zygote:3231.7633909978485},Ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:220.24032814516343,EnzymeReverse:4.383567155771346,FiniteDifferences:6515.271619110091,ForwardDiff:113.43336002429797,MooncakeForward:1118.850241942098,MooncakeReverse:4.236094625555525,ReverseDiff:106.65027717851389,ReverseDiffCompiled:10.002474703035636,Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:3.7070997807017547,EnzymeReverse:"error",FiniteDifferences:59.89666384419982,ForwardDiff:1.4994900560938296,MooncakeForward:6.922356546909588,MooncakeReverse:4.324546766200364,ReverseDiff:69.14985507246377,ReverseDiffCompiled:6.793055319148936,Zygote:4805.383035866054},Qi={__category__:"External libraries",EnzymeForward:"error",EnzymeReverse:"wrong",FiniteDifferences:251.64500783027512,ForwardDiff:"wrong",MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Core Turing syntax",EnzymeForward:3.396797926008968,EnzymeReverse:2.6944662681468823,FiniteDifferences:69.67008648465321,ForwardDiff:1.2970698646839756,MooncakeForward:11.101105777472998,MooncakeReverse:5.356437652150392,ReverseDiff:47.93995660370646,ReverseDiffCompiled:4.377659574468085,Zygote:"error"},na={__category__:"Base Julia features",EnzymeForward:5.5869473399672245,EnzymeReverse:19.239144759658735,FiniteDifferences:13.968493712411153,ForwardDiff:1.069119407858931,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ta={__category__:"Effect of model size",EnzymeForward:5.7722839226593345,EnzymeReverse:2.876051948051948,FiniteDifferences:181.7658567371411,ForwardDiff:2.404700810838551,MooncakeForward:26.878637355837814,MooncakeReverse:4.048585463802933,ReverseDiff:58.1116354929382,ReverseDiffCompiled:4.388978879820572,Zygote:"error"},ra={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:4.499477197780101,FiniteDifferences:43.073361702127656,ForwardDiff:1.060879890817997,MooncakeForward:14.915681639085896,MooncakeReverse:9.099024307326195,ReverseDiff:19.79567512344628,ReverseDiffCompiled:1.3945975203396423,Zygote:1009.873680614859},oa={__category__:"Effect of model size",EnzymeForward:26.95636589232784,EnzymeReverse:4.262343296202345,FiniteDifferences:656.5164581116289,ForwardDiff:12.877374071015689,MooncakeForward:143.34694728068348,MooncakeReverse:4.011229334904516,ReverseDiff:52.55705674495947,ReverseDiffCompiled:4.445131375579598,Zygote:"error"},sa={__category__:"Effect of model size",EnzymeForward:53.650264640600994,EnzymeReverse:3.9870893872394184,FiniteDifferences:1266.9119133282127,ForwardDiff:16.491769547325102,MooncakeForward:259.8343238622486,MooncakeReverse:3.910368710531676,ReverseDiff:54.17930237301965,ReverseDiffCompiled:4.448611976229357,Zygote:"error"},ia={__category__:"Effect of model size",EnzymeForward:264.17951186993076,EnzymeReverse:4.53356917341854,FiniteDifferences:7053.833270249811,ForwardDiff:85.18546511627906,MooncakeForward:1261.2892319277107,MooncakeReverse:3.7108008649797033,ReverseDiff:48.21647166431648,ReverseDiffCompiled:4.291352675207235,Zygote:"error"},aa={__category__:"Distributions",EnzymeForward:3.107675160615663,EnzymeReverse:2.8620703206478857,FiniteDifferences:35.0078976221476,ForwardDiff:1.8775280100686627,MooncakeForward:3.7187399073662455,MooncakeReverse:3.6300492194851253,ReverseDiff:66.68477817786534,ReverseDiffCompiled:5.595702806858186,Zygote:"error"},la={__category__:"Distributions",EnzymeForward:1.891314064362336,EnzymeReverse:7.150457951706911,FiniteDifferences:20.184745025302828,ForwardDiff:1.2113758431614523,MooncakeForward:3.6909241665227155,MooncakeReverse:7.11437780316854,ReverseDiff:40.18746789933231,ReverseDiffCompiled:3.8414356501941875,Zygote:"error"},ca={__category__:"Core Turing syntax",EnzymeForward:9.466993733418212,EnzymeReverse:4.420951307126257,FiniteDifferences:121.37639159627464,ForwardDiff:3.6168817155575934,MooncakeForward:8.429779754430854,MooncakeReverse:13.252991268381614,ReverseDiff:434.73550679355105,ReverseDiffCompiled:38.395227132348815,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:12.090962319854219,EnzymeReverse:5.572048050541393,FiniteDifferences:155.4859949832776,ForwardDiff:3.699569960194604,MooncakeForward:9.590059363592788,MooncakeReverse:11.714870290168527,ReverseDiff:313.08859134262656,ReverseDiffCompiled:25.536927964886377,Zygote:24187.38537535535},fa={__category__:"Core Turing syntax",EnzymeForward:3.3893841974969057,EnzymeReverse:4.350351432764347,FiniteDifferences:78.71719095391941,ForwardDiff:1.8062155997261924,MooncakeForward:9.801904176904175,MooncakeReverse:4.19948068253153,ReverseDiff:65.11567721776933,ReverseDiffCompiled:5.426021587008186,Zygote:"error"},da={__category__:"Core Turing syntax",EnzymeForward:12.254604323992869,EnzymeReverse:5.67483509574164,FiniteDifferences:153.3329955857172,ForwardDiff:3.707509399219558,MooncakeForward:9.35920345396845,MooncakeReverse:11.615042918894702,ReverseDiff:296.56839664233064,ReverseDiffCompiled:24.588919953477674,Zygote:37178.69237397673},_a={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:27.82207858479333,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:5.153851271074678,Zygote:3456.7989821882948},ma={__category__:"Distributions",EnzymeForward:12.400883052327373,EnzymeReverse:4.050910842860177,FiniteDifferences:155.74593977081346,ForwardDiff:3.346360256326408,MooncakeForward:9.348684210526317,MooncakeReverse:11.487864203072174,ReverseDiff:190.27022621914261,ReverseDiffCompiled:15.78210637724559,Zygote:16457.30474807917},pa={__category__:"External libraries",EnzymeForward:"wrong",EnzymeReverse:"wrong",FiniteDifferences:61.889202669991924,ForwardDiff:"wrong",MooncakeForward:"error",MooncakeReverse:"wrong",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ga={__category__:"PosteriorDB",EnzymeForward:6.713136449118895,EnzymeReverse:3.804027754273143,FiniteDifferences:169.71585698031237,ForwardDiff:3.771084906598762,MooncakeForward:28.757733537519144,MooncakeReverse:4.9094628724322025,ReverseDiff:114.95922593787134,ReverseDiffCompiled:9.321446315208389,Zygote:"error"},va={__category__:"PosteriorDB",EnzymeForward:6.179782698390868,EnzymeReverse:4.146778903968389,FiniteDifferences:170.1320658631811,ForwardDiff:3.844740090522562,MooncakeForward:26.97119592875318,MooncakeReverse:4.968089333424677,ReverseDiff:105.24508294852062,ReverseDiffCompiled:9.094927089751488,Zygote:"error"},ha={__category__:"Core Turing syntax",EnzymeForward:6.4728497959056845,EnzymeReverse:3.4744508486618155,FiniteDifferences:116.0672573302658,ForwardDiff:1.6948352220822096,MooncakeForward:10.04308829417211,MooncakeReverse:7.060608096094198,ReverseDiff:110.00229499212166,ReverseDiffCompiled:8.870059067241476,Zygote:16082.8596321394},ba={__category__:"Distributions",EnzymeForward:10.1690626535403,EnzymeReverse:8.461347038139031,FiniteDifferences:43.568219132182946,ForwardDiff:1.0336236944922603,MooncakeForward:18.75615578518605,MooncakeReverse:9.417128736740597,ReverseDiff:26.50347900085098,ReverseDiffCompiled:2.14250588359268,Zygote:368.32995358800423},ya={__category__:"Core Turing syntax",EnzymeForward:5.072975857464497,EnzymeReverse:3.6618030323726263,FiniteDifferences:75.87444720840243,ForwardDiff:1.6125987365265397,MooncakeForward:7.59726239767077,MooncakeReverse:5.651475379562333,ReverseDiff:132.13933551385782,ReverseDiffCompiled:11.762824351297404,Zygote:"error"},wa={__category__:"Base Julia features",EnzymeForward:6.6758640971525445,EnzymeReverse:3.4168258480844367,FiniteDifferences:80.26341906018824,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Ea={abstractgps:Di,assume_beta:Ri,control_flow:xi,delaydiffeq:Mi,demo_assume_dot_observe:Ti,demo_assume_dot_observe_literal:Fi,demo_assume_index_observe:Si,demo_assume_matrix_observe_matrix_index:Ni,demo_assume_multivariate_observe:Ci,demo_assume_multivariate_observe_literal:Ai,demo_assume_observe_literal:ki,demo_assume_submodel_observe_index_literal:Oi,assume_dirichlet:Ii,demo_dot_assume_observe:Li,demo_dot_assume_observe_index:Pi,demo_dot_assume_observe_index_literal:zi,demo_dot_assume_observe_matrix_index:Vi,demo_dot_assume_observe_submodel:Bi,dot_assume:ji,dot_observe:qi,dppl_gauss_unknown:$i,dppl_hier_poisson:Ui,dppl_high_dim_gauss:Hi,assume_lkjcholu:Ki,dppl_hmm_semisup:Zi,dppl_lda:Gi,dppl_logistic_regression:Wi,dppl_naive_bayes:Xi,dppl_sto_volatility:Ji,dynamic_constraint:Yi,lux_nn:Qi,multiple_constraints_same_var:ea,multithreaded:na,n010:ta,assume_mvnormal:ra,n050:oa,n100:sa,n500:ia,observe_bernoulli:aa,observe_categorical:la,observe_index:ca,observe_literal:ua,observe_multivariate:fa,observe_submodel:da,observe_von_mises:_a,assume_normal:ma,ordinarydiffeq:pa,pdb_eight_schools_centered:ga,pdb_eight_schools_noncentered:va,assume_submodel:ha,assume_wishart:ba,broadcast_macro:ya,call_C:wa},Da=`#=
