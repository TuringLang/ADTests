...
`,1;if(ot>1e5&&ot>D.index*3)throw new Error("potential infinite loop, way more iterations than matches");return B+=A,A.length}const we=Ie(m);if(!we)throw Ze(K.replace("{}",m)),new Error('Unknown language: "'+m+'"');const Bo=wo(we);let rt="",C=V||Bo;const Jt={},Q=new b.__emitter(b);Vo();let B="",Tn=0,Ke=0,ot=0,st=!1;try{if(we.__emitTokens)we.__emitTokens(M,Q);else{for(C.matcher.considerAll();;){ot++,st?st=!1:C.matcher.considerAll(),C.matcher.lastIndex=Ke;const y=C.matcher.exec(M);if(!y)break;const D=M.substring(Ke,y.index),A=Xt(D,y);Ke=y.index+A}Xt(M.substring(Ke))}return Q.finalize(),rt=Q.toHTML(),{language:m,value:rt,relevance:Tn,illegal:!1,_emitter:Q,_top:C}}catch(y){if(y.message&&y.message.includes("Illegal"))return{language:m,value:Qn(M),illegal:!0,relevance:0,_illegalBy:{message:y.message,index:Ke,context:M.slice(Ke-100,Ke+100),mode:y.mode,resultSoFar:rt},_emitter:Q};if(Z)return{language:m,value:Qn(M),illegal:!1,relevance:0,errorRaised:y,_emitter:Q,_top:C};throw y}}function et(m){const M={value:Qn(m),illegal:!1,relevance:0,_top:w,_emitter:new b.__emitter(b)};return M._emitter.addText(m),M}function nt(m,M){M=M||b.languages||Object.keys(d);const I=et(m),V=M.filter(Ie).filter(Zt).map(le=>an(le,m,!1));V.unshift(I);const X=V.sort((le,be)=>{if(le.relevance!==be.relevance)return be.relevance-le.relevance;if(le.language&&be.language){if(Ie(le.language).supersetOf===be.language)return 1;if(Ie(be.language).supersetOf===le.language)return-1}return 0}),[ve,Le]=X,Rn=ve;return Rn.secondBest=Le,Rn}function Mo(m,M,I){const V=M&&h[M]||I;m.classList.add("hljs"),m.classList.add(`language-${V}`)}function tt(m){let M=null;const I=Y(m);if(S(I))return;if(xn("before:highlightElement",{el:m,language:I}),m.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",m);return}if(m.children.length>0&&(b.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(m)),b.throwUnescapedHTML))throw new xo("One of your code blocks includes unescaped HTML.",m.innerHTML);M=m;const V=M.textContent,X=I?G(V,{language:I,ignoreIllegals:!0}):nt(V);m.innerHTML=X.value,m.dataset.highlighted="yes",Mo(m,I,X.language),m.result={language:X.language,re:X.relevance,relevance:X.relevance},X.secondBest&&(m.secondBest={language:X.secondBest.language,relevance:X.secondBest.relevance}),xn("after:highlightElement",{el:m,result:X,text:V})}function To(m){b=Bt(b,m)}const Fo=()=>{Dn(),Je("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function So(){Dn(),Je("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let Ut=!1;function Dn(){function m(){Dn()}if(document.readyState==="loading"){Ut||window.addEventListener("DOMContentLoaded",m,!1),Ut=!0;return}document.querySelectorAll(b.cssSelector).forEach(tt)}function No(m,M){let I=null;try{I=M(o)}catch(V){if(Ze("Language definition for '{}' could not be registered.".replace("{}",m)),Z)Ze(V);else throw V;I=w}I.name||(I.name=m),d[m]=I,I.rawDefinition=M.bind(null,o),I.aliases&&Ht(I.aliases,{languageName:m})}function ko(m){delete d[m];for(const M of Object.keys(h))h[M]===m&&delete h[M]}function Co(){return Object.keys(d)}function Ie(m){return m=(m||"").toLowerCase(),d[m]||d[h[m]]}function Ht(m,{languageName:M}){typeof m=="string"&&(m=[m]),m.forEach(I=>{h[I.toLowerCase()]=M})}function Zt(m){const M=Ie(m);return M&&!M.disableAutodetect}function Ao(m){m["before:highlightBlock"]&&!m["before:highlightElement"]&&(m["before:highlightElement"]=M=>{m["before:highlightBlock"](Object.assign({block:M.el},M))}),m["after:highlightBlock"]&&!m["after:highlightElement"]&&(m["after:highlightElement"]=M=>{m["after:highlightBlock"](Object.assign({block:M.el},M))})}function Oo(m){Ao(m),k.push(m)}function Io(m){const M=k.indexOf(m);M!==-1&&k.splice(M,1)}function xn(m,M){const I=m;k.forEach(function(V){V[I]&&V[I](M)})}function Lo(m){return Je("10.7.0","highlightBlock will be removed entirely in v12.0"),Je("10.7.0","Please use highlightElement now."),tt(m)}Object.assign(o,{highlight:G,highlightAuto:nt,highlightAll:Dn,highlightElement:tt,highlightBlock:Lo,configure:To,initHighlighting:Fo,initHighlightingOnLoad:So,registerLanguage:No,unregisterLanguage:ko,listLanguages:Co,getLanguage:Ie,registerAliases:Ht,autoDetection:Zt,inherit:Bt,addPlugin:Oo,removePlugin:Io}),o.debugMode=function(){Z=!1},o.safeMode=function(){Z=!0},o.versionString=Do,o.regex={concat:x,lookahead:c,either:L,optional:p,anyNumberOfTimes:v};for(const m in wn)typeof wn[m]=="object"&&e(wn[m]);return Object.assign(o,wn),o},Ye=$t({});return Ye.newInstance=()=>$t({}),ct=Ye,Ye.HighlightJS=Ye,Ye.default=Ye,ct}var om=rm();const _r=tm(om);var sm=pe("<pre><code><!></code></pre>");function im(e,n){const t=Vn(n,["children","$$slots","$$events","$$legacy"]),r=Vn(t,["code","highlighted","languageName","langtag"]);let i=Ve(n,"code",8),s=Ve(n,"highlighted",8),l=Ve(n,"languageName",8,"plaintext"),u=Ve(n,"langtag",8,!1);var a=sm();let f;var g=H(a);It(g,1,"",null,{},{hljs:!0});var _=H(g);{var c=p=>{var x=Ot(),F=Kn(x);ii(F,s),W(p,x)},v=p=>{var x=Ys();Re(()=>qe(x,i())),W(p,x)};gn(_,p=>{s()?p(c):p(v,!1)})}Re(p=>f=mi(a,f,{"data-language":l(),...r,[fn]:p},"svelte-1w9vok"),[()=>({langtag:u()})],Mt),W(e,a)}function am(e,n){const t=Vn(n,["children","$$slots","$$events","$$legacy"]),r=Vn(t,["language","code","langtag"]);hn(n,!1);let i=Ve(n,"language",8),s=Ve(n,"code",8),l=Ve(n,"langtag",8,!1);const u=bi();let a=Tt("");wi(()=>{O(a)&&u("highlight",{highlighted:O(a)})}),Ss(()=>(mt(i()),mt(s())),()=>{_r.registerLanguage(i().name,i().register),re(a,_r.highlight(s(),{language:i().name}).value)}),Ns(),Gr();var f=Ot(),g=Kn(f);ai(g,n,"default",{get highlighted(){return O(a)}},_=>{im(_,hi(()=>r,{get languageName(){return i().name},get langtag(){return l()},get highlighted(){return O(a)},get code(){return s()}}))}),W(e,f),yn()}function lm(e){const n="[A-Za-z_\\u00A1-\\uFFFF][A-Za-z_0-9\\u00A1-\\uFFFF]*",s={$pattern:n,keyword:["baremodule","begin","break","catch","ccall","const","continue","do","else","elseif","end","export","false","finally","for","function","global","if","import","in","isa","let","local","macro","module","quote","return","true","try","using","where","while"],literal:["ARGS","C_NULL","DEPOT_PATH","ENDIAN_BOM","ENV","Inf","Inf16","Inf32","Inf64","InsertionSort","LOAD_PATH","MergeSort","NaN","NaN16","NaN32","NaN64","PROGRAM_FILE","QuickSort","RoundDown","RoundFromZero","RoundNearest","RoundNearestTiesAway","RoundNearestTiesUp","RoundToZero","RoundUp","VERSION|0","devnull","false","im","missing","nothing","pi","stderr","stdin","stdout","true","undef","π","ℯ"],built_in:["AbstractArray","AbstractChannel","AbstractChar","AbstractDict","AbstractDisplay","AbstractFloat","AbstractIrrational","AbstractMatrix","AbstractRange","AbstractSet","AbstractString","AbstractUnitRange","AbstractVecOrMat","AbstractVector","Any","ArgumentError","Array","AssertionError","BigFloat","BigInt","BitArray","BitMatrix","BitSet","BitVector","Bool","BoundsError","CapturedException","CartesianIndex","CartesianIndices","Cchar","Cdouble","Cfloat","Channel","Char","Cint","Cintmax_t","Clong","Clonglong","Cmd","Colon","Complex","ComplexF16","ComplexF32","ComplexF64","CompositeException","Condition","Cptrdiff_t","Cshort","Csize_t","Cssize_t","Cstring","Cuchar","Cuint","Cuintmax_t","Culong","Culonglong","Cushort","Cvoid","Cwchar_t","Cwstring","DataType","DenseArray","DenseMatrix","DenseVecOrMat","DenseVector","Dict","DimensionMismatch","Dims","DivideError","DomainError","EOFError","Enum","ErrorException","Exception","ExponentialBackOff","Expr","Float16","Float32","Float64","Function","GlobalRef","HTML","IO","IOBuffer","IOContext","IOStream","IdDict","IndexCartesian","IndexLinear","IndexStyle","InexactError","InitError","Int","Int128","Int16","Int32","Int64","Int8","Integer","InterruptException","InvalidStateException","Irrational","KeyError","LinRange","LineNumberNode","LinearIndices","LoadError","MIME","Matrix","Method","MethodError","Missing","MissingException","Module","NTuple","NamedTuple","Nothing","Number","OrdinalRange","OutOfMemoryError","OverflowError","Pair","PartialQuickSort","PermutedDimsArray","Pipe","ProcessFailedException","Ptr","QuoteNode","Rational","RawFD","ReadOnlyMemoryError","Real","ReentrantLock","Ref","Regex","RegexMatch","RoundingMode","SegmentationFault","Set","Signed","Some","StackOverflowError","StepRange","StepRangeLen","StridedArray","StridedMatrix","StridedVecOrMat","StridedVector","String","StringIndexError","SubArray","SubString","SubstitutionString","Symbol","SystemError","Task","TaskFailedException","Text","TextDisplay","Timer","Tuple","Type","TypeError","TypeVar","UInt","UInt128","UInt16","UInt32","UInt64","UInt8","UndefInitializer","UndefKeywordError","UndefRefError","UndefVarError","Union","UnionAll","UnitRange","Unsigned","Val","Vararg","VecElement","VecOrMat","Vector","VersionNumber","WeakKeyDict","WeakRef"]},l={keywords:s,illegal:/<\//},u={className:"number",begin:/(\b0x[\d_]*(\.[\d_]*)?|0x\.\d[\d_]*)p[-+]?\d+|\b0[box][a-fA-F0-9][a-fA-F0-9_]*|(\b\d[\d_]*(\.[\d_]*)?|\.\d[\d_]*)([eEfF][-+]?\d+)?/,relevance:0},a={className:"string",begin:/'(.|\\[xXuU][a-zA-Z0-9]+)'/},f={className:"subst",begin:/\$\(/,end:/\)/,keywords:s},g={className:"variable",begin:"\\$"+n},_={className:"string",contains:[e.BACKSLASH_ESCAPE,f,g],variants:[{begin:/\w*"""/,end:/"""\w*/,relevance:10},{begin:/\w*"/,end:/"\w*/}]},c={className:"string",contains:[e.BACKSLASH_ESCAPE,f,g],begin:"`",end:"`"},v={className:"meta",begin:"@"+n},p={className:"comment",variants:[{begin:"#=",end:"=#",relevance:10},{begin:"#",end:"$"}]};return l.name="Julia",l.contains=[u,a,_,c,v,p,e.HASH_COMMENT_MODE,{className:"keyword",begin:"\\b(((abstract|primitive)\\s+)type|(mutable\\s+)?struct)\\b"},{begin:/<:/}],f.contains=l.contains,l}const cm={name:"julia",register:lm};function um(e,n,t){navigator.clipboard.writeText(n.definition),re(t,!0),setTimeout(()=>{re(t,!1)},2e3)}var fm=Yn('<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>'),dm=Yn('<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>'),_m=pe('<td class="svelte-1u8rajr"> <div class="model-definition svelte-1u8rajr"><div class="code-wrapper svelte-1u8rajr"><!></div> <button class="copy-btn svelte-1u8rajr" aria-label="Copy to clipboard" title="Copy code"><!></button></div></td>');function mm(e,n){let t=Ee(!1);var r=_m(),i=H(r),s=_e(i),l=H(s),u=H(l);am(u,{language:cm,get code(){return n.definition}});var a=_e(l,2);a.__click=[um,n,t];var f=H(a);{var g=c=>{var v=fm();W(c,v)},_=c=>{var v=dm();W(c,v)};gn(f,c=>{O(t)?c(g):c(_,!1)})}Re(()=>{qe(i,`${n.name??""} `),a.disabled=O(t)}),W(e,r)}Ct(["click"]);var pm=pe('<th class="svelte-12yri61"> </th>'),gm=pe('<td class="svelte-12yri61"> </td>'),vm=pe('<a class="issue svelte-12yri61" target="_blank">(?)</a>'),hm=pe('<td class="svelte-12yri61"><!> <span> </span></td>'),ym=pe('<tr class="svelte-12yri61"><!><!></tr>'),bm=pe('<table id="results" class="svelte-12yri61"><thead><tr class="svelte-12yri61"><th class="svelte-12yri61">Model name \\\\ AD type</th><!></tr></thead><tbody></tbody></table>');function wm(e,n){hn(n,!0);const t=[...n.data.keys()],r=n.data.get(t[0]).keys(),i="https://github.com/EnzymeAD/Enzyme.jl/issues/1995",l={assume_mvnormal__EnzymeForward:i,assume_wishart__EnzymeForward:i,multithreaded__Mooncake:"https://github.com/chalk-lab/Mooncake.jl/issues/570"};var u=bm(),a=H(u),f=H(a),g=_e(H(f));_n(g,17,()=>r,dn,(c,v)=>{var p=pm(),x=H(p);Re(()=>qe(x,O(v))),W(c,p)});var _=_e(a);_n(_,21,()=>ht(n.data),dn,(c,v)=>{let p=()=>O(v)[0],x=()=>O(v)[1];var F=ym(),L=H(F);mm(L,{get name(){return p()},get definition(){return n.modelDefinitions[p()]}});var $=_e(L);_n($,17,()=>ht(x()),dn,(T,E)=>{let R=()=>O(E)[0],J=()=>O(E)[1];var N=Ot(),U=Kn(N);{var ae=ne=>{var ge=gm(),Ae=H(ge);Re(fe=>qe(Ae,fe),[()=>J().toFixed(3)]),W(ne,ge)},Ce=ne=>{var ge=hm(),Ae=H(ge);{var fe=Oe=>{var ye=vm();Re(()=>vt(ye,"href",l[`${p()}__${R()}`])),W(Oe,ye)};gn(Ae,Oe=>{l[`${p()}__${R()}`]&&Oe(fe)})}var He=_e(Ae,2),Xe=H(He);Re(()=>{It(He,1,$r(J()),"svelte-12yri61"),qe(Xe,J())}),W(ne,ge)};gn(U,ne=>{typeof J()=="number"?ne(ae):ne(Ce,!1)})}W(T,N)}),W(c,F)}),W(e,u),yn()}function Em(e,n){re(n,O(n)==="light"?"dark":"light",!0),document.documentElement.setAttribute("data-theme",O(n)),localStorage.setItem("theme",O(n))}var Dm=Yn('<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>'),xm=Yn('<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>'),Rm=pe("<h3> </h3> <!>",1),Mm=pe(`<div id="main-wrapper" class="svelte-3hkgjj"><main class="svelte-3hkgjj"><div class="header svelte-3hkgjj"><h1>Turing AD tests</h1> <button class="theme-toggle svelte-3hkgjj" aria-label="Toggle Dark Mode" title="Toggle theme"><!></button></div> <p><a href="https://turinglang.org/docs">Turing.jl documentation</a> | <a href="https://github.com/TuringLang/Turing.jl">Turing.jl GitHub</a> | <a href="https://github.com/TuringLang/ADTests">Source code for these tests</a></p> <p>This page is intended as a brief overview of how different AD
            ...
            comparisons of AD backends, you may wish to check out something like <a href="https://github.com/gradbench/gradbench" target="_blank">GradBench</a>.</p> <ul class="notes svelte-3hkgjj"><li>You can hover over the model names to see their definitions.</li> <li>The definitions of the AD types can be found in <a href="https://github.com/TuringLang/ADTests/blob/main/main.jl" target="_blank">the source code</a>.</li> <li><b>Numbers</b> indicate the time taken to calculate the gradient
                ...
                describes the problem.</li></ul> <div class="warning svelte-3hkgjj"><b>Note: The results here are run with Julia 1.11. Enzyme
                currently does not work on Julia 1.12.</b></div> <h2>Results</h2> <p><a href="adtests.json" target="_blank" download="">Download the raw data (JSON)</a></p> <!> <h2>Manifest</h2> <p>The tests above were run with the following package versions:</p> <!></main></div>`);function Tm(e,n){hn(n,!0);let t=Ee(ze(typeof document<"u"&&document.documentElement.getAttribute("data-theme")||"light")),r=new Map;for(const[p,x]of Object.entries(Da)){let F=x.__category__;delete x.__category__;let L=new Map;for(const[$,T]of Object.entries(x))L.set($,T);r.has(F)||r.set(F,new Map),r.get(F).set(p,L)}let i=new Map([...r.entries()].sort());var s=Mm(),l=H(s),u=H(l),a=_e(H(u),2);a.__click=[Em,t];var f=H(a);{var g=p=>{var x=Dm();W(p,x)},_=p=>{var x=xm();W(p,x)};gn(f,p=>{O(t)==="dark"?p(g):p(_,!1)})}var c=_e(u,16);_n(c,17,()=>i.entries(),dn,(p,x)=>{let F=()=>O(x)[0],L=()=>O(x)[1];var $=Rm(),T=Kn($),E=H(T),R=_e(T,2);wm(R,{get data(){return L()},modelDefinitions:Dl}),Re(()=>qe(E,F())),W(p,$)});var v=_e(c,6);nm(v,{}),W(e,s),yn()}Ct(["click"]);Qs(Tm,{target:document.getElementById("app")});
