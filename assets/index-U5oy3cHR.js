...
\r\f \v\uFEFF`];function ci(e,n,r){var t=e==null?"":""+e;if(n&&(t=t?t+" "+n:n),r){for(var i in r)if(r[i])t=t?t+" "+i:i;else if(t.length)for(var s=i.length,l=0;(l=t.indexOf(i,l))>=0;){var f=l+s;(l===0||lt.includes(t[l-1]))&&(f===t.length||lt.includes(t[f]))?t=(l===0?"":t.substring(0,l))+t.substring(f+1):l=f}}return t===""?null:t}function ct(e,n=!1){var r=n?" !important;":";",t="";for(var i in e){var s=e[i];s!=null&&s!==""&&(t+=" "+i+": "+s+r)}return t}function lr(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var r="",t,i;if(Array.isArray(n)?(t=n[0],i=n[1]):t=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];t&&a.push(...Object.keys(t).map(lr)),i&&a.push(...Object.keys(i).map(lr));var c=0,g=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&g===-1)g=_;else if(u===";"||_===F-1){if(g!==-1){var v=lr(e.substring(c,g).trim());if(!a.includes(v)){u!==";"&&_++;var p=e.substring(c,_).trim();r+=" "+p+";"}}c=_+1,g=-1}}}}return t&&(r+=ct(t)),i&&(r+=ct(i,!0)),r=r.trim(),r===""?null:r}return e==null?null:String(e)}function Or(e,n,r,t,i,s){var l=e.__className;if(l!==r||l===void 0){var f=ci(r,t,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=r}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function cr(e,n={},r,t){for(var i in r){var s=r[i];n[i]!==s&&(r[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,t))}}function fi(e,n,r,t){var i=e.__style;if(i!==n){var s=ui(n,t);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else t&&(Array.isArray(t)?(cr(e,r==null?void 0:r[0],t[0]),cr(e,r==null?void 0:r[1],t[1],"important")):cr(e,r,t));return t}const fn=Symbol("class"),cn=Symbol("style"),Gt=Symbol("is custom element"),Kt=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function br(e,n,r,t){var i=qt(e);i[n]!==(i[n]=r)&&(n==="loading"&&(e[Xo]=r),r==null?e.removeAttribute(n):typeof r!="string"&&Wt(e).includes(n)?e[n]=r:e.setAttribute(n,r))}function _i(e,n,r,t,i=!1){var s=qt(e),l=s[Gt],f=!s[Kt],a=n||{},c=e.tagName==="OPTION";for(var g in n)g in r||(r[g]=null);r.class?r.class=Zt(r.class):r.class=null,r[cn]&&(r.style??(r.style=null));var _=Wt(e);for(const x in r){let D=r[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";Or(e,u,D,t,n==null?void 0:n[fn],r[fn]),a[x]=D,a[fn]=r[fn];continue}if(x==="style"){fi(e,D,n==null?void 0:n[cn],r[cn]),a[x]=D,a[cn]=r[cn];continue}var v=a[x];if(D!==v){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let N=x.slice(2);var F=$s(N);if(Bs(N)&&(N=N.slice(0,-7),M.capture=!0),!F&&v){if(D!=null)continue;e.removeEventListener(N,a[ee],M),a[ee]=null}if(D!=null)if(F)e[`__${N}`]=D,Xs([N]);else{let U=function(Y){a[x].call(this,Y)};var H=U;a[ee]=Ws(N,e,U,M)}else F&&(e[`__${N}`]=void 0)}else if(x==="style")br(e,x,D);else if(x==="autofocus")Ks(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var C=x;f||(C=Hs(C));var z=C==="defaultValue"||C==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,C==="value"||C==="checked"){let M=e;const ee=n===void 0;if(C==="value"){let N=M.defaultValue;M.removeAttribute(C),M.defaultValue=N,M.value=M.__value=ee?N:null}else{let N=M.defaultChecked;M.removeAttribute(C),M.defaultChecked=N,M.checked=ee?N:!1}}else e.removeAttribute(x);else z||_.includes(C)&&(l||typeof D!="string")?e[C]=D:typeof D!="function"&&br(e,C,D)}}}for(let x of Object.getOwnPropertySymbols(r))x.description===hs&&ai(e,()=>r[x]);return a}function qt(e){return e.__attributes??(e.__attributes={[Gt]:e.nodeName.includes("-"),[Kt]:e.namespaceURI===ps})}var ut=new Map;function Wt(e){var n=ut.get(e.nodeName);if(n)return n;ut.set(e.nodeName,n=[]);for(var r,t=e,i=Element.prototype;i!==t;){r=vt(t);for(var s in r)r[s].set&&n.push(s);t=Er(t)}return n}function Lr(e=!1){const n=$,r=n.l.u;if(!r)return;let t=()=>gr(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});t=()=>O(l)}r.b.length&&Ms(()=>{ft(n,t),fr(r.b)}),ot(()=>{const i=Bn(()=>r.m.map(Go));return()=>{for(const s of i)typeof s=="function"&&s()}}),r.a.length&&ot(()=>{ft(n,t),fr(r.a)})}function ft(e,n){if(e.l.s)for(const r of e.l.s)O(r);n()}let Nn=!1;function mi(e){var n=Nn;try{return Nn=!1,[e(),Nn]}finally{Nn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,r){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Et)),e.special[n](r),rt(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),rt(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},gi)}const vi={get(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t)return t[n]}},set(e,n,r){let t=e.props.length;for(;t--;){let i=e.props[t];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(r),!0}return!1},getOwnPropertyDescriptor(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t){const i=je(t,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===qe||n===bt)return!1;for(let r of e.props)if(ln(r)&&(r=r()),r!=null&&n in r)return!0;return!1},ownKeys(e){const n=[];for(let r of e.props)if(ln(r)&&(r=r()),!!r){for(const t in r)n.includes(t)||n.push(t);for(const t of Object.getOwnPropertySymbols(r))n.includes(t)||n.push(t)}return n}};function pi(...e){return new Proxy({props:e},vi)}function dt(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,r,t){var ee;var i=(r&fs)!==0,s=!pn||(r&ds)!==0,l=(r&_s)!==0,f=(r&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var g=qe in e||bt in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(g&&n in e&&(N=>e[n]=N)))||void 0,u=t,v=!0,p=!1,F=()=>(p=!0,v&&(v=!1,f?u=Bn(t):u=t),u);c===void 0&&t!==void 0&&(_&&s&&ts(),c=F(),_&&_(c));var C;if(s)C=()=>{var N=e[n];return N===void 0?F():(v=!0,p=!1,N)};else{var z=(i?mn:Fr)(()=>e[n]);z.f|=qo,C=()=>{var N=O(z);return N!==void 0&&(u=void 0),N===void 0?u:N}}if((r&Et)===0)return C;if(_){var H=e.$$legacy;return function(N,U){return arguments.length>0?((!s||!U||H||a)&&_(U?C():N),N):C()}}var x=!1,D=Nr(c),M=mn(()=>{var N=C(),U=O(D);return x?(x=!1,U):D.v=N});return l&&O(M),i||(M.equals=Mr),function(N,U){if(arguments.length>0){const Y=U?O(M):s&&l?Ke(N):N;if(!M.equals(Y)){if(x=!0,fe(D,Y),p&&u!==void 0&&(u=Y),dt(M))return N;Bn(()=>O(M))}return N}return dt(M)?M.v:O(M)}}function hi(e,n,{bubbles:r=!1,cancelable:t=!1}={}){return new CustomEvent(e,{detail:n,bubbles:r,cancelable:t})}function bi(){const e=$;return e===null&&Dt(),(n,r,t)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=$n(i)?i.slice():[i],f=hi(n,r,t);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){$===null&&Dt(),$.l===null&&rs(),wi($).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var gt;typeof window<"u"&&((gt=window.__svelte??(window.__svelte={})).v??(gt.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.70255767130767,ForwardDiff:1.630203384036917,MooncakeForward:13.167812976452652,MooncakeReverse:5.72092917589595,ReverseDiff:30.940874035989715,ReverseDiffCompiled:2.796701189106252,Zygote:1833.5206441665239},Ri={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.26369863013699,ForwardDiff:1.289966465062012,MooncakeForward:11.13836095185738,MooncakeReverse:7.0884893983341355,ReverseDiff:32.76283472624936,ReverseDiffCompiled:2.8683529411764703,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.92605070614258,ForwardDiff:1.3378550108807241,MooncakeForward:22.36192071659345,MooncakeReverse:6.399492511449437,ReverseDiff:30.508525149190113,ReverseDiffCompiled:2.853484413176326,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.54077609462544,ForwardDiff:1.3639777436093274,MooncakeForward:23.579921602787454,MooncakeReverse:6.087356747767615,ReverseDiff:28.828982085821412,ReverseDiffCompiled:2.6996252995493277,Zygote:2096.6067411653726},Ti={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.524461839530325,ForwardDiff:1.3248176313777356,MooncakeForward:28.15444909592945,MooncakeReverse:5.3412560386473436,ReverseDiff:21.871457311262485,ReverseDiffCompiled:2.001392079070091,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.08874308126535,ForwardDiff:1.4148155280733923,MooncakeForward:44.542106599905665,MooncakeReverse:7.363931762794476,ReverseDiff:49.84735856984606,ReverseDiffCompiled:2.6832612088535757,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:64.7539312754805,ForwardDiff:1.3883056284631088,MooncakeForward:40.22855274154282,MooncakeReverse:7.536886692552066,ReverseDiff:50.70246093315022,ReverseDiffCompiled:2.9065694251369694,Zygote:1661.7601935280302},Si={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.14512066007082,ForwardDiff:1.4578717950062121,MooncakeForward:39.39157004073958,MooncakeReverse:7.519666282866796,ReverseDiff:52.71900553701734,ReverseDiffCompiled:2.7932385621533626,Zygote:1444.4988579094304},Ai={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.06711259754738,ForwardDiff:1.392111433871137,MooncakeForward:24.7606625845043,MooncakeReverse:6.183031869078381,ReverseDiff:32.38758074598874,ReverseDiffCompiled:3.2404046144677694,Zygote:2172.509399175765},Ci={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:56.57732874430998,ForwardDiff:1.314939608839337,MooncakeForward:27.329276174062908,MooncakeReverse:5.084973324382575,ReverseDiff:28.8102295443579,ReverseDiffCompiled:1.8997020484171323,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.343160768975316,ForwardDiff:1.3786855818357624,MooncakeForward:32.90022172949002,MooncakeReverse:6.068637614842884,ReverseDiff:42.13618229522338,ReverseDiffCompiled:2.4447949526813884,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.3122364416413,ForwardDiff:1.28075616795129,MooncakeForward:33.09500942624408,MooncakeReverse:5.3170164917541225,ReverseDiff:33.705689277899346,ReverseDiffCompiled:2.7012993165855335,Zygote:"error"},Oi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:151.3480456778921,ForwardDiff:2.4081595220626766,MooncakeForward:55.82252090572377,MooncakeReverse:6.052289361702128,ReverseDiff:55.15656159255502,ReverseDiffCompiled:6.619892996108949,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.475457927876356,ForwardDiff:1.2828249902515108,MooncakeForward:36.96454948301329,MooncakeReverse:5.80473687999424,ReverseDiff:36.64879877794751,ReverseDiffCompiled:2.710712642820733,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.83225388601036,ForwardDiff:1.3038261248984264,MooncakeForward:36.46149153576331,MooncakeReverse:5.967675471429081,ReverseDiff:41.17205943618942,ReverseDiffCompiled:2.424927478243473,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.32692023633678,ForwardDiff:1.2295520299753369,MooncakeForward:30.79224178109203,MooncakeReverse:5.087159410664663,ReverseDiff:33.11238316064054,ReverseDiffCompiled:1.912356858903874,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:76.05310229178312,ForwardDiff:1.4370569522832222,MooncakeForward:31.015112185755434,MooncakeReverse:4.979703627394655,ReverseDiff:20.6628325479574,ReverseDiffCompiled:1.9139720489317955,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:23.686209386281586,ForwardDiff:1.6765406761302093,MooncakeForward:17.483478558004443,MooncakeReverse:7.605980720792378,ReverseDiff:57.13068828704502,ReverseDiffCompiled:5.343005381493377,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.795075456711675,ForwardDiff:3.843532585545932,MooncakeForward:8.099003014143287,MooncakeReverse:31.133541465130598,ReverseDiff:11.003899050049625,ReverseDiffCompiled:3.9369968051118214,Zygote:190.37811876247505},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:164.9996158131315,ForwardDiff:3.0331183944446565,MooncakeForward:45.984440227703985,MooncakeReverse:3.7411456204876714,ReverseDiff:22.48651533344769,ReverseDiffCompiled:1.9316780953848525,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135379.60779645192,ForwardDiff:18170.08520962293,MooncakeForward:32060.339191709845,MooncakeReverse:16.775695671592523,ReverseDiff:5.462432544624325,ReverseDiffCompiled:1.9967281769401912,Zygote:36.833054490777016},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:17.907669360308628,MooncakeForward:447.41504081594866,MooncakeReverse:35.355729109767495,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:7206.17865454645,ForwardDiff:192.6073702817631,MooncakeForward:459.3608765039668,MooncakeReverse:10.164686764541074,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Gi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.54926030846711,ForwardDiff:1.1572493890084181,MooncakeForward:24.281059063136453,MooncakeReverse:10.176666101407497,ReverseDiff:12.796590083718797,ReverseDiffCompiled:1.2198538119729203,Zygote:887.2249694335009},Ki={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1264.8422083273947,ForwardDiff:"wrong",MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1302.482912025382,ForwardDiff:445.64434845212384,MooncakeForward:1854.4390547917435,MooncakeReverse:24.587437486004326,ReverseDiff:18.8434895001307,ReverseDiffCompiled:3.766616138059702,Zygote:74.49237717136236},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6783.470433294357,ForwardDiff:83.24781840185992,MooncakeForward:1181.381915248582,MooncakeReverse:3.444607658093847,ReverseDiff:34.037251923399765,ReverseDiffCompiled:3.0019377301537062,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.58676132804344,ForwardDiff:1.3584905660377358,MooncakeForward:23.40530005129082,MooncakeReverse:6.275030998140113,ReverseDiff:32.290235619507754,ReverseDiffCompiled:2.642400580451232,Zygote:1670.5093511649777},Ji={__category__:"Miscellaneous features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.401685788182238,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.40404224991777,ForwardDiff:1.2968256923022374,MooncakeForward:26.74306003873467,MooncakeReverse:13.18564479681336,ReverseDiff:31.21148025236133,ReverseDiffCompiled:2.32551361434234,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:15.679093459323786,ForwardDiff:.8824240986717267,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"wrong",ReverseDiffCompiled:.30792397047954195,Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:138.59620729690744,ForwardDiff:1.7164187934073996,MooncakeForward:41.65136333484621,MooncakeReverse:4.456560158348649,ReverseDiff:20.96473649052491,ReverseDiffCompiled:1.852046027098795,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:625.6961309523809,ForwardDiff:8.676682781703235,MooncakeForward:131.5012586998371,MooncakeReverse:4.1571321882001495,ReverseDiff:20.51816043414643,ReverseDiffCompiled:1.8607778314327106,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1275.906038017145,ForwardDiff:14.23383869901986,MooncakeForward:234.61324904809433,MooncakeReverse:4.080505952380952,ReverseDiff:20.632506479081822,ReverseDiffCompiled:2.0140902216812364,Zygote:"error"},ta={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.626621276595746,ForwardDiff:1.4424672107861125,MooncakeForward:16.530214592274678,MooncakeReverse:6.635062899205483,ReverseDiff:21.78001779688439,ReverseDiffCompiled:2.1772619557920785,Zygote:2262.289746349996},oa={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6707.669126196867,ForwardDiff:76.88629663227124,MooncakeForward:1205.9175355174568,MooncakeReverse:4.026838136468458,ReverseDiff:20.438476477579062,ReverseDiffCompiled:1.8911493826808474,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.157023667631535,ForwardDiff:1.6529446163592505,MooncakeForward:12.552223371251293,MooncakeReverse:5.836827810972299,ReverseDiff:34.972784273851886,ReverseDiffCompiled:3.183396647463613,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:17.630335739819163,ForwardDiff:1.2590885640584695,MooncakeForward:8.797237915881983,MooncakeReverse:8.350788002033553,ReverseDiff:12.532718894009216,ReverseDiffCompiled:2.460496041629349,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.38790295099843,ForwardDiff:1.6842871570957836,MooncakeForward:16.31918674184179,MooncakeReverse:7.3922779937408585,ReverseDiff:59.0469260620915,ReverseDiffCompiled:5.2858096301648825,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.255871922878296,ForwardDiff:1.53787839241903,MooncakeForward:18.040045075693143,MooncakeReverse:6.735868354512712,ReverseDiff:35.18342043330795,ReverseDiffCompiled:3.279877909730384,Zygote:3396.3503156457946},ca={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:49.83241861257883,ForwardDiff:1.3332256227977042,MooncakeForward:23.789929053469457,MooncakeReverse:5.5885056943775195,ReverseDiff:24.03952459922609,ReverseDiffCompiled:2.277573529411765,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:23.101118967529345,ForwardDiff:1.44463581710304,MooncakeForward:13.419253700657897,MooncakeReverse:5.711374936580416,ReverseDiff:26.796319186924872,ReverseDiffCompiled:2.598003694231316,Zygote:3237.4351725822776},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:19.5050178601803,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:3.3756726420388894,Zygote:2482.6687285685466},da={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135.05077056027653,ForwardDiff:1.776115798452321,MooncakeForward:58.10926465938236,MooncakeReverse:5.149773489005931,ReverseDiff:32.0177633665809,ReverseDiffCompiled:2.513405345520011,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:133.410231710948,ForwardDiff:1.8841748812140984,MooncakeForward:59.09930740927783,MooncakeReverse:5.102441104359877,ReverseDiff:28.487292737672867,ReverseDiffCompiled:2.667485691371077,Zygote:"error"},ma={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:33.937175313430764,ForwardDiff:1.2792351785220553,MooncakeForward:20.118875953997115,MooncakeReverse:5.496435700028514,ReverseDiff:12.650504977895986,ReverseDiffCompiled:1.2040989340637192,Zygote:2589.187502209027},ga={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:43.87273332515725,ForwardDiff:1.078363360254021,MooncakeForward:23.184898929845424,MooncakeReverse:12.216537087623449,ReverseDiff:15.578419505447002,ReverseDiffCompiled:4.029309904852175,Zygote:456.8291233283804},va={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:36.31904745080027,ForwardDiff:1.3558827026160851,MooncakeForward:25.321923503325944,MooncakeReverse:6.493597744187121,ReverseDiff:27.33057410339368,ReverseDiffCompiled:2.9479532369049295,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.078959006633777,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:37.28321474994869,ForwardDiff:1.5990993877231556,MooncakeForward:29.23700887198986,MooncakeReverse:7.237047732291489,ReverseDiff:19.988996556987185,ReverseDiffCompiled:"wrong",Zygote:2117.7727065267004},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Fi,demo_assume_multivariate_observe:Ni,demo_assume_multivariate_observe_literal:Si,demo_assume_observe_literal:Ai,demo_assume_submodel_observe_index_literal:Ci,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Ii,assume_lkjcholu:Oi,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:$i,dppl_high_dim_gauss:Ui,dppl_hmm_semisup:Hi,dppl_lda:Zi,assume_mvnormal:Gi,dppl_logistic_regression:Ki,dppl_naive_bayes:qi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ra,assume_normal:ta,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:ua,observe_von_mises:fa,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:ga,broadcast_macro:va,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
