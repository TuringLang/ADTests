...
\r\f \v\uFEFF`];function ui(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var i in t)if(t[i])r=r?r+" "+i:i;else if(r.length)for(var s=i.length,l=0;(l=r.indexOf(i,l))>=0;){var u=l+s;(l===0||ar.includes(r[l-1]))&&(u===r.length||ar.includes(r[u]))?r=(l===0?"":r.substring(0,l))+r.substring(u+1):l=u}}return r===""?null:r}function lr(e,n=!1){var t=n?" !important;":";",r="";for(var i in e){var s=e[i];s!=null&&s!==""&&(r+=" "+i+": "+s+t)}return r}function at(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function fi(e,n){if(n){var t="",r,i;if(Array.isArray(n)?(r=n[0],i=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,u=!1,a=[];r&&a.push(...Object.keys(r).map(at)),i&&a.push(...Object.keys(i).map(at));var f=0,g=-1;const x=e.length;for(var _=0;_<x;_++){var c=e[_];if(u?c==="/"&&e[_-1]==="*"&&(u=!1):s?s===c&&(s=!1):c==="/"&&e[_+1]==="*"?u=!0:c==='"'||c==="'"?s=c:c==="("?l++:c===")"&&l--,!u&&s===!1&&l===0){if(c===":"&&g===-1)g=_;else if(c===";"||_===x-1){if(g!==-1){var v=at(e.substring(f,g).trim());if(!a.includes(v)){c!==";"&&_++;var p=e.substring(f,_).trim();t+=" "+p+";"}}f=_+1,g=-1}}}}return r&&(t+=lr(r)),i&&(t+=lr(i,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function It(e,n,t,r,i,s){var l=e.__className;if(l!==t||l===void 0){var u=ui(t,r,s);u==null?e.removeAttribute("class"):n?e.className=u:e.setAttribute("class",u),e.__className=t}else if(s&&i!==s)for(var a in s){var f=!!s[a];(i==null||f!==!!i[a])&&e.classList.toggle(a,f)}return s}function lt(e,n={},t,r){for(var i in t){var s=t[i];n[i]!==s&&(t[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,r))}}function di(e,n,t,r){var i=e.__style;if(i!==n){var s=fi(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(lt(e,t==null?void 0:t[0],r[0]),lt(e,t==null?void 0:t[1],r[1],"important")):lt(e,t,r));return r}const fn=Symbol("class"),cn=Symbol("style"),Ur=Symbol("is custom element"),Hr=Symbol("is html");function _i(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function vt(e,n,t,r){var i=Kr(e);i[n]!==(i[n]=t)&&(n==="loading"&&(e[Yo]=t),t==null?e.removeAttribute(n):typeof t!="string"&&Gr(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function mi(e,n,t,r,i=!1){var s=Kr(e),l=s[Ur],u=!s[Hr],a=n||{},f=e.tagName==="OPTION";for(var g in n)g in t||(t[g]=null);t.class?t.class=$r(t.class):t.class=null,t[cn]&&(t.style??(t.style=null));var _=Gr(e);for(const T in t){let E=t[T];if(f&&T==="value"&&E==null){e.value=e.__value="",a[T]=E;continue}if(T==="class"){var c=e.namespaceURI==="http://www.w3.org/1999/xhtml";It(e,c,E,r,n==null?void 0:n[fn],t[fn]),a[T]=E,a[fn]=t[fn];continue}if(T==="style"){di(e,E,n==null?void 0:n[cn],t[cn]),a[T]=E,a[cn]=t[cn];continue}var v=a[T];if(E!==v){a[T]=E;var p=T[0]+T[1];if(p!=="$$")if(p==="on"){const R={},J="$$"+T;let S=T.slice(2);var x=Us(S);if(qs(S)&&(S=S.slice(0,-7),R.capture=!0),!x&&v){if(E!=null)continue;e.removeEventListener(S,a[J],R),a[J]=null}if(E!=null)if(x)e[`__${S}`]=E,At([S]);else{let U=function(ae){a[T].call(this,ae)};var $=U;a[J]=Js(S,e,U,R)}else x&&(e[`__${S}`]=void 0)}else if(T==="style")vt(e,T,E);else if(T==="autofocus")Ws(e,!!E);else if(!l&&(T==="__value"||T==="value"&&E!=null))e.value=e.__value=E;else if(T==="selected"&&f)_i(e,E);else{var F=T;u||(F=Ks(F));var L=F==="defaultValue"||F==="defaultChecked";if(E==null&&!l&&!L)if(s[T]=null,F==="value"||F==="checked"){let R=e;const J=n===void 0;if(F==="value"){let S=R.defaultValue;R.removeAttribute(F),R.defaultValue=S,R.value=R.__value=J?S:null}else{let S=R.defaultChecked;R.removeAttribute(F),R.defaultChecked=S,R.checked=J?S:!1}}else e.removeAttribute(T);else L||_.includes(F)&&(l||typeof E!="string")?e[F]=E:typeof E!="function"&&vt(e,F,E)}}}for(let T of Object.getOwnPropertySymbols(t))T.description===bs&&li(e,()=>t[T]);return a}function Kr(e){return e.__attributes??(e.__attributes={[Ur]:e.nodeName.includes("-"),[Hr]:e.namespaceURI===ys})}var cr=new Map;function Gr(e){var n=cr.get(e.nodeName);if(n)return n;cr.set(e.nodeName,n=[]);for(var t,r=e,i=Element.prototype;i!==r;){t=pr(r);for(var s in t)t[s].set&&n.push(s);r=bt(r)}return n}function Zr(e=!1){const n=q,t=n.l.u;if(!t)return;let r=()=>mt(n.s);if(e){let i=0,s={};const l=mn(()=>{let u=!1;const a=n.s;for(const f in a)a[f]!==s[f]&&(s[f]=a[f],u=!0);return u&&i++,i});r=()=>O(l)}t.b.length&&Ts(()=>{ur(n,r),ut(t.b)}),rr(()=>{const i=jn(()=>t.m.map(Zo));return()=>{for(const s of i)typeof s=="function"&&s()}}),t.a.length&&rr(()=>{ur(n,r),ut(t.a)})}function ur(e,n){if(e.l.s)for(const t of e.l.s)O(t);n()}let Fn=!1;function pi(e){var n=Fn;try{return Fn=!1,[e(),Fn]}finally{Fn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Ve({get[n](){return e.props[n]}},n,wr)),e.special[n](t),nr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),nr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function Vn(e,n){return new Proxy({props:e,exclude:n,special:{},version:en(0)},gi)}const vi={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let i=e.props[r];ln(i)&&(i=i());const s=Be(i,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const i=Be(r,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===Ze||n===hr)return!1;for(let t of e.props)if(ln(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(ln(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function hi(...e){return new Proxy({props:e},vi)}function fr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Ve(e,n,t,r){var J;var i=(t&_s)!==0,s=!vn||(t&ms)!==0,l=(t&ps)!==0,u=(t&gs)!==0,a=!1,f;l?[f,a]=pi(()=>e[n]):f=e[n];var g=Ze in e||hr in e,_=l&&(((J=Be(e,n))==null?void 0:J.set)??(g&&n in e&&(S=>e[n]=S)))||void 0,c=r,v=!0,p=!1,x=()=>(p=!0,v&&(v=!1,u?c=jn(r):c=r),c);f===void 0&&r!==void 0&&(_&&s&&ss(),f=x(),_&&_(f));var F;if(s)F=()=>{var S=e[n];return S===void 0?x():(v=!0,p=!1,S)};else{var L=(i?mn:Mt)(()=>e[n]);L.f|=Xo,F=()=>{var S=O(L);return S!==void 0&&(c=void 0),S===void 0?c:S}}if((t&wr)===0)return F;if(_){var $=e.$$legacy;return function(S,U){return arguments.length>0?((!s||!U||$||a)&&_(U?F():S),S):F()}}var T=!1,E=Tt(f),R=mn(()=>{var S=F(),U=O(E);return T?(T=!1,U):E.v=S});return l&&O(R),i||(R.equals=Dt),function(S,U){if(arguments.length>0){const ae=U?O(R):s&&l?ze(S):S;if(!R.equals(ae)){if(T=!0,re(E,ae),p&&c!==void 0&&(c=ae),fr(R))return S;jn(()=>O(R))}return S}return fr(R)?R.v:O(R)}}function yi(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function bi(){const e=q;return e===null&&Er(),(n,t,r)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=Bn(i)?i.slice():[i],u=yi(n,t,r);for(const a of l)a.call(e.x,u);return!u.defaultPrevented}return!0}}function wi(e){q===null&&Er(),q.l===null&&os(),Ei(q).a.push(e)}function Ei(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Di="5";var mr;typeof window<"u"&&((mr=window.__svelte??(window.__svelte={})).v??(mr.v=new Set)).add(Di);const xi={__category__:"External libraries",EnzymeFwd:"error",EnzymeRvs:"wrong",FiniteDifferences:96.88268076593313,ForwardDiff:2.172071025361171,MooncakeFwd:22.51890519187359,MooncakeRvs:7.819837421065485,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:762.0254176781378},Ri={__category__:"Distributions",EnzymeFwd:3.4143242580328677,EnzymeRvs:"error",FiniteDifferences:37.2980098656234,ForwardDiff:2.002682190005328,MooncakeFwd:4.811999321918969,MooncakeRvs:3.27111363971556,ReverseDiff:72.47445181030085,ReverseDiffCompiled:72.55881850776849,Zygote:3151.969977924945},Mi={__category__:"External libraries",EnzymeFwd:"error",EnzymeRvs:"error",FiniteDifferences:62.25049705775226,ForwardDiff:1.2206688040932272,MooncakeFwd:493.9973386778815,MooncakeRvs:12.001770016807722,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Ti={__category__:"DynamicPPL demo models",EnzymeFwd:5.713993604708513,EnzymeRvs:3.9377970566340257,FiniteDifferences:79.58354697202758,ForwardDiff:1.6394333398020566,MooncakeFwd:10.73941323000277,MooncakeRvs:5.069220152524103,ReverseDiff:145.7541718383671,ReverseDiffCompiled:149.48134831460675,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeFwd:4.14609120868005,EnzymeRvs:3.2740303122564045,FiniteDifferences:68.5393379458922,ForwardDiff:2.195257617737313,MooncakeFwd:9.212604254059123,MooncakeRvs:5.643399445933212,ReverseDiff:98.72211984711984,ReverseDiffCompiled:107.77773060184695,Zygote:7056.102501276161},Ni={__category__:"DynamicPPL demo models",EnzymeFwd:8.152240222327663,EnzymeRvs:10.822496199966222,FiniteDifferences:84.15070590236434,ForwardDiff:1.7250706264389195,MooncakeFwd:14.041380488638307,MooncakeRvs:4.9627434377646065,ReverseDiff:71.37037037037037,ReverseDiffCompiled:71.79255591599797,Zygote:"error"},Si={__category__:"DynamicPPL demo models",EnzymeFwd:9.859324482355369,EnzymeRvs:13.509350030215538,FiniteDifferences:102.44399101460128,ForwardDiff:1.6241485683226942,MooncakeFwd:17.26797837393923,MooncakeRvs:7.482981238819735,ReverseDiff:118.81146170902268,ReverseDiffCompiled:103.72677688767683,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeFwd:11.884649731229407,EnzymeRvs:13.532748679253665,FiniteDifferences:89.4150705949282,ForwardDiff:1.38100476263635,MooncakeFwd:17.028369780620935,MooncakeRvs:6.217201801715002,ReverseDiff:101.76606431086564,ReverseDiffCompiled:103.53109299988836,Zygote:3887.5124190877614},Ai={__category__:"DynamicPPL demo models",EnzymeFwd:10.96334978766651,EnzymeRvs:13.783728981206727,FiniteDifferences:85.7311798521763,ForwardDiff:1.6095321046580495,MooncakeFwd:17.060852145773943,MooncakeRvs:6.859459850843531,ReverseDiff:111.87983596409781,ReverseDiffCompiled:109.1245987308697,Zygote:2974.447169811321},Ci={__category__:"DynamicPPL demo models",EnzymeFwd:5.7014290468042965,EnzymeRvs:3.7817763647432865,FiniteDifferences:77.31106006125981,ForwardDiff:1.926722210489474,MooncakeFwd:9.927183923407771,MooncakeRvs:5.657471391566661,ReverseDiff:146.59846753595914,ReverseDiffCompiled:146.94952703050697,Zygote:8706.544013017812},Oi={__category__:"DynamicPPL demo models",EnzymeFwd:8.166652004247911,EnzymeRvs:11.344862556452416,FiniteDifferences:70.38900700617857,ForwardDiff:1.510236252929607,MooncakeFwd:14.577777777777776,MooncakeRvs:5.431792884818599,ReverseDiff:98.6413002566296,ReverseDiffCompiled:80.21252488992344,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeFwd:10.927599249342208,EnzymeRvs:14.724012094672089,FiniteDifferences:81.07107210462914,ForwardDiff:1.4436845822898605,MooncakeFwd:16.113721997670755,MooncakeRvs:6.103108003108003,ReverseDiff:107.3987679102928,ReverseDiffCompiled:106.36096027436412,Zygote:"error"},Li={__category__:"Distributions",EnzymeFwd:6.11799077396207,EnzymeRvs:9.994257728361193,FiniteDifferences:27.24513379921595,ForwardDiff:1.2137086231571008,MooncakeFwd:4.532125138122422,MooncakeRvs:5.928296985027689,ReverseDiff:58.606497703691105,ReverseDiffCompiled:60.89246307927347,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeFwd:7.7002001908361235,EnzymeRvs:11.092576196151882,FiniteDifferences:82.62300285684054,ForwardDiff:1.8034119325682048,MooncakeFwd:14.197184054283289,MooncakeRvs:5.2882856212439675,ReverseDiff:74.49325085146312,ReverseDiffCompiled:96.8384471309382,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeFwd:8.732940293977501,EnzymeRvs:9.938259585039951,FiniteDifferences:82.22157096609304,ForwardDiff:1.563880106854888,MooncakeFwd:14.442222222222222,MooncakeRvs:5.496265489730096,ReverseDiff:99.83134942302792,ReverseDiffCompiled:102.64873949579834,Zygote:"error"},ji={__category__:"DynamicPPL demo models",EnzymeFwd:10.00793128528383,EnzymeRvs:14.27700817005278,FiniteDifferences:76.76360225140714,ForwardDiff:1.4671417683171946,MooncakeFwd:16.285466598674144,MooncakeRvs:6.8122918454935615,ReverseDiff:95.47481445849368,ReverseDiffCompiled:99.30949580788345,Zygote:"error"},Vi={__category__:"DynamicPPL demo models",EnzymeFwd:10.367405895377802,EnzymeRvs:15.277993612231006,FiniteDifferences:79.64747772268,ForwardDiff:2.303542235072698,MooncakeFwd:15.223124893508263,MooncakeRvs:5.906974331306675,ReverseDiff:104.22800408407562,ReverseDiffCompiled:103.2926846515575,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeFwd:3.887590039102696,EnzymeRvs:2.635804205779678,FiniteDifferences:116.5766455804411,ForwardDiff:1.538225555572667,MooncakeFwd:17.05407006063165,MooncakeRvs:4.344186437826013,ReverseDiff:58.66319218241042,ReverseDiffCompiled:59.68736907868143,Zygote:"error"},qi={__category__:"Core Turing syntax",EnzymeFwd:9.359452881363584,EnzymeRvs:5.184055719088964,FiniteDifferences:114.21307386104583,ForwardDiff:3.9161774783675396,MooncakeFwd:12.722770014664384,MooncakeRvs:13.107523526022662,ReverseDiff:385.9684951557817,ReverseDiffCompiled:394.1369200014028,Zygote:"error"},$i={__category__:"DynamicPPL arXiV paper",EnzymeFwd:5.86042471042471,EnzymeRvs:6.869275233437084,FiniteDifferences:26.324435063322568,ForwardDiff:4.451409007110877,MooncakeFwd:4.135064023855464,MooncakeRvs:34.052141087648934,ReverseDiff:213.52404646209146,ReverseDiffCompiled:203.08125195129563,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeFwd:6.53142704910754,EnzymeRvs:2.4361912517449973,FiniteDifferences:184.1622957867584,ForwardDiff:4.631655214322441,MooncakeFwd:32.6115632893629,MooncakeRvs:4.206932883784638,ReverseDiff:91.65629504623283,ReverseDiffCompiled:87.39002589295217,Zygote:"error"},Hi={__category__:"DynamicPPL arXiV paper",EnzymeFwd:54141.457301341594,EnzymeRvs:6.255209761447765,FiniteDifferences:143183.22034835498,ForwardDiff:17200.482356249122,MooncakeFwd:36138.34665019221,MooncakeRvs:22.774918522542098,ReverseDiff:11.999865120043161,ReverseDiffCompiled:11.489882417281924,Zygote:"error"},Ki={__category__:"DynamicPPL arXiV paper",EnzymeFwd:59.762401546847855,EnzymeRvs:"error",FiniteDifferences:"NaN",ForwardDiff:26.12144066784633,MooncakeFwd:4303.256280047911,MooncakeRvs:5.772646373559994,ReverseDiff:69.27747953885418,ReverseDiffCompiled:66.203565144464,Zygote:"error"},Gi={__category__:"Distributions",EnzymeFwd:4.914742764154063,EnzymeRvs:20.47004923413567,FiniteDifferences:160.55043543852432,ForwardDiff:2.6220761349707433,MooncakeFwd:22.133844373185585,MooncakeRvs:4.246735754911197,ReverseDiff:68.16137438304628,ReverseDiffCompiled:67.49189975076156,Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeFwd:313.89571964345896,EnzymeRvs:"error",FiniteDifferences:3464.8072083530715,ForwardDiff:151.31593613226266,MooncakeFwd:403.26715144057704,MooncakeRvs:9.855296579593015,ReverseDiff:84.23238962245024,ReverseDiffCompiled:79.64812393053955,Zygote:"error"},Wi={__category__:"DynamicPPL arXiV paper",EnzymeFwd:42.7227423385605,EnzymeRvs:3.622313713941452,FiniteDifferences:1073.9806677007055,ForwardDiff:51.80591250923936,MooncakeFwd:170.18593728573387,MooncakeRvs:5.082060216906152,ReverseDiff:63.17576178043927,ReverseDiffCompiled:67.21102797283298,Zygote:168.41589092157537},Xi={__category__:"DynamicPPL arXiV paper",EnzymeFwd:115.05939860849438,EnzymeRvs:.9665250946414043,FiniteDifferences:3066.291429343299,ForwardDiff:152.03136426008473,MooncakeFwd:426.391561485187,MooncakeRvs:4.377606638212137,ReverseDiff:179.5472969609315,ReverseDiffCompiled:143.9387641938979,Zygote:"error"},Ji={__category__:"DynamicPPL arXiV paper",EnzymeFwd:217.9166577109081,EnzymeRvs:4.36425132467253,FiniteDifferences:6496.168758584114,ForwardDiff:128.6635395172513,MooncakeFwd:1357.1488044779935,MooncakeRvs:3.9592109088026217,ReverseDiff:105.97422584089695,ReverseDiffCompiled:107.89213586706063,Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeFwd:3.5301750640478224,EnzymeRvs:2.9562542809077113,FiniteDifferences:59.88699643039265,ForwardDiff:1.5147370406415739,MooncakeFwd:7.931578418404399,MooncakeRvs:4.216656571025924,ReverseDiff:107.60362083689154,ReverseDiffCompiled:107.2167841788478,Zygote:4617.750761140326},Qi={__category__:"External libraries",EnzymeFwd:"error",EnzymeRvs:17.296693146129687,FiniteDifferences:257.10885206263083,ForwardDiff:3.192134701879829,MooncakeFwd:45.29809971002546,MooncakeRvs:17.844940300866394,ReverseDiff:65.58601333177407,ReverseDiffCompiled:64.40866810655147,Zygote:"error"},ea={__category__:"Core Turing syntax",EnzymeFwd:4.672077028885832,EnzymeRvs:5.419739292364991,FiniteDifferences:68.99101178610148,ForwardDiff:1.2202372356884994,MooncakeFwd:12.039810329535376,MooncakeRvs:5.067020984775752,ReverseDiff:60.046084558181754,ReverseDiffCompiled:57.92190295758342,Zygote:"error"},na={__category__:"Base Julia features",EnzymeFwd:4.993960846152555,EnzymeRvs:17.783989749123283,FiniteDifferences:13.757591178965225,ForwardDiff:.9692668136714443,MooncakeFwd:"error",MooncakeRvs:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ta={__category__:"Effect of model size",EnzymeFwd:5.420721952553497,EnzymeRvs:2.712041774781547,FiniteDifferences:178.80998147089886,ForwardDiff:2.53129792645977,MooncakeFwd:29.41025857698158,MooncakeRvs:3.9026200851787074,ReverseDiff:55.48183782671331,ReverseDiffCompiled:56.72764158918005,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeFwd:25.593050587634135,EnzymeRvs:4.55036288408058,FiniteDifferences:679.0068125516102,ForwardDiff:12.773438302241999,MooncakeFwd:131.3145185939888,MooncakeRvs:4.003499798088572,ReverseDiff:56.476305359296916,ReverseDiffCompiled:54.31150143556832,Zygote:"error"},oa={__category__:"Distributions",EnzymeFwd:"error",EnzymeRvs:4.315704504230729,FiniteDifferences:44.09986572097507,ForwardDiff:1.4070707750507407,MooncakeFwd:14.953643804685296,MooncakeRvs:9.204882635648115,ReverseDiff:18.91260261424092,ReverseDiffCompiled:19.18036992417263,Zygote:1019.313205043132},sa={__category__:"Effect of model size",EnzymeFwd:49.77670312877021,EnzymeRvs:4.645826638817481,FiniteDifferences:1296.6189436220984,ForwardDiff:17.243020175259833,MooncakeFwd:258.15385850799004,MooncakeRvs:3.905436197916666,ReverseDiff:62.57702874757087,ReverseDiffCompiled:53.03200538038533,Zygote:"error"},ia={__category__:"Effect of model size",EnzymeFwd:243.44797322424694,EnzymeRvs:4.189989255677818,FiniteDifferences:6636.333494298132,ForwardDiff:75.92392255315912,MooncakeFwd:1254.1454169797144,MooncakeRvs:3.7878185907046475,ReverseDiff:50.61071163825056,ReverseDiffCompiled:51.0655663915979,Zygote:"error"},aa={__category__:"Distributions",EnzymeFwd:3.0378860833822663,EnzymeRvs:2.836552826565595,FiniteDifferences:32.05602174282317,ForwardDiff:1.8510106093886176,MooncakeFwd:4.605002730002729,MooncakeRvs:3.7557499125393576,ReverseDiff:71.09810494629541,ReverseDiffCompiled:70.9435645243344,Zygote:"error"},la={__category__:"Distributions",EnzymeFwd:2.0404197405717936,EnzymeRvs:8.078338144563311,FiniteDifferences:20.175705355634395,ForwardDiff:1.187247233187223,MooncakeFwd:4.411612864040816,MooncakeRvs:7.021190032208849,ReverseDiff:17.0250461641766,ReverseDiffCompiled:17.095681625740898,Zygote:"error"},ca={__category__:"Core Turing syntax",EnzymeFwd:9.31676176103781,EnzymeRvs:5.241036131481587,FiniteDifferences:116.00384200276858,ForwardDiff:3.6977686417163325,MooncakeFwd:12.86997273108656,MooncakeRvs:12.98306025183037,ReverseDiff:402.49534301800236,ReverseDiffCompiled:390.13620653540005,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeFwd:11.923273390190888,EnzymeRvs:5.500721689072922,FiniteDifferences:148.58387783539487,ForwardDiff:3.7308396475991636,MooncakeFwd:14.923862671742489,MooncakeRvs:11.29552795053186,ReverseDiff:303.85548148684876,ReverseDiffCompiled:306.3829908469303,Zygote:21331.868962529785},fa={__category__:"Core Turing syntax",EnzymeFwd:3.7187401352295155,EnzymeRvs:4.2442543227665706,FiniteDifferences:76.02297907263028,ForwardDiff:1.7651702000730127,MooncakeFwd:12.853978906999043,MooncakeRvs:5.05499853916811,ReverseDiff:68.39630706103607,ReverseDiffCompiled:69.00094030786376,Zygote:"error"},da={__category__:"Core Turing syntax",EnzymeFwd:13.295560283261567,EnzymeRvs:4.714044170036244,FiniteDifferences:148.3119925008826,ForwardDiff:3.7183571675700615,MooncakeFwd:15.623192133662267,MooncakeRvs:11.791873363638413,ReverseDiff:301.70563018005146,ReverseDiffCompiled:300.3641304347826,Zygote:34779.60063385798},_a={__category__:"Distributions",EnzymeFwd:"error",EnzymeRvs:"error",FiniteDifferences:27.584150816360882,ForwardDiff:"NaN",MooncakeFwd:4.9161866171422135,MooncakeRvs:3.6782543074209744,ReverseDiff:"NaN",ReverseDiffCompiled:"NaN",Zygote:3118.773149566105},ma={__category__:"External libraries",EnzymeFwd:"wrong",EnzymeRvs:84.67836971869231,FiniteDifferences:62.5677295872305,ForwardDiff:6.567179192412703,MooncakeFwd:"error",MooncakeRvs:54.84365932602503,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},pa={__category__:"Distributions",EnzymeFwd:12.891716305762879,EnzymeRvs:4.8589623403567845,FiniteDifferences:150.96021458018387,ForwardDiff:3.4711084931012097,MooncakeFwd:14.666396585600205,MooncakeRvs:11.49499907650253,ReverseDiff:201.56876853466213,ReverseDiffCompiled:207.60875269618518,Zygote:13574.899957466418},ga={__category__:"PosteriorDB",EnzymeFwd:6.567377274466827,EnzymeRvs:4.303948545091835,FiniteDifferences:170.10078162827696,ForwardDiff:3.855671197960918,MooncakeFwd:29.847291321171916,MooncakeRvs:4.801792318456695,ReverseDiff:115.1531113726033,ReverseDiffCompiled:112.47087013075922,Zygote:"error"},va={__category__:"PosteriorDB",EnzymeFwd:5.847267712463368,EnzymeRvs:4.225478159021042,FiniteDifferences:163.4534585824082,ForwardDiff:3.4386033805702585,MooncakeFwd:26.04581299286519,MooncakeRvs:4.0607684221235045,ReverseDiff:109.05367217194183,ReverseDiffCompiled:107.02812629256859,Zygote:"error"},ha={__category__:"Core Turing syntax",EnzymeFwd:6.132320223212029,EnzymeRvs:3.477789518075234,FiniteDifferences:59.483920406435224,ForwardDiff:2.2568746266541124,MooncakeFwd:13.528199962297938,MooncakeRvs:6.54926044088992,ReverseDiff:117.9646816634465,ReverseDiffCompiled:113.3993004027984,Zygote:14047.477817440084},ya={__category__:"Distributions",EnzymeFwd:8.075500450232042,EnzymeRvs:9.618258905575146,FiniteDifferences:44.942525491302966,ForwardDiff:1.0171570485589176,MooncakeFwd:16.481246082050568,MooncakeRvs:10.596215808596696,ReverseDiff:18.516869280152985,ReverseDiffCompiled:17.894347986701145,Zygote:370.5077259720586},ba={__category__:"Core Turing syntax",EnzymeFwd:4.8892198724437135,EnzymeRvs:3.7003084223013047,FiniteDifferences:75.31947059159107,ForwardDiff:1.6401265625810468,MooncakeFwd:9.653537866224433,MooncakeRvs:5.184027121527121,ReverseDiff:137.2083794630501,ReverseDiffCompiled:135.08893050206692,Zygote:"error"},wa={__category__:"Base Julia features",EnzymeFwd:3.1403277001946566,EnzymeRvs:1.9560367134513175,FiniteDifferences:81.99191679384998,ForwardDiff:2.3424490747878197,MooncakeFwd:10.55172601876318,MooncakeRvs:4.818440655011081,ReverseDiff:64.65181338327942,ReverseDiffCompiled:63.32721099983025,Zygote:6203.864719904648},Ea={abstractgps:xi,assume_beta:Ri,delaydiffeq:Mi,demo_assume_dot_observe:Ti,demo_assume_dot_observe_literal:Fi,demo_assume_index_observe:Ni,demo_assume_matrix_observe_matrix_index:Si,demo_assume_multivariate_observe:ki,demo_assume_multivariate_observe_literal:Ai,demo_assume_observe_literal:Ci,demo_assume_submodel_observe_index_literal:Oi,demo_dot_assume_observe:Ii,assume_dirichlet:Li,demo_dot_assume_observe_index:Pi,demo_dot_assume_observe_index_literal:zi,demo_dot_assume_observe_matrix_index:ji,demo_dot_assume_observe_submodel:Vi,dot_assume:Bi,dot_observe:qi,dppl_gauss_unknown:$i,dppl_hier_poisson:Ui,dppl_high_dim_gauss:Hi,dppl_hmm_semisup:Ki,assume_lkjcholu:Gi,dppl_lda:Zi,dppl_logistic_regression:Wi,dppl_naive_bayes:Xi,dppl_sto_volatility:Ji,dynamic_constraint:Yi,lux_nn:Qi,multiple_constraints_same_var:ea,multithreaded:na,n010:ta,n050:ra,assume_mvnormal:oa,n100:sa,n500:ia,observe_bernoulli:aa,observe_categorical:la,observe_index:ca,observe_literal:ua,observe_multivariate:fa,observe_submodel:da,observe_von_mises:_a,ordinarydiffeq:ma,assume_normal:pa,pdb_eight_schools_centered:ga,pdb_eight_schools_noncentered:va,assume_submodel:ha,assume_wishart:ya,broadcast_macro:ba,control_flow:wa},Da=`#=
