...
\r\f \v\uFEFF`];function ci(e,n,r){var t=e==null?"":""+e;if(n&&(t=t?t+" "+n:n),r){for(var i in r)if(r[i])t=t?t+" "+i:i;else if(t.length)for(var s=i.length,l=0;(l=t.indexOf(i,l))>=0;){var f=l+s;(l===0||lt.includes(t[l-1]))&&(f===t.length||lt.includes(t[f]))?t=(l===0?"":t.substring(0,l))+t.substring(f+1):l=f}}return t===""?null:t}function ct(e,n=!1){var r=n?" !important;":";",t="";for(var i in e){var s=e[i];s!=null&&s!==""&&(t+=" "+i+": "+s+r)}return t}function lr(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var r="",t,i;if(Array.isArray(n)?(t=n[0],i=n[1]):t=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];t&&a.push(...Object.keys(t).map(lr)),i&&a.push(...Object.keys(i).map(lr));var c=0,g=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&g===-1)g=_;else if(u===";"||_===F-1){if(g!==-1){var v=lr(e.substring(c,g).trim());if(!a.includes(v)){u!==";"&&_++;var p=e.substring(c,_).trim();r+=" "+p+";"}}c=_+1,g=-1}}}}return t&&(r+=ct(t)),i&&(r+=ct(i,!0)),r=r.trim(),r===""?null:r}return e==null?null:String(e)}function Or(e,n,r,t,i,s){var l=e.__className;if(l!==r||l===void 0){var f=ci(r,t,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=r}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function cr(e,n={},r,t){for(var i in r){var s=r[i];n[i]!==s&&(r[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,t))}}function fi(e,n,r,t){var i=e.__style;if(i!==n){var s=ui(n,t);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else t&&(Array.isArray(t)?(cr(e,r==null?void 0:r[0],t[0]),cr(e,r==null?void 0:r[1],t[1],"important")):cr(e,r,t));return t}const fn=Symbol("class"),cn=Symbol("style"),Gt=Symbol("is custom element"),Kt=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function br(e,n,r,t){var i=qt(e);i[n]!==(i[n]=r)&&(n==="loading"&&(e[Xo]=r),r==null?e.removeAttribute(n):typeof r!="string"&&Wt(e).includes(n)?e[n]=r:e.setAttribute(n,r))}function _i(e,n,r,t,i=!1){var s=qt(e),l=s[Gt],f=!s[Kt],a=n||{},c=e.tagName==="OPTION";for(var g in n)g in r||(r[g]=null);r.class?r.class=Zt(r.class):r.class=null,r[cn]&&(r.style??(r.style=null));var _=Wt(e);for(const x in r){let D=r[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";Or(e,u,D,t,n==null?void 0:n[fn],r[fn]),a[x]=D,a[fn]=r[fn];continue}if(x==="style"){fi(e,D,n==null?void 0:n[cn],r[cn]),a[x]=D,a[cn]=r[cn];continue}var v=a[x];if(D!==v){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let N=x.slice(2);var F=$s(N);if(Bs(N)&&(N=N.slice(0,-7),M.capture=!0),!F&&v){if(D!=null)continue;e.removeEventListener(N,a[ee],M),a[ee]=null}if(D!=null)if(F)e[`__${N}`]=D,Xs([N]);else{let U=function(Y){a[x].call(this,Y)};var H=U;a[ee]=Ws(N,e,U,M)}else F&&(e[`__${N}`]=void 0)}else if(x==="style")br(e,x,D);else if(x==="autofocus")Ks(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var C=x;f||(C=Hs(C));var z=C==="defaultValue"||C==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,C==="value"||C==="checked"){let M=e;const ee=n===void 0;if(C==="value"){let N=M.defaultValue;M.removeAttribute(C),M.defaultValue=N,M.value=M.__value=ee?N:null}else{let N=M.defaultChecked;M.removeAttribute(C),M.defaultChecked=N,M.checked=ee?N:!1}}else e.removeAttribute(x);else z||_.includes(C)&&(l||typeof D!="string")?e[C]=D:typeof D!="function"&&br(e,C,D)}}}for(let x of Object.getOwnPropertySymbols(r))x.description===hs&&ai(e,()=>r[x]);return a}function qt(e){return e.__attributes??(e.__attributes={[Gt]:e.nodeName.includes("-"),[Kt]:e.namespaceURI===ps})}var ut=new Map;function Wt(e){var n=ut.get(e.nodeName);if(n)return n;ut.set(e.nodeName,n=[]);for(var r,t=e,i=Element.prototype;i!==t;){r=vt(t);for(var s in r)r[s].set&&n.push(s);t=Er(t)}return n}function Lr(e=!1){const n=$,r=n.l.u;if(!r)return;let t=()=>gr(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});t=()=>O(l)}r.b.length&&Ms(()=>{ft(n,t),fr(r.b)}),ot(()=>{const i=Bn(()=>r.m.map(Go));return()=>{for(const s of i)typeof s=="function"&&s()}}),r.a.length&&ot(()=>{ft(n,t),fr(r.a)})}function ft(e,n){if(e.l.s)for(const r of e.l.s)O(r);n()}let Nn=!1;function mi(e){var n=Nn;try{return Nn=!1,[e(),Nn]}finally{Nn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,r){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Et)),e.special[n](r),rt(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),rt(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},gi)}const vi={get(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t)return t[n]}},set(e,n,r){let t=e.props.length;for(;t--;){let i=e.props[t];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(r),!0}return!1},getOwnPropertyDescriptor(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t){const i=je(t,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===qe||n===bt)return!1;for(let r of e.props)if(ln(r)&&(r=r()),r!=null&&n in r)return!0;return!1},ownKeys(e){const n=[];for(let r of e.props)if(ln(r)&&(r=r()),!!r){for(const t in r)n.includes(t)||n.push(t);for(const t of Object.getOwnPropertySymbols(r))n.includes(t)||n.push(t)}return n}};function pi(...e){return new Proxy({props:e},vi)}function dt(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,r,t){var ee;var i=(r&fs)!==0,s=!pn||(r&ds)!==0,l=(r&_s)!==0,f=(r&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var g=qe in e||bt in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(g&&n in e&&(N=>e[n]=N)))||void 0,u=t,v=!0,p=!1,F=()=>(p=!0,v&&(v=!1,f?u=Bn(t):u=t),u);c===void 0&&t!==void 0&&(_&&s&&ts(),c=F(),_&&_(c));var C;if(s)C=()=>{var N=e[n];return N===void 0?F():(v=!0,p=!1,N)};else{var z=(i?mn:Fr)(()=>e[n]);z.f|=qo,C=()=>{var N=O(z);return N!==void 0&&(u=void 0),N===void 0?u:N}}if((r&Et)===0)return C;if(_){var H=e.$$legacy;return function(N,U){return arguments.length>0?((!s||!U||H||a)&&_(U?C():N),N):C()}}var x=!1,D=Nr(c),M=mn(()=>{var N=C(),U=O(D);return x?(x=!1,U):D.v=N});return l&&O(M),i||(M.equals=Mr),function(N,U){if(arguments.length>0){const Y=U?O(M):s&&l?Ke(N):N;if(!M.equals(Y)){if(x=!0,fe(D,Y),p&&u!==void 0&&(u=Y),dt(M))return N;Bn(()=>O(M))}return N}return dt(M)?M.v:O(M)}}function hi(e,n,{bubbles:r=!1,cancelable:t=!1}={}){return new CustomEvent(e,{detail:n,bubbles:r,cancelable:t})}function bi(){const e=$;return e===null&&Dt(),(n,r,t)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=$n(i)?i.slice():[i],f=hi(n,r,t);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){$===null&&Dt(),$.l===null&&rs(),wi($).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var gt;typeof window<"u"&&((gt=window.__svelte??(window.__svelte={})).v??(gt.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:22.304414889970523,ForwardDiff:1.6458295741168518,MooncakeForward:12.528680681326579,MooncakeReverse:5.61373543727493,ReverseDiff:32.09742978723404,ReverseDiffCompiled:2.7558470823463135,Zygote:1869.5432052926485},Ri={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.30602895363753,ForwardDiff:1.3150218858114953,MooncakeForward:11.675083056478407,MooncakeReverse:7.75213142025369,ReverseDiff:32.625726423109604,ReverseDiffCompiled:2.930486125109185,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:36.772501992860356,ForwardDiff:1.3191563366537522,MooncakeForward:24.41499229847681,MooncakeReverse:5.979288010719294,ReverseDiff:29.390170295322267,ReverseDiffCompiled:3.0457777023283406,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.69028277634961,ForwardDiff:1.3133945807216338,MooncakeForward:24.0165988909427,MooncakeReverse:5.723280861640431,ReverseDiff:29.12736500483358,ReverseDiffCompiled:2.8316973314260347,Zygote:2098.9451555188552},Ti={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.27094226870132,ForwardDiff:1.2643090544041675,MooncakeForward:28.381118515158914,MooncakeReverse:4.882099029680366,ReverseDiff:22.90528948008197,ReverseDiffCompiled:2.241993557458637,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.70812794188503,ForwardDiff:1.4207739265814487,MooncakeForward:40.17887234938913,MooncakeReverse:6.904355562745177,ReverseDiff:50.264282978797475,ReverseDiffCompiled:2.8132602952371006,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.69410363741339,ForwardDiff:1.3827744566293203,MooncakeForward:48.57984340205445,MooncakeReverse:7.299271137026238,ReverseDiff:50.62846939857865,ReverseDiffCompiled:2.8261537924047095,Zygote:1634.2491787457543},Si={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.89223764093669,ForwardDiff:1.4389206471674734,MooncakeForward:39.14475544246537,MooncakeReverse:6.980683918669132,ReverseDiff:49.90364464692483,ReverseDiffCompiled:2.7741622122965026,Zygote:1410.8377723081444},Ai={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.444858874583076,ForwardDiff:1.3751438234371185,MooncakeForward:23.836719958741618,MooncakeReverse:6.454405809244518,ReverseDiff:33.102086838864125,ReverseDiffCompiled:3.776294346245456,Zygote:2141.9492565816395},Ci={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.33508192009198,ForwardDiff:1.3270185850382632,MooncakeForward:27.922708254089013,MooncakeReverse:5.179192073170731,ReverseDiff:29.458037637255934,ReverseDiffCompiled:2.1040502056745067,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.63931414574404,ForwardDiff:1.3044450529390288,MooncakeForward:31.36189402480271,MooncakeReverse:5.8401479289940825,ReverseDiff:41.30434295530079,ReverseDiffCompiled:2.386316710989247,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.57084614834418,ForwardDiff:1.4220352864842523,MooncakeForward:36.26767909732818,MooncakeReverse:5.69133060317901,ReverseDiff:34.95827819182281,ReverseDiffCompiled:2.498236799584852,Zygote:"error"},Oi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:150.23221178479932,ForwardDiff:2.622025039824116,MooncakeForward:57.76568015204996,MooncakeReverse:6.485179515725021,ReverseDiff:54.531887799602266,ReverseDiffCompiled:6.620434961017644,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.394967476267695,ForwardDiff:1.3051129621825506,MooncakeForward:32.9429468633124,MooncakeReverse:6.058591212811229,ReverseDiff:35.459469842489426,ReverseDiffCompiled:2.7525291732899584,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.81973765488172,ForwardDiff:1.2950620086254927,MooncakeForward:31.931943309771604,MooncakeReverse:6.025430550016316,ReverseDiff:41.13043787571586,ReverseDiffCompiled:2.4730309693126458,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.133895131086135,ForwardDiff:1.2332110732687103,MooncakeForward:26.1685626738985,MooncakeReverse:5.0638775743271545,ReverseDiff:31.23558701209508,ReverseDiffCompiled:1.9659401349902794,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:77.59688533627343,ForwardDiff:1.4149410222804717,MooncakeForward:30.75925925925926,MooncakeReverse:5.142496482289534,ReverseDiff:20.47788710512688,ReverseDiffCompiled:1.9240354163119358,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.353143013999453,ForwardDiff:1.6665613548084317,MooncakeForward:17.37856342903686,MooncakeReverse:7.15813858417933,ReverseDiff:55.2536671897387,ReverseDiffCompiled:5.287268830421798,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:28.802244832041342,ForwardDiff:4.168785759694851,MooncakeForward:23.14508483705898,MooncakeReverse:45.612911589318124,ReverseDiff:11.110592401802961,ReverseDiffCompiled:4.761330761812921,Zygote:245.76746619446234},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:165.0054037362977,ForwardDiff:2.9894943322205245,MooncakeForward:44.43541974326934,MooncakeReverse:3.7294479576140827,ReverseDiff:22.753541563251744,ReverseDiffCompiled:1.9559480699591647,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:142105.46744141984,ForwardDiff:18768.96868457781,MooncakeForward:32014.70996539248,MooncakeReverse:16.795460152973106,ReverseDiff:4.917699222546162,ReverseDiffCompiled:1.8257469980452388,Zygote:21.3530874921036},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:16.425626440489086,MooncakeForward:418.741962343665,MooncakeReverse:33.85546243108833,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6296.356999456766,ForwardDiff:153.50360756461205,MooncakeForward:482.4004141288713,MooncakeReverse:7.409704005122591,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Gi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.116903908398015,ForwardDiff:.9227371548743412,MooncakeForward:25.285405249495245,MooncakeReverse:10.111605888139405,ReverseDiff:12.86336032388664,ReverseDiffCompiled:1.285676791713326,Zygote:879.8547532181456},Ki={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"wrong",ForwardDiff:32.3396676959085,MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:50.50787760430308,ReverseDiffCompiled:5.509086067438171,Zygote:"error"},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1303.8753573053534,ForwardDiff:452.65879590760153,MooncakeForward:1832.6134626304984,MooncakeReverse:26.883898836020705,ReverseDiff:19.902835185695476,ReverseDiffCompiled:3.5000134752728735,Zygote:73.71375392908722},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6669.794002974895,ForwardDiff:80.38734039425698,MooncakeForward:1071.4814135109789,MooncakeReverse:3.44743328994468,ReverseDiff:33.308024402446705,ReverseDiffCompiled:3.2000106358173426,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.7766192514846,ForwardDiff:1.360055117704631,MooncakeForward:22.313537209059593,MooncakeReverse:6.266345815236529,ReverseDiff:32.16551624444364,ReverseDiffCompiled:2.6789657425878795,Zygote:1644.7373209089903},Ji={__category__:"Miscellaneous features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.910997492211465,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.69799159604016,ForwardDiff:1.2614872016936103,MooncakeForward:27.953809656712252,MooncakeReverse:14.042586806165081,ReverseDiff:28.389920840191238,ReverseDiffCompiled:2.43175364060264,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:15.629125780553078,ForwardDiff:.8515509776868548,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:137.31384387247112,ForwardDiff:1.7969042135212032,MooncakeForward:42.07280331761954,MooncakeReverse:4.619045927609846,ReverseDiff:20.524571867043356,ReverseDiffCompiled:1.889754343918514,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:620.3670625609184,ForwardDiff:9.518183790036876,MooncakeForward:124.93610586011341,MooncakeReverse:4.092665224881786,ReverseDiff:20.914591261621464,ReverseDiffCompiled:1.7952688984371312,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1255.4021886820167,ForwardDiff:14.688947566955866,MooncakeForward:238.52913735653462,MooncakeReverse:3.974824139207701,ReverseDiff:20.079763663220092,ReverseDiffCompiled:1.862091791703442,Zygote:"error"},ta={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.43446049277825,ForwardDiff:1.4745170763172188,MooncakeForward:17.10096071733561,MooncakeReverse:6.736376183126311,ReverseDiff:21.45107865271032,ReverseDiffCompiled:2.1446117048539266,Zygote:2389.6863408171803},oa={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6745.9115330905115,ForwardDiff:81.6354612381323,MooncakeForward:1253.3404401006192,MooncakeReverse:3.988751251069755,ReverseDiff:20.043482571562116,ReverseDiffCompiled:1.8435440670039538,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.10836018314397,ForwardDiff:1.6035334401407346,MooncakeForward:12.303867376619863,MooncakeReverse:5.872070693014194,ReverseDiff:33.97040519983405,ReverseDiffCompiled:3.381642600601041,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:17.400329316143495,ForwardDiff:1.2502863833369606,MooncakeForward:8.840500323485012,MooncakeReverse:7.638872824176447,ReverseDiff:12.703701153382683,ReverseDiffCompiled:2.463970603943686,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.32246871249786,ForwardDiff:1.6401983244999143,MooncakeForward:17.514639026051423,MooncakeReverse:7.564931444501337,ReverseDiff:57.711379050489825,ReverseDiffCompiled:5.233414838767914,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.010765069015743,ForwardDiff:1.5445841771678877,MooncakeForward:17.71045646631509,MooncakeReverse:7.302170689613262,ReverseDiff:37.16204603580563,ReverseDiffCompiled:3.6894034472272477,Zygote:3388.913436913095},ca={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:48.9781886165351,ForwardDiff:1.372839677741877,MooncakeForward:23.56508793795873,MooncakeReverse:5.580610396459608,ReverseDiff:25.656144228776682,ReverseDiffCompiled:2.25785638944303,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:23.070455709165383,ForwardDiff:1.4120408442982455,MooncakeForward:13.957667405009373,MooncakeReverse:5.749348582939807,ReverseDiff:25.8381357373703,ReverseDiffCompiled:2.4932919297800566,Zygote:3138.717158176944},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.209517923362174,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:2.981159260281534,Zygote:2230.925879396985},da={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135.19168582926127,ForwardDiff:1.8558398100172715,MooncakeForward:57.90760791624838,MooncakeReverse:5.246601941747572,ReverseDiff:29.29916709161992,ReverseDiffCompiled:2.559129271121421,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:136.93894225460969,ForwardDiff:1.8223496857374708,MooncakeForward:60.368706910740094,MooncakeReverse:5.111793589858047,ReverseDiff:30.801065308012973,ReverseDiffCompiled:2.6152656722949565,Zygote:"error"},ma={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:33.72839375682627,ForwardDiff:1.2597570643687572,MooncakeForward:24.132351397683937,MooncakeReverse:5.3574524147973515,ReverseDiff:11.981574539363486,ReverseDiffCompiled:1.4749121687164821,Zygote:1620.0885351397121},ga={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:42.75834220476487,ForwardDiff:1.1176054400377342,MooncakeForward:23.071114369501462,MooncakeReverse:11.758720024914355,ReverseDiff:16.01423865689087,ReverseDiffCompiled:4.203156538544127,Zygote:361.86864094372083},va={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.07098787320048,ForwardDiff:1.3430197865543272,MooncakeForward:24.13629701129701,MooncakeReverse:6.480177514792899,ReverseDiff:29.98515834581751,ReverseDiffCompiled:2.8818286191420524,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.975873015873013,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:38.13879059117403,ForwardDiff:1.6523338158160963,MooncakeForward:28.866707869798105,MooncakeReverse:7.169117807422486,ReverseDiff:19.96435603634379,ReverseDiffCompiled:"wrong",Zygote:2191.888064447742},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Fi,demo_assume_multivariate_observe:Ni,demo_assume_multivariate_observe_literal:Si,demo_assume_observe_literal:Ai,demo_assume_submodel_observe_index_literal:Ci,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Ii,assume_lkjcholu:Oi,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:$i,dppl_high_dim_gauss:Ui,dppl_hmm_semisup:Hi,dppl_lda:Zi,assume_mvnormal:Gi,dppl_logistic_regression:Ki,dppl_naive_bayes:qi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ra,assume_normal:ta,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:ua,observe_von_mises:fa,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:ga,broadcast_macro:va,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
