...
Here we use a Metropolis-Hasting sampler implemented with Turing and AdvancedHMC as the inversion of the inner "subjective" model.
=#
...
@model function metabayesian_Turing_AdvancedHMC(
    observation,
    action,
    inner_sampler = MH(),
    inner_n_samples = 20,
...
model = metabayesian_Turing_AdvancedHMC(0.0, 1.0)
