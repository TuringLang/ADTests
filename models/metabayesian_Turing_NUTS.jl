...
Here we use a NUTS sampler implemented with Turing as the inversion of the inner "subjective" model.
=#
...
@model function metabayesian_Turing_NUTS(
    observation,
    action,
    inner_sampler = NUTS(),
    inner_n_samples = 20,
...
model = metabayesian_Turing_NUTS(0.0, 1.0)
