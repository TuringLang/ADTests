...
model = dppl_lda(k, m, w, doc, alpha, beta)`,Ja=`using StatsFuns: logistic
...
model = multithreaded([1.5, 2.0, 2.5, 1.5, 2.0, 2.5])`,ol=`@model function n010(::Type{TV} = Vector{Float64}) where {TV}
    a = TV(undef, 10)
