...
\r\f \v\uFEFF`];function ci(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var i in t)if(t[i])r=r?r+" "+i:i;else if(r.length)for(var s=i.length,l=0;(l=r.indexOf(i,l))>=0;){var u=l+s;(l===0||lr.includes(r[l-1]))&&(u===r.length||lr.includes(r[u]))?r=(l===0?"":r.substring(0,l))+r.substring(u+1):l=u}}return r===""?null:r}function cr(e,n=!1){var t=n?" !important;":";",r="";for(var i in e){var s=e[i];s!=null&&s!==""&&(r+=" "+i+": "+s+t)}return r}function lt(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function fi(e,n){if(n){var t="",r,i;if(Array.isArray(n)?(r=n[0],i=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,u=!1,a=[];r&&a.push(...Object.keys(r).map(lt)),i&&a.push(...Object.keys(i).map(lt));var c=0,v=-1;const S=e.length;for(var _=0;_<S;_++){var f=e[_];if(u?f==="/"&&e[_-1]==="*"&&(u=!1):s?s===f&&(s=!1):f==="/"&&e[_+1]==="*"?u=!0:f==='"'||f==="'"?s=f:f==="("?l++:f===")"&&l--,!u&&s===!1&&l===0){if(f===":"&&v===-1)v=_;else if(f===";"||_===S-1){if(v!==-1){var g=lt(e.substring(c,v).trim());if(!a.includes(g)){f!==";"&&_++;var p=e.substring(c,_).trim();t+=" "+p+";"}}c=_+1,v=-1}}}}return r&&(t+=cr(r)),i&&(t+=cr(i,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function It(e,n,t,r,i,s){var l=e.__className;if(l!==t||l===void 0){var u=ci(t,r,s);u==null?e.removeAttribute("class"):n?e.className=u:e.setAttribute("class",u),e.__className=t}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function ct(e,n={},t,r){for(var i in t){var s=t[i];n[i]!==s&&(t[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,r))}}function ui(e,n,t,r){var i=e.__style;if(i!==n){var s=fi(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(ct(e,t==null?void 0:t[0],r[0]),ct(e,t==null?void 0:t[1],r[1],"important")):ct(e,t,r));return r}const un=Symbol("class"),cn=Symbol("style"),Kr=Symbol("is custom element"),Zr=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function bt(e,n,t,r){var i=Gr(e);i[n]!==(i[n]=t)&&(n==="loading"&&(e[Xo]=t),t==null?e.removeAttribute(n):typeof t!="string"&&Wr(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function _i(e,n,t,r,i=!1){var s=Gr(e),l=s[Kr],u=!s[Zr],a=n||{},c=e.tagName==="OPTION";for(var v in n)v in t||(t[v]=null);t.class?t.class=Hr(t.class):t.class=null,t[cn]&&(t.style??(t.style=null));var _=Wr(e);for(const x in t){let D=t[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var f=e.namespaceURI==="http://www.w3.org/1999/xhtml";It(e,f,D,r,n==null?void 0:n[un],t[un]),a[x]=D,a[un]=t[un];continue}if(x==="style"){ui(e,D,n==null?void 0:n[cn],t[cn]),a[x]=D,a[cn]=t[cn];continue}var g=a[x];if(D!==g){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let F=x.slice(2);var S=Us(F);if(Bs(F)&&(F=F.slice(0,-7),M.capture=!0),!S&&g){if(D!=null)continue;e.removeEventListener(F,a[ee],M),a[ee]=null}if(D!=null)if(S)e[`__${F}`]=D,Xs([F]);else{let $=function(Y){a[x].call(this,Y)};var q=$;a[ee]=Ws(F,e,$,M)}else S&&(e[`__${F}`]=void 0)}else if(x==="style")bt(e,x,D);else if(x==="autofocus")Zs(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var A=x;u||(A=qs(A));var z=A==="defaultValue"||A==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,A==="value"||A==="checked"){let M=e;const ee=n===void 0;if(A==="value"){let F=M.defaultValue;M.removeAttribute(A),M.defaultValue=F,M.value=M.__value=ee?F:null}else{let F=M.defaultChecked;M.removeAttribute(A),M.defaultChecked=F,M.checked=ee?F:!1}}else e.removeAttribute(x);else z||_.includes(A)&&(l||typeof D!="string")?e[A]=D:typeof D!="function"&&bt(e,A,D)}}}for(let x of Object.getOwnPropertySymbols(t))x.description===hs&&ai(e,()=>t[x]);return a}function Gr(e){return e.__attributes??(e.__attributes={[Kr]:e.nodeName.includes("-"),[Zr]:e.namespaceURI===ps})}var fr=new Map;function Wr(e){var n=fr.get(e.nodeName);if(n)return n;fr.set(e.nodeName,n=[]);for(var t,r=e,i=Element.prototype;i!==r;){t=gr(r);for(var s in t)t[s].set&&n.push(s);r=Et(r)}return n}function Lt(e=!1){const n=U,t=n.l.u;if(!t)return;let r=()=>vt(n.s);if(e){let i=0,s={};const l=mn(()=>{let u=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],u=!0);return u&&i++,i});r=()=>I(l)}t.b.length&&Ms(()=>{ur(n,r),ut(t.b)}),or(()=>{const i=Bn(()=>t.m.map(Ko));return()=>{for(const s of i)typeof s=="function"&&s()}}),t.a.length&&or(()=>{ur(n,r),ut(t.a)})}function ur(e,n){if(e.l.s)for(const t of e.l.s)I(t);n()}let Fn=!1;function mi(e){var n=Fn;try{return Fn=!1,[e(),Fn]}finally{Fn=n}}const vi={get(e,n){if(!e.exclude.includes(n))return I(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Er)),e.special[n](t),tr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),tr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},vi)}const gi={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let i=e.props[r];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const i=je(r,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===Ge||n===br)return!1;for(let t of e.props)if(ln(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(ln(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function pi(...e){return new Proxy({props:e},gi)}function dr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,t,r){var ee;var i=(t&us)!==0,s=!pn||(t&ds)!==0,l=(t&_s)!==0,u=(t&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var v=Ge in e||br in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(v&&n in e&&(F=>e[n]=F)))||void 0,f=r,g=!0,p=!1,S=()=>(p=!0,g&&(g=!1,u?f=Bn(r):f=r),f);c===void 0&&r!==void 0&&(_&&s&&rs(),c=S(),_&&_(c));var A;if(s)A=()=>{var F=e[n];return F===void 0?S():(g=!0,p=!1,F)};else{var z=(i?mn:St)(()=>e[n]);z.f|=Go,A=()=>{var F=I(z);return F!==void 0&&(f=void 0),F===void 0?f:F}}if((t&Er)===0)return A;if(_){var q=e.$$legacy;return function(F,$){return arguments.length>0?((!s||!$||q||a)&&_($?A():F),F):A()}}var x=!1,D=Ft(c),M=mn(()=>{var F=A(),$=I(D);return x?(x=!1,$):D.v=F});return l&&I(M),i||(M.equals=Mt),function(F,$){if(arguments.length>0){const Y=$?I(M):s&&l?Ze(F):F;if(!M.equals(Y)){if(x=!0,ue(D,Y),p&&f!==void 0&&(f=Y),dr(M))return F;Bn(()=>I(M))}return F}return dr(M)?M.v:I(M)}}function hi(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function bi(){const e=U;return e===null&&Dr(),(n,t,r)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=Un(i)?i.slice():[i],u=hi(n,t,r);for(const a of l)a.call(e.x,u);return!u.defaultPrevented}return!0}}function yi(e){U===null&&Dr(),U.l===null&&ts(),wi(U).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var vr;typeof window<"u"&&((vr=window.__svelte??(window.__svelte={})).v??(vr.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:2.9967953271765726,EnzymeReverse:3.616384285418963,FiniteDifferences:26.36178516884439,ForwardDiff:1.7847667439639883,MooncakeForward:7.642719469572368,MooncakeReverse:6.5878327908172,ReverseDiff:38.14880604707095,ReverseDiffCompiled:3.385353759789735,Zygote:1766.4444463344107},Ri={__category__:"Distributions",EnzymeForward:2.853450588606972,EnzymeReverse:2.9078447687318656,FiniteDifferences:23.284999144275204,ForwardDiff:1.353468075333027,MooncakeForward:8.101154670325434,MooncakeReverse:7.4049062049062035,ReverseDiff:39.10967566464948,ReverseDiffCompiled:3.2857142857142856,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:3.603197322471118,EnzymeReverse:3.203776812241323,FiniteDifferences:41.363176568279606,ForwardDiff:1.0186213924133851,MooncakeForward:20.414443946033607,MooncakeReverse:7.157158364491616,ReverseDiff:37.876000711617145,ReverseDiffCompiled:4.071305060381524,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:3.564077583916394,EnzymeReverse:3.2530838380963134,FiniteDifferences:40.98200248241621,ForwardDiff:1.4239550543750579,MooncakeForward:20.373712697304775,MooncakeReverse:7.626628550350424,ReverseDiff:38.09757712404266,ReverseDiffCompiled:4.121164357538117,Zygote:2820.571567876297},Ti={__category__:"DynamicPPL demo models",EnzymeForward:4.7717372149578825,EnzymeReverse:4.242143892435316,FiniteDifferences:63.83832569377821,ForwardDiff:1.4484664463826789,MooncakeForward:28.063303172200115,MooncakeReverse:6.875525914807487,ReverseDiff:31.327105429514646,ReverseDiffCompiled:3.057281721923277,Zygote:"error"},Si={__category__:"DynamicPPL demo models",EnzymeForward:5.525021143216735,EnzymeReverse:5.411957411957411,FiniteDifferences:68.28948766065928,ForwardDiff:1.5070693709582594,MooncakeForward:35.556604445711024,MooncakeReverse:9.241584995580153,ReverseDiff:57.113435403406164,ReverseDiffCompiled:3.2336996865720886,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:4.833706534050226,EnzymeReverse:5.36621832968408,FiniteDifferences:71.96706892305527,ForwardDiff:1.5196720378067525,MooncakeForward:35.21477070549363,MooncakeReverse:8.145409735058534,ReverseDiff:62.587707390648575,ReverseDiffCompiled:3.801660908650024,Zygote:2003.9278929036348},Ni={__category__:"DynamicPPL demo models",EnzymeForward:5.035758381801218,EnzymeReverse:3.643580912111472,FiniteDifferences:72.43372848037171,ForwardDiff:1.4672363896465326,MooncakeForward:32.35151717517426,MooncakeReverse:6.983688211478644,ReverseDiff:52.20329547152892,ReverseDiffCompiled:3.4505303968553114,Zygote:1886.2965133072005},Ci={__category__:"DynamicPPL demo models",EnzymeForward:4.025715717077347,EnzymeReverse:3.578024826081026,FiniteDifferences:42.57332325453546,ForwardDiff:1.5005922209075284,MooncakeForward:22.34674615002484,MooncakeReverse:7.939196082432155,ReverseDiff:44.79173861987981,ReverseDiffCompiled:4.915526271329616,Zygote:3358.146203748198},Ai={__category__:"DynamicPPL demo models",EnzymeForward:4.346175196563774,EnzymeReverse:4.969576719576719,FiniteDifferences:64.46604773592288,ForwardDiff:1.3688142001890558,MooncakeForward:27.811287968304722,MooncakeReverse:6.052954930451173,ReverseDiff:39.918946486466794,ReverseDiffCompiled:3.067830566685747,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:4.804364646713327,EnzymeReverse:5.616914165069903,FiniteDifferences:66.16934392672519,ForwardDiff:1.400805830775537,MooncakeForward:29.867895886556333,MooncakeReverse:7.1706696807007635,ReverseDiff:54.1035013604468,ReverseDiffCompiled:3.2981386688958496,Zygote:"error"},Oi={__category__:"DynamicPPL demo models",EnzymeForward:4.7759440273252425,EnzymeReverse:4.112634388105223,FiniteDifferences:66.58283370148311,ForwardDiff:1.4019062156778794,MooncakeForward:28.296911248729796,MooncakeReverse:6.0110113166876245,ReverseDiff:39.198904464601256,ReverseDiffCompiled:2.8473300916233315,Zygote:"error"},Ii={__category__:"Distributions",EnzymeForward:4.781162920304663,EnzymeReverse:6.73234392419175,FiniteDifferences:157.17566919969877,ForwardDiff:2.5807161827016,MooncakeForward:36.112510111490174,MooncakeReverse:6.518042707101619,ReverseDiff:59.09751669806474,ReverseDiffCompiled:7.101986500192355,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:4.964865053838624,EnzymeReverse:4.253731011485735,FiniteDifferences:64.93936399251756,ForwardDiff:1.411233216262613,MooncakeForward:31.21108897233504,MooncakeReverse:6.769341225090183,ReverseDiff:48.61668215281252,ReverseDiffCompiled:3.6368998768978247,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:4.760892189374163,EnzymeReverse:4.040172756285007,FiniteDifferences:78.49544181500347,ForwardDiff:1.3171550558658072,MooncakeForward:27.09147427613426,MooncakeReverse:6.657490358943933,ReverseDiff:43.511718469600176,ReverseDiffCompiled:3.0188903659133843,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:4.473483214722163,EnzymeReverse:5.079274137095472,FiniteDifferences:64.60024414763753,ForwardDiff:1.4249644785450413,MooncakeForward:25.891761486389168,MooncakeReverse:5.993484202470755,ReverseDiff:42.85676840834627,ReverseDiffCompiled:2.8079612694997307,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:3.6399263508250126,EnzymeReverse:2.2583809469408673,FiniteDifferences:81.70103766054714,ForwardDiff:1.5905184592201922,MooncakeForward:27.1982109227872,MooncakeReverse:6.448591776115664,ReverseDiff:28.90347071583514,ReverseDiffCompiled:2.7286803048535897,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:3.693118700165489,EnzymeReverse:3.0488213219868214,FiniteDifferences:32.447905474269724,ForwardDiff:1.9029723821290572,MooncakeForward:12.299229320089058,MooncakeReverse:8.487190991920235,ReverseDiff:75.23443969086392,ReverseDiffCompiled:7.187586210562404,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:1.4942843779232926,EnzymeReverse:2.2299412404787815,FiniteDifferences:30.9220105544218,ForwardDiff:1.6015205406366708,MooncakeForward:4.482326202499182,MooncakeReverse:9.172958510157613,ReverseDiff:126.89356462243875,ReverseDiffCompiled:23.45261734832723,Zygote:26.59829535983436},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:4.912547007207772,EnzymeReverse:2.1071820605300298,FiniteDifferences:165.17690598087074,ForwardDiff:3.38842755596891,MooncakeForward:40.16576956080818,MooncakeReverse:4.311164326403251,ReverseDiff:29.504565670878108,ReverseDiffCompiled:2.355614105427955,Zygote:962.6314243183956},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:4920.977281718366,EnzymeReverse:2.432428498065111,FiniteDifferences:129165.44232989215,ForwardDiff:3260.253936468295,MooncakeForward:8238.45861355492,MooncakeReverse:3.547890178016738,ReverseDiff:1.8708281238966726,ReverseDiffCompiled:.4253774963468095,Zygote:2.473495111320532},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:37.5691655751138,EnzymeReverse:9.415200745643531,FiniteDifferences:"NaN",ForwardDiff:27.7600487356212,MooncakeForward:190.5232667115802,MooncakeReverse:4.636253834241194,ReverseDiff:73.22066081385692,ReverseDiffCompiled:11.425957883304172,Zygote:"error"},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:2.9740904234381147,FiniteDifferences:3658.2145464228192,ForwardDiff:188.5037001804625,MooncakeForward:916.6408907821146,MooncakeReverse:9.56368964716806,ReverseDiff:86.02665818177022,ReverseDiffCompiled:12.08927956103532,Zygote:"error"},Ki={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:4.528350934199838,FiniteDifferences:40.26895206243032,ForwardDiff:1.2595855283815371,MooncakeForward:19.658006988512195,MooncakeReverse:10.003958083891588,ReverseDiff:14.74067138537658,ReverseDiffCompiled:1.4685131396373197,Zygote:882.3037417461481},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:58.152429015273285,EnzymeReverse:4.118561513403016,FiniteDifferences:1257.1769994578708,ForwardDiff:54.28387056175147,MooncakeForward:715.7044436584848,MooncakeReverse:6.2592954536227765,ReverseDiff:54.79640838102292,ReverseDiffCompiled:8.04825411409639,Zygote:157.46574032960103},Gi={__category__:"DynamicPPL arXiV paper",EnzymeForward:220.67756826955832,EnzymeReverse:.9919648879612074,FiniteDifferences:2838.7800265708042,ForwardDiff:256.1642016135323,MooncakeForward:427.37966333362084,MooncakeReverse:4.505194991931919,ReverseDiff:148.9919070187257,ReverseDiffCompiled:22.133608427980047,Zygote:4632.690144167759},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:272.9009576859181,EnzymeReverse:2.1904064960991563,FiniteDifferences:6881.78049326947,ForwardDiff:70.43085878907645,MooncakeForward:1366.545086069777,MooncakeReverse:4.318404848951318,ReverseDiff:52.19947908406632,ReverseDiffCompiled:5.601335077573876,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:3.308663013800867,EnzymeReverse:3.177225657989357,FiniteDifferences:39.848920609122715,ForwardDiff:1.4140661189177692,MooncakeForward:20.050266721378744,MooncakeReverse:7.171314921532384,ReverseDiff:44.78159455623886,ReverseDiffCompiled:3.566245365017344,Zygote:2156.8831195484863},Ji={__category__:"Core Turing syntax",EnzymeForward:3.714592728297633,EnzymeReverse:2.7273149705262782,FiniteDifferences:63.64260866509715,ForwardDiff:1.2579563293849008,MooncakeForward:25.859795377036757,MooncakeReverse:13.131499923655056,ReverseDiff:30.99245269772177,ReverseDiffCompiled:2.558770751122602,Zygote:"error"},Yi={__category__:"Base Julia features",EnzymeForward:2.9671974955764258,EnzymeReverse:12.257337303275202,FiniteDifferences:15.755347091932457,ForwardDiff:.8532965743782263,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:4.637205712080278,ReverseDiffCompiled:"wrong",Zygote:"error"},Qi={__category__:"Effect of model size",EnzymeForward:5.415619610741562,EnzymeReverse:2.115393133997785,FiniteDifferences:148.60962014863748,ForwardDiff:1.9744647305365541,MooncakeForward:39.81407885001586,MooncakeReverse:5.869752410553457,ReverseDiff:28.944662012600034,ReverseDiffCompiled:2.727272727272727,Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:25.00833023428784,EnzymeReverse:1.9834544277390118,FiniteDifferences:648.4649829050402,ForwardDiff:10.689109056756658,MooncakeForward:143.38368250971277,MooncakeReverse:5.608593365309212,ReverseDiff:29.336589745892073,ReverseDiffCompiled:2.841503992901509,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:49.14050486000289,EnzymeReverse:1.954053756737927,FiniteDifferences:1263.1165523816508,ForwardDiff:17.463850977499078,MooncakeForward:277.93368036901876,MooncakeReverse:5.494948373487287,ReverseDiff:30.258821589535014,ReverseDiffCompiled:2.817378823009827,Zygote:"error"},ta={__category__:"Effect of model size",EnzymeForward:267.098095655029,EnzymeReverse:1.9639856710307475,FiniteDifferences:6909.763869252359,ForwardDiff:110.3407448229085,MooncakeForward:1437.3078305820286,MooncakeReverse:5.424214024026583,ReverseDiff:29.722695825390367,ReverseDiffCompiled:2.7638806789393686,Zygote:"error"},ra={__category__:"Distributions",EnzymeForward:3.490369799691833,EnzymeReverse:2.8618253359400136,FiniteDifferences:33.229958381660644,ForwardDiff:1.579325045539975,MooncakeForward:10.195327990234246,MooncakeReverse:7.68848437233134,ReverseDiff:27.384910179640716,ReverseDiffCompiled:2.9556042026070113,Zygote:2691.4598604730304},oa={__category__:"Distributions",EnzymeForward:2.94522670619147,EnzymeReverse:3.4123275638227932,FiniteDifferences:21.236673773987206,ForwardDiff:1.7171717171717171,MooncakeForward:8.565912516270467,MooncakeReverse:6.23242856005731,ReverseDiff:38.98152550431298,ReverseDiffCompiled:4.010659846547315,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:2.135481695904393,EnzymeReverse:6.43267763269459,FiniteDifferences:19.05671946857435,ForwardDiff:1.3967115608571787,MooncakeForward:6.381310250732516,MooncakeReverse:7.9108809808758505,ReverseDiff:13.902342392437617,ReverseDiffCompiled:2.807832907075874,Zygote:"error"},ia={__category__:"Core Turing syntax",EnzymeForward:3.6098275294516653,EnzymeReverse:3.2191086139869105,FiniteDifferences:31.701144332414604,ForwardDiff:1.8175758243061262,MooncakeForward:14.146150786887107,MooncakeReverse:8.03104680155324,ReverseDiff:76.22056506669468,ReverseDiffCompiled:6.997471266143285,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:3.510607438866061,EnzymeReverse:3.1455493678383113,FiniteDifferences:32.788890787899504,ForwardDiff:1.7437608162411884,MooncakeForward:10.892077091624559,MooncakeReverse:8.464104010456078,ReverseDiff:47.53870285753256,ReverseDiffCompiled:4.828043865767651,Zygote:4122.301694457571},la={__category__:"Core Turing syntax",EnzymeForward:3.3100492779916157,EnzymeReverse:3.123400777771516,FiniteDifferences:55.33692647871752,ForwardDiff:1.4568474354942473,MooncakeForward:17.76607661457613,MooncakeReverse:6.552781672080697,ReverseDiff:32.41267340297996,ReverseDiffCompiled:3.217237469518351,Zygote:"error"},ca={__category__:"Core Turing syntax",EnzymeForward:3.209556207879803,EnzymeReverse:2.9083058686162815,FiniteDifferences:31.069452360515022,ForwardDiff:1.665277936597406,MooncakeForward:8.826476987447698,MooncakeReverse:7.567947930160206,ReverseDiff:39.739376475489514,ReverseDiffCompiled:3.7764712210703038,Zygote:4527.753796719094},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:18.559194024091074,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:3.5612257264839555,Zygote:2179.9918332479074},ua={__category__:"Integrations with other packages",EnzymeForward:"wrong",EnzymeReverse:"wrong",FiniteDifferences:61.50546503733876,ForwardDiff:6.674054747346968,MooncakeForward:"error",MooncakeReverse:59.320057390793274,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},da={__category__:"PosteriorDB",EnzymeForward:7.630687318489835,EnzymeReverse:3.071382695660152,FiniteDifferences:141.86516932305653,ForwardDiff:2.198027761192865,MooncakeForward:50.11115792202742,MooncakeReverse:7.936242202093541,ReverseDiff:33.582611804970256,ReverseDiffCompiled:3.9756291390728475,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:8.026292602121735,EnzymeReverse:2.9869092100604067,FiniteDifferences:141.12784886399885,ForwardDiff:2.2046769718588983,MooncakeForward:56.50776053215078,MooncakeReverse:6.081225033288948,ReverseDiff:44.2354031510658,ReverseDiffCompiled:4.5721097391737535,Zygote:"error"},ma={__category__:"Core Turing syntax",EnzymeForward:2.970991771256176,EnzymeReverse:2.4471150925497565,FiniteDifferences:23.7059492231906,ForwardDiff:1.3547840733510608,MooncakeForward:13.8700026741543,MooncakeReverse:7.262575107296136,ReverseDiff:19.17909168808912,ReverseDiffCompiled:1.8959985519012568,Zygote:2296.3449848024316},va={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:12.68668551081091,FiniteDifferences:44.892022645393716,ForwardDiff:1.1585854023840405,MooncakeForward:19.737881508078992,MooncakeReverse:11.129070405155275,ReverseDiff:16.87418749097212,ReverseDiffCompiled:4.315049351225462,Zygote:376.3187540004267},ga={__category__:"Core Turing syntax",EnzymeForward:3.890546574875952,EnzymeReverse:3.857508875956224,FiniteDifferences:41.98417789181099,ForwardDiff:1.5498841352179635,MooncakeForward:15.361911216536768,MooncakeReverse:7.897365746892833,ReverseDiff:43.70689117555348,ReverseDiffCompiled:4.1566445422408185,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:3.524157980729829,EnzymeReverse:2.953239459981399,FiniteDifferences:32.47532270311314,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:2.999241737456491,EnzymeReverse:3.248684997598874,FiniteDifferences:41.736813146504296,ForwardDiff:1.6982060085836908,MooncakeForward:21.19699794445241,MooncakeReverse:7.133325083363713,ReverseDiff:22.33755850727388,ReverseDiffCompiled:"wrong",Zygote:2107.7893414302166},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Si,demo_assume_multivariate_observe:Fi,demo_assume_multivariate_observe_literal:Ni,demo_assume_observe_literal:Ci,demo_assume_submodel_observe_index_literal:Ai,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Oi,assume_lkjcholu:Ii,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:Ui,dppl_high_dim_gauss:$i,dppl_hmm_semisup:qi,dppl_lda:Hi,assume_mvnormal:Ki,dppl_logistic_regression:Zi,dppl_naive_bayes:Gi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,multiple_constraints_same_var:Ji,multithreaded:Yi,n010:Qi,n050:ea,n100:na,n500:ta,assume_normal:ra,observe_bernoulli:oa,observe_categorical:sa,observe_index:ia,observe_literal:aa,observe_multivariate:la,observe_submodel:ca,observe_von_mises:fa,ordinary_diffeq:ua,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:va,broadcast_macro:ga,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
