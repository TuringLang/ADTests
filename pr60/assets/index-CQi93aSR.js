...
\r\f \v\uFEFF`];function ci(e,n,r){var t=e==null?"":""+e;if(n&&(t=t?t+" "+n:n),r){for(var i in r)if(r[i])t=t?t+" "+i:i;else if(t.length)for(var s=i.length,l=0;(l=t.indexOf(i,l))>=0;){var f=l+s;(l===0||lt.includes(t[l-1]))&&(f===t.length||lt.includes(t[f]))?t=(l===0?"":t.substring(0,l))+t.substring(f+1):l=f}}return t===""?null:t}function ct(e,n=!1){var r=n?" !important;":";",t="";for(var i in e){var s=e[i];s!=null&&s!==""&&(t+=" "+i+": "+s+r)}return t}function lr(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var r="",t,i;if(Array.isArray(n)?(t=n[0],i=n[1]):t=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];t&&a.push(...Object.keys(t).map(lr)),i&&a.push(...Object.keys(i).map(lr));var c=0,g=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&g===-1)g=_;else if(u===";"||_===F-1){if(g!==-1){var v=lr(e.substring(c,g).trim());if(!a.includes(v)){u!==";"&&_++;var p=e.substring(c,_).trim();r+=" "+p+";"}}c=_+1,g=-1}}}}return t&&(r+=ct(t)),i&&(r+=ct(i,!0)),r=r.trim(),r===""?null:r}return e==null?null:String(e)}function Or(e,n,r,t,i,s){var l=e.__className;if(l!==r||l===void 0){var f=ci(r,t,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=r}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function cr(e,n={},r,t){for(var i in r){var s=r[i];n[i]!==s&&(r[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,t))}}function fi(e,n,r,t){var i=e.__style;if(i!==n){var s=ui(n,t);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else t&&(Array.isArray(t)?(cr(e,r==null?void 0:r[0],t[0]),cr(e,r==null?void 0:r[1],t[1],"important")):cr(e,r,t));return t}const fn=Symbol("class"),cn=Symbol("style"),Gt=Symbol("is custom element"),Kt=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function br(e,n,r,t){var i=qt(e);i[n]!==(i[n]=r)&&(n==="loading"&&(e[Xo]=r),r==null?e.removeAttribute(n):typeof r!="string"&&Wt(e).includes(n)?e[n]=r:e.setAttribute(n,r))}function _i(e,n,r,t,i=!1){var s=qt(e),l=s[Gt],f=!s[Kt],a=n||{},c=e.tagName==="OPTION";for(var g in n)g in r||(r[g]=null);r.class?r.class=Zt(r.class):r.class=null,r[cn]&&(r.style??(r.style=null));var _=Wt(e);for(const x in r){let D=r[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";Or(e,u,D,t,n==null?void 0:n[fn],r[fn]),a[x]=D,a[fn]=r[fn];continue}if(x==="style"){fi(e,D,n==null?void 0:n[cn],r[cn]),a[x]=D,a[cn]=r[cn];continue}var v=a[x];if(D!==v){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let N=x.slice(2);var F=$s(N);if(Bs(N)&&(N=N.slice(0,-7),M.capture=!0),!F&&v){if(D!=null)continue;e.removeEventListener(N,a[ee],M),a[ee]=null}if(D!=null)if(F)e[`__${N}`]=D,Xs([N]);else{let U=function(Y){a[x].call(this,Y)};var H=U;a[ee]=Ws(N,e,U,M)}else F&&(e[`__${N}`]=void 0)}else if(x==="style")br(e,x,D);else if(x==="autofocus")Ks(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var C=x;f||(C=Hs(C));var z=C==="defaultValue"||C==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,C==="value"||C==="checked"){let M=e;const ee=n===void 0;if(C==="value"){let N=M.defaultValue;M.removeAttribute(C),M.defaultValue=N,M.value=M.__value=ee?N:null}else{let N=M.defaultChecked;M.removeAttribute(C),M.defaultChecked=N,M.checked=ee?N:!1}}else e.removeAttribute(x);else z||_.includes(C)&&(l||typeof D!="string")?e[C]=D:typeof D!="function"&&br(e,C,D)}}}for(let x of Object.getOwnPropertySymbols(r))x.description===hs&&ai(e,()=>r[x]);return a}function qt(e){return e.__attributes??(e.__attributes={[Gt]:e.nodeName.includes("-"),[Kt]:e.namespaceURI===ps})}var ut=new Map;function Wt(e){var n=ut.get(e.nodeName);if(n)return n;ut.set(e.nodeName,n=[]);for(var r,t=e,i=Element.prototype;i!==t;){r=vt(t);for(var s in r)r[s].set&&n.push(s);t=Er(t)}return n}function Lr(e=!1){const n=$,r=n.l.u;if(!r)return;let t=()=>gr(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});t=()=>O(l)}r.b.length&&Ms(()=>{ft(n,t),fr(r.b)}),ot(()=>{const i=Bn(()=>r.m.map(Go));return()=>{for(const s of i)typeof s=="function"&&s()}}),r.a.length&&ot(()=>{ft(n,t),fr(r.a)})}function ft(e,n){if(e.l.s)for(const r of e.l.s)O(r);n()}let Nn=!1;function mi(e){var n=Nn;try{return Nn=!1,[e(),Nn]}finally{Nn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,r){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Et)),e.special[n](r),rt(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),rt(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},gi)}const vi={get(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t)return t[n]}},set(e,n,r){let t=e.props.length;for(;t--;){let i=e.props[t];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(r),!0}return!1},getOwnPropertyDescriptor(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t){const i=je(t,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===qe||n===bt)return!1;for(let r of e.props)if(ln(r)&&(r=r()),r!=null&&n in r)return!0;return!1},ownKeys(e){const n=[];for(let r of e.props)if(ln(r)&&(r=r()),!!r){for(const t in r)n.includes(t)||n.push(t);for(const t of Object.getOwnPropertySymbols(r))n.includes(t)||n.push(t)}return n}};function pi(...e){return new Proxy({props:e},vi)}function dt(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,r,t){var ee;var i=(r&fs)!==0,s=!pn||(r&ds)!==0,l=(r&_s)!==0,f=(r&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var g=qe in e||bt in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(g&&n in e&&(N=>e[n]=N)))||void 0,u=t,v=!0,p=!1,F=()=>(p=!0,v&&(v=!1,f?u=Bn(t):u=t),u);c===void 0&&t!==void 0&&(_&&s&&ts(),c=F(),_&&_(c));var C;if(s)C=()=>{var N=e[n];return N===void 0?F():(v=!0,p=!1,N)};else{var z=(i?mn:Fr)(()=>e[n]);z.f|=qo,C=()=>{var N=O(z);return N!==void 0&&(u=void 0),N===void 0?u:N}}if((r&Et)===0)return C;if(_){var H=e.$$legacy;return function(N,U){return arguments.length>0?((!s||!U||H||a)&&_(U?C():N),N):C()}}var x=!1,D=Nr(c),M=mn(()=>{var N=C(),U=O(D);return x?(x=!1,U):D.v=N});return l&&O(M),i||(M.equals=Mr),function(N,U){if(arguments.length>0){const Y=U?O(M):s&&l?Ke(N):N;if(!M.equals(Y)){if(x=!0,fe(D,Y),p&&u!==void 0&&(u=Y),dt(M))return N;Bn(()=>O(M))}return N}return dt(M)?M.v:O(M)}}function hi(e,n,{bubbles:r=!1,cancelable:t=!1}={}){return new CustomEvent(e,{detail:n,bubbles:r,cancelable:t})}function bi(){const e=$;return e===null&&Dt(),(n,r,t)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=$n(i)?i.slice():[i],f=hi(n,r,t);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){$===null&&Dt(),$.l===null&&rs(),wi($).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var gt;typeof window<"u"&&((gt=window.__svelte??(window.__svelte={})).v??(gt.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:22.383274902041656,ForwardDiff:1.6548053714091449,MooncakeForward:12.774150782193678,MooncakeReverse:5.761510569884381,ReverseDiff:31.879071995620034,ReverseDiffCompiled:2.822042344247551,Zygote:1738.6969300452943},Ri={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.3504229830239,ForwardDiff:1.2500690190080246,MooncakeForward:11.327778726310399,MooncakeReverse:7.50710486193461,ReverseDiff:31.348288075560806,ReverseDiffCompiled:2.8346777606608997,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.64932562620424,ForwardDiff:1.346505931099115,MooncakeForward:28.57681511003293,MooncakeReverse:5.434662644397028,ReverseDiff:29.552868173324402,ReverseDiffCompiled:3.1365590812605455,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.54582271410118,ForwardDiff:1.3689874897773948,MooncakeForward:22.876723195712724,MooncakeReverse:6.421862807030582,ReverseDiff:29.02712232167074,ReverseDiffCompiled:2.800528571889,Zygote:2147.596305775008},Ti={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.94378667041423,ForwardDiff:1.3143742341217544,MooncakeForward:29.419171433524006,MooncakeReverse:5.382099661344945,ReverseDiff:23.325198717054803,ReverseDiffCompiled:2.2011723605532074,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:61.99234449760766,ForwardDiff:1.4275990334850182,MooncakeForward:49.30788168422576,MooncakeReverse:7.25358630952381,ReverseDiff:49.91434899052328,ReverseDiffCompiled:2.7411285073489715,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.40778329439252,ForwardDiff:1.4516365701843654,MooncakeForward:46.4589772768988,MooncakeReverse:7.379837697977106,ReverseDiff:51.128120324434995,ReverseDiffCompiled:2.9869923960524187,Zygote:1596.9375154359102},Si={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:64.06365376973376,ForwardDiff:1.4059775648443888,MooncakeForward:41.98258491652275,MooncakeReverse:7.219734319825122,ReverseDiff:50.910000000000004,ReverseDiffCompiled:2.815009817935414,Zygote:1420.6004901960785},Ai={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.348181325122034,ForwardDiff:1.3834665672678057,MooncakeForward:24.860005499415685,MooncakeReverse:6.332571358905194,ReverseDiff:31.082709349453868,ReverseDiffCompiled:3.0993753684847904,Zygote:2094.7495471516763},Ci={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.64199553239018,ForwardDiff:1.2515157572123394,MooncakeForward:26.72328028840902,MooncakeReverse:5.330600918601684,ReverseDiff:28.94373382624769,ReverseDiffCompiled:2.111503759398496,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.46076818798012,ForwardDiff:1.2738222698072805,MooncakeForward:36.61990349564888,MooncakeReverse:6.126879712250121,ReverseDiff:40.17496347503831,ReverseDiffCompiled:2.349916845990909,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.9194894181356,ForwardDiff:1.319104958300286,MooncakeForward:38.18874811357175,MooncakeReverse:5.784486899966742,ReverseDiff:34.03754340277778,ReverseDiffCompiled:2.622721401323096,Zygote:"error"},Oi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:148.09045226130652,ForwardDiff:2.4230205475406845,MooncakeForward:58.12107521629919,MooncakeReverse:6.31319840857983,ReverseDiff:56.10063323635119,ReverseDiffCompiled:6.572000140879795,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:62.08041683051514,ForwardDiff:1.3326085195684987,MooncakeForward:33.810230478912466,MooncakeReverse:5.482359220709902,ReverseDiff:36.408858239727,ReverseDiffCompiled:3.202309882923742,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.181394837195654,ForwardDiff:1.3140145017735072,MooncakeForward:33.32222222222222,MooncakeReverse:6.225179664626031,ReverseDiff:40.6776978964586,ReverseDiffCompiled:2.417993925060806,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.86519722411996,ForwardDiff:1.2136720667648502,MooncakeForward:26.395533190873376,MooncakeReverse:4.971498430771476,ReverseDiff:32.381900967558344,ReverseDiffCompiled:1.9379900726566435,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:73.15857639818034,ForwardDiff:1.415245257220988,MooncakeForward:29.254259501965926,MooncakeReverse:5.023337975518581,ReverseDiff:20.963521838443967,ReverseDiffCompiled:1.9082292484476484,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.483886304909564,ForwardDiff:1.6256228697086312,MooncakeForward:17.009725302849343,MooncakeReverse:7.297206178764789,ReverseDiff:58.165663268796614,ReverseDiffCompiled:5.383366958603989,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.3724414120439,ForwardDiff:4.062266298162901,MooncakeForward:6.783229620410703,MooncakeReverse:40.50522284122563,ReverseDiff:10.841929653830114,ReverseDiffCompiled:4.927003739229393,Zygote:207.60927792351237},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:164.16032205260953,ForwardDiff:3.101070516972075,MooncakeForward:47.41615592523507,MooncakeReverse:3.873609394313968,ReverseDiff:22.513695266160415,ReverseDiffCompiled:1.9483402568695454,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:130267.87437641724,ForwardDiff:13351.425990556354,MooncakeForward:35752.68743266122,MooncakeReverse:17.08229485069363,ReverseDiff:4.661667620683076,ReverseDiffCompiled:1.7794186775305547,Zygote:22.13432398083879},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:17.13226145534458,MooncakeForward:415.45274308314924,MooncakeReverse:32.67527336225779,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:7238.656717486221,ForwardDiff:164.82484722132668,MooncakeForward:446.0148519762952,MooncakeReverse:10.345565267230262,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Gi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.8451370193967,ForwardDiff:1.1854997580700908,MooncakeForward:23.85492154570892,MooncakeReverse:9.783050288928901,ReverseDiff:12.441945278146157,ReverseDiffCompiled:1.291776733022945,Zygote:858.8865395245991},Ki={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:"wrong",MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:"error",ReverseDiffCompiled:"wrong",Zygote:"wrong"},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1338.341340736449,ForwardDiff:536.2230187552076,MooncakeForward:1957.4441323765598,MooncakeReverse:27.575309906943932,ReverseDiff:20.58244716125861,ReverseDiffCompiled:4.3298849463405205,Zygote:79.7095445200711},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6761.645195336602,ForwardDiff:79.39804996259312,MooncakeForward:1107.8997156995201,MooncakeReverse:3.1878596515312716,ReverseDiff:33.2758393572991,ReverseDiffCompiled:3.21173797178094,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:33.6139554087531,ForwardDiff:1.3532085002771042,MooncakeForward:22.6445945472999,MooncakeReverse:6.3633849346890585,ReverseDiff:32.99309060967314,ReverseDiffCompiled:2.6493311308961074,Zygote:1719.6487918148175},Ji={__category__:"Miscellaneous features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.35577264206726,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.21463969751478,ForwardDiff:1.2929670931712145,MooncakeForward:26.37454271573058,MooncakeReverse:13.504578722200616,ReverseDiff:29.53587851153445,ReverseDiffCompiled:2.3578751838674394,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:14.818621605202168,ForwardDiff:.8489250034528798,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:4.095679452445459,ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:136.6706781820756,ForwardDiff:1.7492676121832134,MooncakeForward:41.48617470627906,MooncakeReverse:4.603750212116069,ReverseDiff:20.284855856510056,ReverseDiffCompiled:1.9292947112161734,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:554.2821070675105,ForwardDiff:8.557263699889665,MooncakeForward:130.5458426966292,MooncakeReverse:4.159728122344944,ReverseDiff:20.313329213769038,ReverseDiffCompiled:1.8378675259053128,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1235.232089552239,ForwardDiff:14.50554716007519,MooncakeForward:233.3844699777613,MooncakeReverse:3.910439017245798,ReverseDiff:20.53582368322749,ReverseDiffCompiled:1.9021260723610594,Zygote:"error"},ta={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.991491542798567,ForwardDiff:1.3852550867824724,MooncakeForward:16.25785951442208,MooncakeReverse:6.78082381135576,ReverseDiff:21.488377657756203,ReverseDiffCompiled:2.269100691152759,Zygote:2459.503282871237},oa={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6748.586509883135,ForwardDiff:80.82684186497747,MooncakeForward:1238.8074934662457,MooncakeReverse:3.949251366666191,ReverseDiff:20.73490702032579,ReverseDiffCompiled:1.9100420073892517,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.33117877189998,ForwardDiff:1.6306889578412762,MooncakeForward:12.740178724866814,MooncakeReverse:5.883816993464052,ReverseDiff:33.42058423201759,ReverseDiffCompiled:3.2641438097202164,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:17.772509088342215,ForwardDiff:1.2552878763330302,MooncakeForward:8.631346578366447,MooncakeReverse:7.3939801406702514,ReverseDiff:12.811267245784363,ReverseDiffCompiled:2.3776596795543,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.59886643666831,ForwardDiff:1.6361556903951457,MooncakeForward:17.042869958251387,MooncakeReverse:7.362513971315302,ReverseDiff:57.40110226576853,ReverseDiffCompiled:5.106110147925094,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.438406243581845,ForwardDiff:1.5579748390669343,MooncakeForward:17.90894405713314,MooncakeReverse:7.248510638297873,ReverseDiff:36.361717259323505,ReverseDiffCompiled:3.4348388509576657,Zygote:3432.754510194641},ca={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:49.80835406301824,ForwardDiff:1.3905887489993451,MooncakeForward:23.94739536336503,MooncakeReverse:5.897196225953452,ReverseDiff:24.938641710489897,ReverseDiffCompiled:2.133695652173913,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:22.632369450586836,ForwardDiff:1.4649802371541503,MooncakeForward:13.939152628892291,MooncakeReverse:5.6002059767009955,ReverseDiff:27.25930893304627,ReverseDiffCompiled:2.540859593682087,Zygote:3275.0175499165653},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:19.54704370179949,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:2.943732377538829,Zygote:1912.4276403344138},da={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:136.2805085809587,ForwardDiff:1.8565125750214346,MooncakeForward:57.00184042438021,MooncakeReverse:5.148874421523257,ReverseDiff:31.562630105520068,ReverseDiffCompiled:2.5504664179104477,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135.72794800371403,ForwardDiff:1.6131768218211429,MooncakeForward:58.40670313130942,MooncakeReverse:4.951980955619793,ReverseDiff:31.226941525392697,ReverseDiffCompiled:2.816264424301991,Zygote:"error"},ma={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.0303783291919,ForwardDiff:1.2685834197116534,MooncakeForward:23.34045412499782,MooncakeReverse:5.429239766081871,ReverseDiff:12.955601116236688,ReverseDiffCompiled:1.197841226196614,Zygote:1676.209816204309},ga={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:42.926705554146594,ForwardDiff:1.1037228584328695,MooncakeForward:23.01923076923077,MooncakeReverse:11.70701652652943,ReverseDiff:16.727514719881537,ReverseDiffCompiled:4.118190749972708,Zygote:433.68498313485236},va={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.53163004240704,ForwardDiff:1.3465064167854959,MooncakeForward:23.88752893315564,MooncakeReverse:6.418589096593919,ReverseDiff:29.341046277666003,ReverseDiffCompiled:2.8244676423666504,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.815021533161065,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:38.01408548431863,ForwardDiff:1.6575137294058915,MooncakeForward:29.92333126679066,MooncakeReverse:7.2355374351371395,ReverseDiff:20.547936259143157,ReverseDiffCompiled:"wrong",Zygote:2066.3419137612686},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Fi,demo_assume_multivariate_observe:Ni,demo_assume_multivariate_observe_literal:Si,demo_assume_observe_literal:Ai,demo_assume_submodel_observe_index_literal:Ci,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Ii,assume_lkjcholu:Oi,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:$i,dppl_high_dim_gauss:Ui,dppl_hmm_semisup:Hi,dppl_lda:Zi,assume_mvnormal:Gi,dppl_logistic_regression:Ki,dppl_naive_bayes:qi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ra,assume_normal:ta,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:ua,observe_von_mises:fa,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:ga,broadcast_macro:va,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
