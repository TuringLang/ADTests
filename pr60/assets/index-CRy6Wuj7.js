...
\r\f \v\uFEFF`];function ci(e,n,r){var t=e==null?"":""+e;if(n&&(t=t?t+" "+n:n),r){for(var i in r)if(r[i])t=t?t+" "+i:i;else if(t.length)for(var s=i.length,l=0;(l=t.indexOf(i,l))>=0;){var f=l+s;(l===0||lt.includes(t[l-1]))&&(f===t.length||lt.includes(t[f]))?t=(l===0?"":t.substring(0,l))+t.substring(f+1):l=f}}return t===""?null:t}function ct(e,n=!1){var r=n?" !important;":";",t="";for(var i in e){var s=e[i];s!=null&&s!==""&&(t+=" "+i+": "+s+r)}return t}function lr(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var r="",t,i;if(Array.isArray(n)?(t=n[0],i=n[1]):t=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];t&&a.push(...Object.keys(t).map(lr)),i&&a.push(...Object.keys(i).map(lr));var c=0,g=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&g===-1)g=_;else if(u===";"||_===F-1){if(g!==-1){var v=lr(e.substring(c,g).trim());if(!a.includes(v)){u!==";"&&_++;var p=e.substring(c,_).trim();r+=" "+p+";"}}c=_+1,g=-1}}}}return t&&(r+=ct(t)),i&&(r+=ct(i,!0)),r=r.trim(),r===""?null:r}return e==null?null:String(e)}function Or(e,n,r,t,i,s){var l=e.__className;if(l!==r||l===void 0){var f=ci(r,t,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=r}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function cr(e,n={},r,t){for(var i in r){var s=r[i];n[i]!==s&&(r[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,t))}}function fi(e,n,r,t){var i=e.__style;if(i!==n){var s=ui(n,t);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else t&&(Array.isArray(t)?(cr(e,r==null?void 0:r[0],t[0]),cr(e,r==null?void 0:r[1],t[1],"important")):cr(e,r,t));return t}const fn=Symbol("class"),cn=Symbol("style"),Gt=Symbol("is custom element"),Kt=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function br(e,n,r,t){var i=qt(e);i[n]!==(i[n]=r)&&(n==="loading"&&(e[Xo]=r),r==null?e.removeAttribute(n):typeof r!="string"&&Wt(e).includes(n)?e[n]=r:e.setAttribute(n,r))}function _i(e,n,r,t,i=!1){var s=qt(e),l=s[Gt],f=!s[Kt],a=n||{},c=e.tagName==="OPTION";for(var g in n)g in r||(r[g]=null);r.class?r.class=Zt(r.class):r.class=null,r[cn]&&(r.style??(r.style=null));var _=Wt(e);for(const x in r){let D=r[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";Or(e,u,D,t,n==null?void 0:n[fn],r[fn]),a[x]=D,a[fn]=r[fn];continue}if(x==="style"){fi(e,D,n==null?void 0:n[cn],r[cn]),a[x]=D,a[cn]=r[cn];continue}var v=a[x];if(D!==v){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let N=x.slice(2);var F=$s(N);if(Bs(N)&&(N=N.slice(0,-7),M.capture=!0),!F&&v){if(D!=null)continue;e.removeEventListener(N,a[ee],M),a[ee]=null}if(D!=null)if(F)e[`__${N}`]=D,Xs([N]);else{let U=function(Y){a[x].call(this,Y)};var H=U;a[ee]=Ws(N,e,U,M)}else F&&(e[`__${N}`]=void 0)}else if(x==="style")br(e,x,D);else if(x==="autofocus")Ks(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var C=x;f||(C=Hs(C));var z=C==="defaultValue"||C==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,C==="value"||C==="checked"){let M=e;const ee=n===void 0;if(C==="value"){let N=M.defaultValue;M.removeAttribute(C),M.defaultValue=N,M.value=M.__value=ee?N:null}else{let N=M.defaultChecked;M.removeAttribute(C),M.defaultChecked=N,M.checked=ee?N:!1}}else e.removeAttribute(x);else z||_.includes(C)&&(l||typeof D!="string")?e[C]=D:typeof D!="function"&&br(e,C,D)}}}for(let x of Object.getOwnPropertySymbols(r))x.description===hs&&ai(e,()=>r[x]);return a}function qt(e){return e.__attributes??(e.__attributes={[Gt]:e.nodeName.includes("-"),[Kt]:e.namespaceURI===ps})}var ut=new Map;function Wt(e){var n=ut.get(e.nodeName);if(n)return n;ut.set(e.nodeName,n=[]);for(var r,t=e,i=Element.prototype;i!==t;){r=vt(t);for(var s in r)r[s].set&&n.push(s);t=Er(t)}return n}function Lr(e=!1){const n=$,r=n.l.u;if(!r)return;let t=()=>gr(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});t=()=>O(l)}r.b.length&&Ms(()=>{ft(n,t),fr(r.b)}),ot(()=>{const i=Bn(()=>r.m.map(Go));return()=>{for(const s of i)typeof s=="function"&&s()}}),r.a.length&&ot(()=>{ft(n,t),fr(r.a)})}function ft(e,n){if(e.l.s)for(const r of e.l.s)O(r);n()}let Nn=!1;function mi(e){var n=Nn;try{return Nn=!1,[e(),Nn]}finally{Nn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,r){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Et)),e.special[n](r),rt(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),rt(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},gi)}const vi={get(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t)return t[n]}},set(e,n,r){let t=e.props.length;for(;t--;){let i=e.props[t];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(r),!0}return!1},getOwnPropertyDescriptor(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t){const i=je(t,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===qe||n===bt)return!1;for(let r of e.props)if(ln(r)&&(r=r()),r!=null&&n in r)return!0;return!1},ownKeys(e){const n=[];for(let r of e.props)if(ln(r)&&(r=r()),!!r){for(const t in r)n.includes(t)||n.push(t);for(const t of Object.getOwnPropertySymbols(r))n.includes(t)||n.push(t)}return n}};function pi(...e){return new Proxy({props:e},vi)}function dt(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,r,t){var ee;var i=(r&fs)!==0,s=!pn||(r&ds)!==0,l=(r&_s)!==0,f=(r&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var g=qe in e||bt in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(g&&n in e&&(N=>e[n]=N)))||void 0,u=t,v=!0,p=!1,F=()=>(p=!0,v&&(v=!1,f?u=Bn(t):u=t),u);c===void 0&&t!==void 0&&(_&&s&&ts(),c=F(),_&&_(c));var C;if(s)C=()=>{var N=e[n];return N===void 0?F():(v=!0,p=!1,N)};else{var z=(i?mn:Fr)(()=>e[n]);z.f|=qo,C=()=>{var N=O(z);return N!==void 0&&(u=void 0),N===void 0?u:N}}if((r&Et)===0)return C;if(_){var H=e.$$legacy;return function(N,U){return arguments.length>0?((!s||!U||H||a)&&_(U?C():N),N):C()}}var x=!1,D=Nr(c),M=mn(()=>{var N=C(),U=O(D);return x?(x=!1,U):D.v=N});return l&&O(M),i||(M.equals=Mr),function(N,U){if(arguments.length>0){const Y=U?O(M):s&&l?Ke(N):N;if(!M.equals(Y)){if(x=!0,fe(D,Y),p&&u!==void 0&&(u=Y),dt(M))return N;Bn(()=>O(M))}return N}return dt(M)?M.v:O(M)}}function hi(e,n,{bubbles:r=!1,cancelable:t=!1}={}){return new CustomEvent(e,{detail:n,bubbles:r,cancelable:t})}function bi(){const e=$;return e===null&&Dt(),(n,r,t)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=$n(i)?i.slice():[i],f=hi(n,r,t);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){$===null&&Dt(),$.l===null&&rs(),wi($).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var gt;typeof window<"u"&&((gt=window.__svelte??(window.__svelte={})).v??(gt.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.967456785897657,ForwardDiff:1.6278097982708934,MooncakeForward:13.398437115068143,MooncakeReverse:5.849378317458009,ReverseDiff:30.091418454021827,ReverseDiffCompiled:2.893408024757857,Zygote:1792.5517938352705},Ri={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:19.87373952805883,ForwardDiff:1.3114361353749422,MooncakeForward:12.077799546298206,MooncakeReverse:7.563661062998812,ReverseDiff:32.2821274851404,ReverseDiffCompiled:2.7230483898162197,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.47876580538758,ForwardDiff:1.3274996715280514,MooncakeForward:24.120210497351586,MooncakeReverse:6.493359375,ReverseDiff:31.413196822353097,ReverseDiffCompiled:2.80675569520817,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.113597007688576,ForwardDiff:1.3690792495495179,MooncakeForward:22.693380209226547,MooncakeReverse:6.103787125979905,ReverseDiff:29.813859734482516,ReverseDiffCompiled:2.8959783560346186,Zygote:2023.5870020964362},Ti={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.85837149949306,ForwardDiff:1.3517375771354336,MooncakeForward:30.230742515801907,MooncakeReverse:4.964771258723184,ReverseDiff:22.000839366278456,ReverseDiffCompiled:2.184943498746604,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:64.07905335270915,ForwardDiff:1.4194109415900193,MooncakeForward:39.928219971056436,MooncakeReverse:7.541216289201742,ReverseDiff:50.08301478821576,ReverseDiffCompiled:2.7233847977357026,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:64.30463334549435,ForwardDiff:1.3881720430107527,MooncakeForward:41.385594446051485,MooncakeReverse:7.1671238740747345,ReverseDiff:50.7382775288431,ReverseDiffCompiled:2.8762984282651693,Zygote:1616.6862132352942},Si={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.95481916718368,ForwardDiff:1.4292749572318326,MooncakeForward:43.24592979835699,MooncakeReverse:7.219379683597003,ReverseDiff:53.355947201533816,ReverseDiffCompiled:2.7904159579247025,Zygote:1436.1729049588237},Ai={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:36.14767624020888,ForwardDiff:1.4715735167669821,MooncakeForward:22.6314144913045,MooncakeReverse:6.737574417417927,ReverseDiff:32.39134026295863,ReverseDiffCompiled:3.2418940853360585,Zygote:2069.2537655306446},Ci={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.870188706167724,ForwardDiff:1.2189932654377467,MooncakeForward:25.904277265850638,MooncakeReverse:4.992790714440199,ReverseDiff:29.68643971308209,ReverseDiffCompiled:2.1834113987630563,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.9227757232978,ForwardDiff:1.2075986977657955,MooncakeForward:32.255201524037204,MooncakeReverse:6.304972846342242,ReverseDiff:40.685335107759414,ReverseDiffCompiled:2.4701095597375193,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:58.95314042965475,ForwardDiff:1.3491476680336414,MooncakeForward:33.536844282070724,MooncakeReverse:5.660390536988359,ReverseDiff:35.289379431328115,ReverseDiffCompiled:2.6385535455592284,Zygote:"error"},Oi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:151.16113110539845,ForwardDiff:2.486387496546553,MooncakeForward:57.10330980773911,MooncakeReverse:6.205079764903442,ReverseDiff:55.72935732647815,ReverseDiffCompiled:6.58108527131783,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:60.00115615847078,ForwardDiff:1.3637025693380977,MooncakeForward:33,MooncakeReverse:5.819514603668958,ReverseDiff:35.83672608374644,ReverseDiffCompiled:2.6349607182940518,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.29504801355677,ForwardDiff:1.3198507548581404,MooncakeForward:32.546600285485496,MooncakeReverse:6.387563557846346,ReverseDiff:40.76931353561437,ReverseDiffCompiled:2.3978733427552323,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.78058977230309,ForwardDiff:1.2779722398864681,MooncakeForward:30.1183912590303,MooncakeReverse:5.0950513839653375,ReverseDiff:31.635025976798808,ReverseDiffCompiled:1.907818317200298,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:76.1568493642698,ForwardDiff:1.4998292058070026,MooncakeForward:30.859986728599868,MooncakeReverse:5.026963216424294,ReverseDiff:20.884642918016024,ReverseDiffCompiled:1.934378690004862,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.038611346316678,ForwardDiff:1.6450562183846502,MooncakeForward:17.182916703471424,MooncakeReverse:7.7162672674722925,ReverseDiff:58.14144590668263,ReverseDiffCompiled:5.154357751839095,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:28.388318356867774,ForwardDiff:3.9876225687188556,MooncakeForward:30.096582602339186,MooncakeReverse:39.881561547749094,ReverseDiff:12.235465116279071,ReverseDiffCompiled:4.850533807829182,Zygote:237.36859478151527},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:166.14065916900967,ForwardDiff:3.0425149929332673,MooncakeForward:45.1046159667045,MooncakeReverse:3.7548232883728874,ReverseDiff:22.588859416445622,ReverseDiffCompiled:1.930517553662954,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:133364.86714739673,ForwardDiff:14951.804197735431,MooncakeForward:34362.890928443754,MooncakeReverse:16.808226140673263,ReverseDiff:4.6709431204579595,ReverseDiffCompiled:1.8732869749095196,Zygote:33.55841884328358},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:30.248889316975088,MooncakeForward:190.5262248921713,MooncakeReverse:4.428009954415477,ReverseDiff:73.66991436243559,ReverseDiffCompiled:12.33542603640814,Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:7213.095100498074,ForwardDiff:161.81408855664176,MooncakeForward:491.83944443651825,MooncakeReverse:10.17458769539653,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Gi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.41764806866953,ForwardDiff:1.1903799457058875,MooncakeForward:24.049093094791928,MooncakeReverse:9.466504263093787,ReverseDiff:12.41212448595525,ReverseDiffCompiled:1.201363200438416,Zygote:935.4568297619879},Ki={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1218.8303270098713,ForwardDiff:"wrong",MooncakeForward:"wrong",MooncakeReverse:"wrong",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1308.4645577501815,ForwardDiff:583.9405572945436,MooncakeForward:1747.994323144105,MooncakeReverse:27.14219367917318,ReverseDiff:20.89025872950725,ReverseDiffCompiled:4.049266954135633,Zygote:80.48343067546978},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6715.704654778086,ForwardDiff:90.47495517332979,MooncakeForward:1150.2214509134565,MooncakeReverse:3.390255233539901,ReverseDiff:33.652937650365736,ReverseDiffCompiled:3.1470530706744113,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.346625873518065,ForwardDiff:1.3466936699321779,MooncakeForward:23.40656335460346,MooncakeReverse:6.276625028475966,ReverseDiff:31.918710532742562,ReverseDiffCompiled:2.6799114895664444,Zygote:1681.3255156528112},Ji={__category__:"Miscellaneous features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.709725832236735,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.436692142429465,ForwardDiff:1.2372193436960277,MooncakeForward:26.73772904039519,MooncakeReverse:13.492751423149906,ReverseDiff:30.3738979570159,ReverseDiffCompiled:2.315827439036608,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:14.446115861186046,ForwardDiff:.893296804952679,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:137.77451717655103,ForwardDiff:1.7678811581209133,MooncakeForward:42.38542515861482,MooncakeReverse:4.498819716027199,ReverseDiff:21.06470338383123,ReverseDiffCompiled:1.8873782181766974,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:652.2185873605947,ForwardDiff:8.642873092668403,MooncakeForward:132.06317757009344,MooncakeReverse:4.084718100890208,ReverseDiff:20.601749012951554,ReverseDiffCompiled:1.8448417132216015,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1242.2130531796206,ForwardDiff:14.020847810979845,MooncakeForward:231.83588812204866,MooncakeReverse:4.047728965003723,ReverseDiff:20.83452647278151,ReverseDiffCompiled:1.8649723756906076,Zygote:"error"},ta={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.475811482433596,ForwardDiff:1.451911756627355,MooncakeForward:17.706767366444787,MooncakeReverse:6.704969268469047,ReverseDiff:20.742420641656764,ReverseDiffCompiled:2.320626787578111,Zygote:2405.763739085773},oa={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6681.36886357081,ForwardDiff:72.43937920120791,MooncakeForward:1214.5941771122311,MooncakeReverse:4.118212548672819,ReverseDiff:20.179695833933977,ReverseDiffCompiled:1.8638239538239538,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.1888718734048,ForwardDiff:1.6562888740674104,MooncakeForward:12.869619162502152,MooncakeReverse:5.688828473685403,ReverseDiff:34.54068232351306,ReverseDiffCompiled:3.3520194170623174,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:17.980089972937826,ForwardDiff:1.24669441222624,MooncakeForward:8.582484230955847,MooncakeReverse:7.228707506135639,ReverseDiff:12.851885098743267,ReverseDiffCompiled:2.68936816020678,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.66920102651839,ForwardDiff:1.6560685186790327,MooncakeForward:17.728167639656913,MooncakeReverse:7.640532482576578,ReverseDiff:56.99371677138714,ReverseDiffCompiled:5.169220683231072,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.987113313963423,ForwardDiff:1.572910330737067,MooncakeForward:18.082452830188682,MooncakeReverse:7.412714584900015,ReverseDiff:37.589289364311504,ReverseDiffCompiled:3.4117858054907373,Zygote:2760.448698051388},ca={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:49.04364574376613,ForwardDiff:1.3253293562018393,MooncakeForward:23.181746977694534,MooncakeReverse:5.601705274855819,ReverseDiff:25.761125017382838,ReverseDiffCompiled:2.2309851683207707,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:23.340191281138786,ForwardDiff:1.53059156591428,MooncakeForward:14.075477603406807,MooncakeReverse:5.861006804578867,ReverseDiff:27.234720392980456,ReverseDiffCompiled:2.453138566373059,Zygote:3263.428129536186},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.0349267223668,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:2.935724632682624,Zygote:2301.3589365363678},da={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135.0856898943549,ForwardDiff:1.776180136284998,MooncakeForward:59.9116440634123,MooncakeReverse:5.245423523975402,ReverseDiff:31.82973621103118,ReverseDiffCompiled:2.566757522504752,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:134.15366639521298,ForwardDiff:1.790700230845334,MooncakeForward:59.4882176752914,MooncakeReverse:5.014630267691493,ReverseDiff:30.346013846263652,ReverseDiffCompiled:2.5114224684117157,Zygote:"error"},ma={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:33.52742315098781,ForwardDiff:1.24764675418166,MooncakeForward:19.518103563772772,MooncakeReverse:5.126989507870144,ReverseDiff:12.086717656555802,ReverseDiffCompiled:1.177689457661403,Zygote:1723.9654803509025},ga={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:42.4899819859564,ForwardDiff:1.1181119223815936,MooncakeForward:24.567157409991623,MooncakeReverse:12.673068065053327,ReverseDiff:16.41362307611031,ReverseDiffCompiled:4.929708707454583,Zygote:455.08952542014583},va={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:36.40859845227859,ForwardDiff:1.3378404099256533,MooncakeForward:23.7433066519459,MooncakeReverse:6.200066753699972,ReverseDiff:31.620889611767204,ReverseDiffCompiled:2.9558916138963722,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.321918461958006,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:37.477089417327214,ForwardDiff:1.6669056807715437,MooncakeForward:28.569417340395873,MooncakeReverse:7.514226874892742,ReverseDiff:19.60089797954602,ReverseDiffCompiled:"wrong",Zygote:2162.140377840713},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Fi,demo_assume_multivariate_observe:Ni,demo_assume_multivariate_observe_literal:Si,demo_assume_observe_literal:Ai,demo_assume_submodel_observe_index_literal:Ci,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Ii,assume_lkjcholu:Oi,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:$i,dppl_high_dim_gauss:Ui,dppl_hmm_semisup:Hi,dppl_lda:Zi,assume_mvnormal:Gi,dppl_logistic_regression:Ki,dppl_naive_bayes:qi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ra,assume_normal:ta,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:ua,observe_von_mises:fa,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:ga,broadcast_macro:va,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
