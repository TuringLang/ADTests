...
\r\f \v\uFEFF`];function ci(e,n,r){var t=e==null?"":""+e;if(n&&(t=t?t+" "+n:n),r){for(var i in r)if(r[i])t=t?t+" "+i:i;else if(t.length)for(var s=i.length,l=0;(l=t.indexOf(i,l))>=0;){var f=l+s;(l===0||lt.includes(t[l-1]))&&(f===t.length||lt.includes(t[f]))?t=(l===0?"":t.substring(0,l))+t.substring(f+1):l=f}}return t===""?null:t}function ct(e,n=!1){var r=n?" !important;":";",t="";for(var i in e){var s=e[i];s!=null&&s!==""&&(t+=" "+i+": "+s+r)}return t}function lr(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function ui(e,n){if(n){var r="",t,i;if(Array.isArray(n)?(t=n[0],i=n[1]):t=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,f=!1,a=[];t&&a.push(...Object.keys(t).map(lr)),i&&a.push(...Object.keys(i).map(lr));var c=0,g=-1;const F=e.length;for(var _=0;_<F;_++){var u=e[_];if(f?u==="/"&&e[_-1]==="*"&&(f=!1):s?s===u&&(s=!1):u==="/"&&e[_+1]==="*"?f=!0:u==='"'||u==="'"?s=u:u==="("?l++:u===")"&&l--,!f&&s===!1&&l===0){if(u===":"&&g===-1)g=_;else if(u===";"||_===F-1){if(g!==-1){var v=lr(e.substring(c,g).trim());if(!a.includes(v)){u!==";"&&_++;var p=e.substring(c,_).trim();r+=" "+p+";"}}c=_+1,g=-1}}}}return t&&(r+=ct(t)),i&&(r+=ct(i,!0)),r=r.trim(),r===""?null:r}return e==null?null:String(e)}function Or(e,n,r,t,i,s){var l=e.__className;if(l!==r||l===void 0){var f=ci(r,t,s);f==null?e.removeAttribute("class"):n?e.className=f:e.setAttribute("class",f),e.__className=r}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function cr(e,n={},r,t){for(var i in r){var s=r[i];n[i]!==s&&(r[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,t))}}function fi(e,n,r,t){var i=e.__style;if(i!==n){var s=ui(n,t);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else t&&(Array.isArray(t)?(cr(e,r==null?void 0:r[0],t[0]),cr(e,r==null?void 0:r[1],t[1],"important")):cr(e,r,t));return t}const fn=Symbol("class"),cn=Symbol("style"),Gt=Symbol("is custom element"),Kt=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function br(e,n,r,t){var i=qt(e);i[n]!==(i[n]=r)&&(n==="loading"&&(e[Xo]=r),r==null?e.removeAttribute(n):typeof r!="string"&&Wt(e).includes(n)?e[n]=r:e.setAttribute(n,r))}function _i(e,n,r,t,i=!1){var s=qt(e),l=s[Gt],f=!s[Kt],a=n||{},c=e.tagName==="OPTION";for(var g in n)g in r||(r[g]=null);r.class?r.class=Zt(r.class):r.class=null,r[cn]&&(r.style??(r.style=null));var _=Wt(e);for(const x in r){let D=r[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var u=e.namespaceURI==="http://www.w3.org/1999/xhtml";Or(e,u,D,t,n==null?void 0:n[fn],r[fn]),a[x]=D,a[fn]=r[fn];continue}if(x==="style"){fi(e,D,n==null?void 0:n[cn],r[cn]),a[x]=D,a[cn]=r[cn];continue}var v=a[x];if(D!==v){a[x]=D;var p=x[0]+x[1];if(p!=="$$")if(p==="on"){const M={},ee="$$"+x;let N=x.slice(2);var F=$s(N);if(Bs(N)&&(N=N.slice(0,-7),M.capture=!0),!F&&v){if(D!=null)continue;e.removeEventListener(N,a[ee],M),a[ee]=null}if(D!=null)if(F)e[`__${N}`]=D,Xs([N]);else{let U=function(Y){a[x].call(this,Y)};var H=U;a[ee]=Ws(N,e,U,M)}else F&&(e[`__${N}`]=void 0)}else if(x==="style")br(e,x,D);else if(x==="autofocus")Ks(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var C=x;f||(C=Hs(C));var z=C==="defaultValue"||C==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,C==="value"||C==="checked"){let M=e;const ee=n===void 0;if(C==="value"){let N=M.defaultValue;M.removeAttribute(C),M.defaultValue=N,M.value=M.__value=ee?N:null}else{let N=M.defaultChecked;M.removeAttribute(C),M.defaultChecked=N,M.checked=ee?N:!1}}else e.removeAttribute(x);else z||_.includes(C)&&(l||typeof D!="string")?e[C]=D:typeof D!="function"&&br(e,C,D)}}}for(let x of Object.getOwnPropertySymbols(r))x.description===hs&&ai(e,()=>r[x]);return a}function qt(e){return e.__attributes??(e.__attributes={[Gt]:e.nodeName.includes("-"),[Kt]:e.namespaceURI===ps})}var ut=new Map;function Wt(e){var n=ut.get(e.nodeName);if(n)return n;ut.set(e.nodeName,n=[]);for(var r,t=e,i=Element.prototype;i!==t;){r=vt(t);for(var s in r)r[s].set&&n.push(s);t=Er(t)}return n}function Lr(e=!1){const n=$,r=n.l.u;if(!r)return;let t=()=>gr(n.s);if(e){let i=0,s={};const l=mn(()=>{let f=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],f=!0);return f&&i++,i});t=()=>O(l)}r.b.length&&Ms(()=>{ft(n,t),fr(r.b)}),ot(()=>{const i=Bn(()=>r.m.map(Go));return()=>{for(const s of i)typeof s=="function"&&s()}}),r.a.length&&ot(()=>{ft(n,t),fr(r.a)})}function ft(e,n){if(e.l.s)for(const r of e.l.s)O(r);n()}let Nn=!1;function mi(e){var n=Nn;try{return Nn=!1,[e(),Nn]}finally{Nn=n}}const gi={get(e,n){if(!e.exclude.includes(n))return O(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,r){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Et)),e.special[n](r),rt(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),rt(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},gi)}const vi={get(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t)return t[n]}},set(e,n,r){let t=e.props.length;for(;t--;){let i=e.props[t];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(r),!0}return!1},getOwnPropertyDescriptor(e,n){let r=e.props.length;for(;r--;){let t=e.props[r];if(ln(t)&&(t=t()),typeof t=="object"&&t!==null&&n in t){const i=je(t,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===qe||n===bt)return!1;for(let r of e.props)if(ln(r)&&(r=r()),r!=null&&n in r)return!0;return!1},ownKeys(e){const n=[];for(let r of e.props)if(ln(r)&&(r=r()),!!r){for(const t in r)n.includes(t)||n.push(t);for(const t of Object.getOwnPropertySymbols(r))n.includes(t)||n.push(t)}return n}};function pi(...e){return new Proxy({props:e},vi)}function dt(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,r,t){var ee;var i=(r&fs)!==0,s=!pn||(r&ds)!==0,l=(r&_s)!==0,f=(r&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var g=qe in e||bt in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(g&&n in e&&(N=>e[n]=N)))||void 0,u=t,v=!0,p=!1,F=()=>(p=!0,v&&(v=!1,f?u=Bn(t):u=t),u);c===void 0&&t!==void 0&&(_&&s&&ts(),c=F(),_&&_(c));var C;if(s)C=()=>{var N=e[n];return N===void 0?F():(v=!0,p=!1,N)};else{var z=(i?mn:Fr)(()=>e[n]);z.f|=qo,C=()=>{var N=O(z);return N!==void 0&&(u=void 0),N===void 0?u:N}}if((r&Et)===0)return C;if(_){var H=e.$$legacy;return function(N,U){return arguments.length>0?((!s||!U||H||a)&&_(U?C():N),N):C()}}var x=!1,D=Nr(c),M=mn(()=>{var N=C(),U=O(D);return x?(x=!1,U):D.v=N});return l&&O(M),i||(M.equals=Mr),function(N,U){if(arguments.length>0){const Y=U?O(M):s&&l?Ke(N):N;if(!M.equals(Y)){if(x=!0,fe(D,Y),p&&u!==void 0&&(u=Y),dt(M))return N;Bn(()=>O(M))}return N}return dt(M)?M.v:O(M)}}function hi(e,n,{bubbles:r=!1,cancelable:t=!1}={}){return new CustomEvent(e,{detail:n,bubbles:r,cancelable:t})}function bi(){const e=$;return e===null&&Dt(),(n,r,t)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=$n(i)?i.slice():[i],f=hi(n,r,t);for(const a of l)a.call(e.x,f);return!f.defaultPrevented}return!0}}function yi(e){$===null&&Dt(),$.l===null&&rs(),wi($).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var gt;typeof window<"u"&&((gt=window.__svelte??(window.__svelte={})).v??(gt.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.839132644418093,ForwardDiff:1.64402711489244,MooncakeForward:13.443343689548039,MooncakeReverse:5.645542902857922,ReverseDiff:32.04469502819067,ReverseDiffCompiled:2.8808707088754506,Zygote:1827.6723199892533},Ri={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:20.270644424447983,ForwardDiff:1.3418738019724115,MooncakeForward:11.2972159036299,MooncakeReverse:7.516855431993156,ReverseDiff:32.8195737425405,ReverseDiffCompiled:2.9522910324097267,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.90056818181819,ForwardDiff:1.306479367835423,MooncakeForward:24.918684090670215,MooncakeReverse:6.157087470449172,ReverseDiff:29.701179554390567,ReverseDiffCompiled:3.0632193961445617,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.94910304547351,ForwardDiff:1.3285697869126964,MooncakeForward:22.739001189060644,MooncakeReverse:6.288060791080436,ReverseDiff:28.518031105793884,ReverseDiffCompiled:2.9775734922719463,Zygote:2147.858220594103},Ti={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.35812133072406,ForwardDiff:1.2986293185252875,MooncakeForward:28.981642512077297,MooncakeReverse:5.273627159471564,ReverseDiff:23.501714775650186,ReverseDiffCompiled:2.1052224722563038,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.70356066314996,ForwardDiff:1.4667847491052515,MooncakeForward:45.83256856994998,MooncakeReverse:7.572090437361008,ReverseDiff:49.36962016043368,ReverseDiffCompiled:2.782502403796976,Zygote:"error"},Ni={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:66.54618152738905,ForwardDiff:1.3322195364709228,MooncakeForward:45.210101637054855,MooncakeReverse:7.337919870497774,ReverseDiff:51.55391916833025,ReverseDiffCompiled:2.8729892032897357,Zygote:1605.2098927514794},Si={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:63.54321694333142,ForwardDiff:1.4418447534046865,MooncakeForward:39.969842460615155,MooncakeReverse:7.258272391571936,ReverseDiff:50.17910613286015,ReverseDiffCompiled:2.809088852932477,Zygote:1476.4822166495953},Ai={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.060821956269955,ForwardDiff:1.4280726779417559,MooncakeForward:23.768908775981526,MooncakeReverse:6.3971662938105895,ReverseDiff:32.021596566523606,ReverseDiffCompiled:3.20838823012736,Zygote:2194.902089120591},Ci={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.72047578589635,ForwardDiff:1.2847419423541104,MooncakeForward:26.486212778054153,MooncakeReverse:5.275122860532113,ReverseDiff:28.862994454713498,ReverseDiffCompiled:2.0548519958427955,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.46420855537952,ForwardDiff:1.2434424509495332,MooncakeForward:31.866680864657646,MooncakeReverse:6.131900861610467,ReverseDiff:40.34384368497161,ReverseDiffCompiled:2.4938735240762546,Zygote:"error"},Ii={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.875100849052984,ForwardDiff:1.3468585837360791,MooncakeForward:37.39927140908764,MooncakeReverse:5.71898343373494,ReverseDiff:32.19216417910448,ReverseDiffCompiled:2.5723925697971897,Zygote:"error"},Oi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:148.1993852317469,ForwardDiff:2.464620133767793,MooncakeForward:57.34895578682685,MooncakeReverse:6.254633408919124,ReverseDiff:55.28725776024696,ReverseDiffCompiled:6.942857142857143,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:59.205946102160254,ForwardDiff:1.3213594470046082,MooncakeForward:32.99884591172974,MooncakeReverse:5.553352725045928,ReverseDiff:36.01825954640968,ReverseDiffCompiled:2.743005565862709,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:61.064978888350524,ForwardDiff:1.3289302050796101,MooncakeForward:32.6491968018778,MooncakeReverse:6.23535715605484,ReverseDiff:41.63853627402312,ReverseDiffCompiled:2.3912269196111993,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:56.98283534647171,ForwardDiff:1.262716018458336,MooncakeForward:27.035363243988247,MooncakeReverse:5.1908695961826075,ReverseDiff:32.6412803144632,ReverseDiffCompiled:1.8587649821265857,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:76.72741801000556,ForwardDiff:1.3913395933256774,MooncakeForward:29.20364467849224,MooncakeReverse:5.226738952127554,ReverseDiff:21.555181214905566,ReverseDiffCompiled:1.9435428414248384,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.08008872206108,ForwardDiff:1.400760492937264,MooncakeForward:16.935637089557375,MooncakeReverse:7.76363842963468,ReverseDiff:56.41321799897732,ReverseDiffCompiled:5.3208336720513145,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:27.330350901719555,ForwardDiff:3.707432335672347,MooncakeForward:8.34920634920635,MooncakeReverse:29.188425246382888,ReverseDiff:9.396144633283905,ReverseDiffCompiled:4.130944270336558,Zygote:223.51889491117132},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:166.59667287110284,ForwardDiff:3.1730619853969237,MooncakeForward:48.47175925925925,MooncakeReverse:3.630820078496178,ReverseDiff:22.331456456456454,ReverseDiffCompiled:2.097560505626638,Zygote:"error"},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:120516.34362282879,ForwardDiff:13212.177562657473,MooncakeForward:32901.88236460233,MooncakeReverse:16.98466790207744,ReverseDiff:4.7227356746765246,ReverseDiffCompiled:1.8506862665475514,Zygote:31.45701508600694},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:34.87073398500982,MooncakeForward:196.7214179924514,MooncakeReverse:4.342437815630555,ReverseDiff:73.35672845110052,ReverseDiffCompiled:10.821202104492745,Zygote:"error"},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6516.5810984316695,ForwardDiff:170.55979586370236,MooncakeForward:476.44920486070407,MooncakeReverse:9.957612444764584,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Gi={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.999155048584704,ForwardDiff:1.2132096622988917,MooncakeForward:24.102023465397043,MooncakeReverse:9.744302470787618,ReverseDiff:12.786529156217993,ReverseDiffCompiled:1.2413171600877193,Zygote:894.5592831839967},Ki={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:"error",ForwardDiff:52.16611340695076,MooncakeForward:698.3051584335711,MooncakeReverse:"error",ReverseDiff:38.804877332589456,ReverseDiffCompiled:4.727653268238465,Zygote:174.69559328507322},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1320.5217769310705,ForwardDiff:538.5829975024496,MooncakeForward:1651.3776422539877,MooncakeReverse:24.993309726512468,ReverseDiff:20.445891807042614,ReverseDiffCompiled:4.048317589195097,Zygote:70.87994975388166},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6714.024082177074,ForwardDiff:83.65671599615699,MooncakeForward:3467.232859220947,MooncakeReverse:3.478554408260524,ReverseDiff:33.01835520097403,ReverseDiffCompiled:3.2181861387436697,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.81545325491787,ForwardDiff:1.3003978166342864,MooncakeForward:21.050138413659106,MooncakeReverse:6.212906191209167,ReverseDiff:31.594353853889807,ReverseDiffCompiled:2.560443222938051,Zygote:1615.804923164485},Ji={__category__:"Miscellaneous features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.53779084237856,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:57.15888263221817,ForwardDiff:1.2276255069221087,MooncakeForward:26.611703557666456,MooncakeReverse:13.861213835109854,ReverseDiff:29.731231694157547,ReverseDiffCompiled:2.3246677572641588,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:14.76941553242594,ForwardDiff:.8705276556352697,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"wrong",ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:137.2811741104424,ForwardDiff:1.7401918423781544,MooncakeForward:42.61820247053813,MooncakeReverse:4.573226787355915,ReverseDiff:19.95797289251567,ReverseDiffCompiled:1.9120855766506093,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:628.8893650031399,ForwardDiff:8.764810426540285,MooncakeForward:128.30567296996662,MooncakeReverse:4.1658536585365855,ReverseDiff:20.70642303843445,ReverseDiffCompiled:1.8817332835263354,Zygote:"error"},ra={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:1243.6740576496672,ForwardDiff:14.546279761904763,MooncakeForward:234.00497586334944,MooncakeReverse:4.174499629355077,ReverseDiff:21.09791976225854,ReverseDiffCompiled:1.901635687732342,Zygote:"error"},ta={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:24.93539466370206,ForwardDiff:1.4506242757348,MooncakeForward:16.8254993688275,MooncakeReverse:6.357079068489386,ReverseDiff:20.30067357219675,ReverseDiffCompiled:2.2068531914893614,Zygote:2327.902761104442},oa={__category__:"Effect of model size",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:6601.41791977219,ForwardDiff:74.04281588447654,MooncakeForward:1262.6857126458222,MooncakeReverse:4.0542054997767245,ReverseDiff:20.420369918640855,ReverseDiffCompiled:1.864407989606088,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:21.04462922110979,ForwardDiff:1.5671702321808783,MooncakeForward:12.843397651981869,MooncakeReverse:5.730023364485981,ReverseDiff:34.972353244964715,ReverseDiffCompiled:3.2643119477488254,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:17.590112058374594,ForwardDiff:1.2085081265678688,MooncakeForward:8.603922914164809,MooncakeReverse:7.523815975162292,ReverseDiff:12.660052887191274,ReverseDiffCompiled:2.461821048610603,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.39648992037947,ForwardDiff:1.6169338410232936,MooncakeForward:16.66745291230025,MooncakeReverse:7.359449882600164,ReverseDiff:57.83851527188057,ReverseDiffCompiled:5.383222392899812,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:26.568683274021353,ForwardDiff:1.5539160284244409,MooncakeForward:16.57951252769729,MooncakeReverse:7.294112945582425,ReverseDiff:36.63098740222884,ReverseDiffCompiled:3.3908135957596652,Zygote:3373.030456852792},ca={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:49.88388098683514,ForwardDiff:1.3528886684849988,MooncakeForward:24.15713168929003,MooncakeReverse:5.316155208869079,ReverseDiff:25.70144270689178,ReverseDiffCompiled:2.2971969194616038,Zygote:"error"},ua={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:23.270042918454937,ForwardDiff:1.4343592284430475,MooncakeForward:13.659566252654608,MooncakeReverse:5.770128337727795,ReverseDiff:27.375218209823725,ReverseDiffCompiled:2.5475269470641626,Zygote:3213.8180649197193},fa={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:19.931010532308566,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:2.9111291836096345,Zygote:1877.3410525581558},da={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:129.50754556293646,ForwardDiff:1.827625488210618,MooncakeForward:57.55012189875233,MooncakeReverse:5.2254901960784315,ReverseDiff:31.759276345545,ReverseDiffCompiled:2.529456314052458,Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:135.4959233666045,ForwardDiff:1.8821808128680166,MooncakeForward:57.70625914427435,MooncakeReverse:5.1670096021947876,ReverseDiff:29.570330927024514,ReverseDiffCompiled:2.5439422129801903,Zygote:"error"},ma={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:34.416344482673,ForwardDiff:1.2670694263655242,MooncakeForward:20.106861525704808,MooncakeReverse:5.458791880655418,ReverseDiff:13.683084028400085,ReverseDiffCompiled:1.2144258048496501,Zygote:1713.299268056898},ga={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:42.52087855487289,ForwardDiff:1.1052827325468675,MooncakeForward:23.863520624681723,MooncakeReverse:11.708579881656805,ReverseDiff:16.786719151121,ReverseDiffCompiled:4.308080928059548,Zygote:447.8361566555288},va={__category__:"Core Turing syntax",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:35.2910447761194,ForwardDiff:1.3623385899600735,MooncakeForward:23.805559556387728,MooncakeReverse:6.223341902313624,ReverseDiff:28.442814932257136,ReverseDiffCompiled:2.836184873344848,Zygote:"error"},pa={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.586441494118453,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:37.76586668516335,ForwardDiff:1.603280598280073,MooncakeForward:29.9553664648152,MooncakeReverse:7.19862315145334,ReverseDiff:19.768822243049044,ReverseDiffCompiled:"wrong",Zygote:2185.4829384541},ba={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Fi,demo_assume_multivariate_observe:Ni,demo_assume_multivariate_observe_literal:Si,demo_assume_observe_literal:Ai,demo_assume_submodel_observe_index_literal:Ci,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Ii,assume_lkjcholu:Oi,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:$i,dppl_high_dim_gauss:Ui,dppl_hmm_semisup:Hi,dppl_lda:Zi,assume_mvnormal:Gi,dppl_logistic_regression:Ki,dppl_naive_bayes:qi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ra,assume_normal:ta,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:ua,observe_von_mises:fa,pdb_eight_schools_centered:da,pdb_eight_schools_noncentered:_a,assume_submodel:ma,assume_wishart:ga,broadcast_macro:va,call_C:pa,control_flow:ha},ya=`@model function assume_beta()
    a ~ Beta(2, 2)
end
