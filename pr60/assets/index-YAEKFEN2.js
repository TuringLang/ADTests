...
\r\f \v\uFEFF`];function ci(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var i in t)if(t[i])r=r?r+" "+i:i;else if(r.length)for(var s=i.length,l=0;(l=r.indexOf(i,l))>=0;){var u=l+s;(l===0||lr.includes(r[l-1]))&&(u===r.length||lr.includes(r[u]))?r=(l===0?"":r.substring(0,l))+r.substring(u+1):l=u}}return r===""?null:r}function cr(e,n=!1){var t=n?" !important;":";",r="";for(var i in e){var s=e[i];s!=null&&s!==""&&(r+=" "+i+": "+s+t)}return r}function lt(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function fi(e,n){if(n){var t="",r,i;if(Array.isArray(n)?(r=n[0],i=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,l=0,u=!1,a=[];r&&a.push(...Object.keys(r).map(lt)),i&&a.push(...Object.keys(i).map(lt));var c=0,p=-1;const S=e.length;for(var _=0;_<S;_++){var f=e[_];if(u?f==="/"&&e[_-1]==="*"&&(u=!1):s?s===f&&(s=!1):f==="/"&&e[_+1]==="*"?u=!0:f==='"'||f==="'"?s=f:f==="("?l++:f===")"&&l--,!u&&s===!1&&l===0){if(f===":"&&p===-1)p=_;else if(f===";"||_===S-1){if(p!==-1){var v=lt(e.substring(c,p).trim());if(!a.includes(v)){f!==";"&&_++;var g=e.substring(c,_).trim();t+=" "+g+";"}}c=_+1,p=-1}}}}return r&&(t+=cr(r)),i&&(t+=cr(i,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function It(e,n,t,r,i,s){var l=e.__className;if(l!==t||l===void 0){var u=ci(t,r,s);u==null?e.removeAttribute("class"):n?e.className=u:e.setAttribute("class",u),e.__className=t}else if(s&&i!==s)for(var a in s){var c=!!s[a];(i==null||c!==!!i[a])&&e.classList.toggle(a,c)}return s}function ct(e,n={},t,r){for(var i in t){var s=t[i];n[i]!==s&&(t[i]==null?e.style.removeProperty(i):e.style.setProperty(i,s,r))}}function ui(e,n,t,r){var i=e.__style;if(i!==n){var s=fi(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(ct(e,t==null?void 0:t[0],r[0]),ct(e,t==null?void 0:t[1],r[1],"important")):ct(e,t,r));return r}const un=Symbol("class"),cn=Symbol("style"),Kr=Symbol("is custom element"),Zr=Symbol("is html");function di(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function bt(e,n,t,r){var i=Gr(e);i[n]!==(i[n]=t)&&(n==="loading"&&(e[Xo]=t),t==null?e.removeAttribute(n):typeof t!="string"&&Wr(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function _i(e,n,t,r,i=!1){var s=Gr(e),l=s[Kr],u=!s[Zr],a=n||{},c=e.tagName==="OPTION";for(var p in n)p in t||(t[p]=null);t.class?t.class=Hr(t.class):t.class=null,t[cn]&&(t.style??(t.style=null));var _=Wr(e);for(const x in t){let D=t[x];if(c&&x==="value"&&D==null){e.value=e.__value="",a[x]=D;continue}if(x==="class"){var f=e.namespaceURI==="http://www.w3.org/1999/xhtml";It(e,f,D,r,n==null?void 0:n[un],t[un]),a[x]=D,a[un]=t[un];continue}if(x==="style"){ui(e,D,n==null?void 0:n[cn],t[cn]),a[x]=D,a[cn]=t[cn];continue}var v=a[x];if(D!==v){a[x]=D;var g=x[0]+x[1];if(g!=="$$")if(g==="on"){const M={},ee="$$"+x;let F=x.slice(2);var S=Us(F);if(Bs(F)&&(F=F.slice(0,-7),M.capture=!0),!S&&v){if(D!=null)continue;e.removeEventListener(F,a[ee],M),a[ee]=null}if(D!=null)if(S)e[`__${F}`]=D,Xs([F]);else{let $=function(Y){a[x].call(this,Y)};var q=$;a[ee]=Ws(F,e,$,M)}else S&&(e[`__${F}`]=void 0)}else if(x==="style")bt(e,x,D);else if(x==="autofocus")Zs(e,!!D);else if(!l&&(x==="__value"||x==="value"&&D!=null))e.value=e.__value=D;else if(x==="selected"&&c)di(e,D);else{var A=x;u||(A=qs(A));var z=A==="defaultValue"||A==="defaultChecked";if(D==null&&!l&&!z)if(s[x]=null,A==="value"||A==="checked"){let M=e;const ee=n===void 0;if(A==="value"){let F=M.defaultValue;M.removeAttribute(A),M.defaultValue=F,M.value=M.__value=ee?F:null}else{let F=M.defaultChecked;M.removeAttribute(A),M.defaultChecked=F,M.checked=ee?F:!1}}else e.removeAttribute(x);else z||_.includes(A)&&(l||typeof D!="string")?e[A]=D:typeof D!="function"&&bt(e,A,D)}}}for(let x of Object.getOwnPropertySymbols(t))x.description===hs&&ai(e,()=>t[x]);return a}function Gr(e){return e.__attributes??(e.__attributes={[Kr]:e.nodeName.includes("-"),[Zr]:e.namespaceURI===gs})}var fr=new Map;function Wr(e){var n=fr.get(e.nodeName);if(n)return n;fr.set(e.nodeName,n=[]);for(var t,r=e,i=Element.prototype;i!==r;){t=vr(r);for(var s in t)t[s].set&&n.push(s);r=Et(r)}return n}function Lt(e=!1){const n=U,t=n.l.u;if(!t)return;let r=()=>pt(n.s);if(e){let i=0,s={};const l=mn(()=>{let u=!1;const a=n.s;for(const c in a)a[c]!==s[c]&&(s[c]=a[c],u=!0);return u&&i++,i});r=()=>I(l)}t.b.length&&Ms(()=>{ur(n,r),ut(t.b)}),or(()=>{const i=Bn(()=>t.m.map(Ko));return()=>{for(const s of i)typeof s=="function"&&s()}}),t.a.length&&or(()=>{ur(n,r),ut(t.a)})}function ur(e,n){if(e.l.s)for(const t of e.l.s)I(t);n()}let Fn=!1;function mi(e){var n=Fn;try{return Fn=!1,[e(),Fn]}finally{Fn=n}}const pi={get(e,n){if(!e.exclude.includes(n))return I(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Be({get[n](){return e.props[n]}},n,Er)),e.special[n](t),tr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),tr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function jn(e,n){return new Proxy({props:e,exclude:n,special:{},version:Qe(0)},pi)}const vi={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let i=e.props[r];ln(i)&&(i=i());const s=je(i,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(ln(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const i=je(r,n);return i&&!i.configurable&&(i.configurable=!0),i}}},has(e,n){if(n===Ge||n===br)return!1;for(let t of e.props)if(ln(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(ln(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function gi(...e){return new Proxy({props:e},vi)}function dr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Be(e,n,t,r){var ee;var i=(t&us)!==0,s=!gn||(t&ds)!==0,l=(t&_s)!==0,u=(t&ms)!==0,a=!1,c;l?[c,a]=mi(()=>e[n]):c=e[n];var p=Ge in e||br in e,_=l&&(((ee=je(e,n))==null?void 0:ee.set)??(p&&n in e&&(F=>e[n]=F)))||void 0,f=r,v=!0,g=!1,S=()=>(g=!0,v&&(v=!1,u?f=Bn(r):f=r),f);c===void 0&&r!==void 0&&(_&&s&&rs(),c=S(),_&&_(c));var A;if(s)A=()=>{var F=e[n];return F===void 0?S():(v=!0,g=!1,F)};else{var z=(i?mn:St)(()=>e[n]);z.f|=Go,A=()=>{var F=I(z);return F!==void 0&&(f=void 0),F===void 0?f:F}}if((t&Er)===0)return A;if(_){var q=e.$$legacy;return function(F,$){return arguments.length>0?((!s||!$||q||a)&&_($?A():F),F):A()}}var x=!1,D=Ft(c),M=mn(()=>{var F=A(),$=I(D);return x?(x=!1,$):D.v=F});return l&&I(M),i||(M.equals=Mt),function(F,$){if(arguments.length>0){const Y=$?I(M):s&&l?Ze(F):F;if(!M.equals(Y)){if(x=!0,ue(D,Y),g&&f!==void 0&&(f=Y),dr(M))return F;Bn(()=>I(M))}return F}return dr(M)?M.v:I(M)}}function hi(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function bi(){const e=U;return e===null&&Dr(),(n,t,r)=>{var s;const i=(s=e.s.$$events)==null?void 0:s[n];if(i){const l=Un(i)?i.slice():[i],u=hi(n,t,r);for(const a of l)a.call(e.x,u);return!u.defaultPrevented}return!0}}function yi(e){U===null&&Dr(),U.l===null&&ts(),wi(U).a.push(e)}function wi(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Ei="5";var pr;typeof window<"u"&&((pr=window.__svelte??(window.__svelte={})).v??(pr.v=new Set)).add(Ei);ls();const Di={__category__:"Distributions",EnzymeForward:2.902382968428692,EnzymeReverse:3.398590263155909,FiniteDifferences:27.313395381715363,ForwardDiff:1.7427939229902996,MooncakeForward:7.680280202034085,MooncakeReverse:5.993501956400223,ReverseDiff:37.95402690277541,ReverseDiffCompiled:3.399187446356778,Zygote:1866.3090382978726},Ri={__category__:"Distributions",EnzymeForward:2.787853859936122,EnzymeReverse:2.9575140207817228,FiniteDifferences:22.71379505120076,ForwardDiff:1.3965349562357754,MooncakeForward:8.244730077120822,MooncakeReverse:7.497225729397714,ReverseDiff:34.94351197656385,ReverseDiffCompiled:3.328686797293229,Zygote:"error"},Mi={__category__:"DynamicPPL demo models",EnzymeForward:3.851509068186068,EnzymeReverse:3.4132664845317287,FiniteDifferences:42.77536231884058,ForwardDiff:1.5321054240410636,MooncakeForward:23.443120829706988,MooncakeReverse:7.391274826005772,ReverseDiff:42.19154929577465,ReverseDiffCompiled:4.369820144585826,Zygote:"error"},xi={__category__:"DynamicPPL demo models",EnzymeForward:3.691353306088848,EnzymeReverse:3.1769645038627643,FiniteDifferences:39.84092531772097,ForwardDiff:1.4880123213827332,MooncakeForward:19.938115020281117,MooncakeReverse:7.698509451828989,ReverseDiff:39.52404906284454,ReverseDiffCompiled:4.059264138226824,Zygote:3072.520486758344},Ti={__category__:"DynamicPPL demo models",EnzymeForward:4.777405163709794,EnzymeReverse:4.156484159899628,FiniteDifferences:65.61211495439683,ForwardDiff:1.4258494004193862,MooncakeForward:27.44140318321319,MooncakeReverse:6.454422746555412,ReverseDiff:30.947460776218005,ReverseDiffCompiled:3.1115085448248454,Zygote:"error"},Si={__category__:"DynamicPPL demo models",EnzymeForward:5.952423283433489,EnzymeReverse:4.989893400352002,FiniteDifferences:68.83824888067657,ForwardDiff:1.5208782147153992,MooncakeForward:33.72506504770165,MooncakeReverse:7.861597364437717,ReverseDiff:61.05909107123747,ReverseDiffCompiled:3.495422660801332,Zygote:"error"},Fi={__category__:"DynamicPPL demo models",EnzymeForward:4.991196940463066,EnzymeReverse:5.167773476546172,FiniteDifferences:70.8910131174993,ForwardDiff:1.5307049994715145,MooncakeForward:39.65610125868208,MooncakeReverse:8.496702056141153,ReverseDiff:65.46083277033034,ReverseDiffCompiled:3.7555672379350225,Zygote:2230.4192063297564},Ni={__category__:"DynamicPPL demo models",EnzymeForward:4.7136385241024925,EnzymeReverse:4.844024345501716,FiniteDifferences:70.04827319678178,ForwardDiff:1.557022128598257,MooncakeForward:35.08328742780986,MooncakeReverse:8.061577350249458,ReverseDiff:65.55303248059788,ReverseDiffCompiled:4.099879178413209,Zygote:1893.9689352879122},Ci={__category__:"DynamicPPL demo models",EnzymeForward:3.811524368146249,EnzymeReverse:2.9683317234717816,FiniteDifferences:42.61951538965291,ForwardDiff:1.4228074656547043,MooncakeForward:21.455875439984407,MooncakeReverse:7.2377258537508276,ReverseDiff:40.47376093294461,ReverseDiffCompiled:4.532659198185875,Zygote:3550.74176012035},Ai={__category__:"DynamicPPL demo models",EnzymeForward:4.2993761568519915,EnzymeReverse:4.691021187315127,FiniteDifferences:63.7334403853874,ForwardDiff:1.3836198997017712,MooncakeForward:26.16263218915785,MooncakeReverse:6.276851661292904,ReverseDiff:41.155121414322075,ReverseDiffCompiled:3.1124780724683143,Zygote:"error"},ki={__category__:"DynamicPPL demo models",EnzymeForward:4.9586945740421005,EnzymeReverse:5.079421721225658,FiniteDifferences:65.66015026884591,ForwardDiff:1.3986127187538826,MooncakeForward:29.47443333451945,MooncakeReverse:7.152449518822873,ReverseDiff:51.68227460099355,ReverseDiffCompiled:3.2860913934360267,Zygote:"error"},Oi={__category__:"DynamicPPL demo models",EnzymeForward:4.790959140552927,EnzymeReverse:4.075938862135257,FiniteDifferences:66.31582014693416,ForwardDiff:1.1389817934530617,MooncakeForward:27.539067372284887,MooncakeReverse:5.936301568855316,ReverseDiff:38.1773840228951,ReverseDiffCompiled:3.274611052529673,Zygote:"error"},Ii={__category__:"Distributions",EnzymeForward:4.950791676537945,EnzymeReverse:6.603322376559572,FiniteDifferences:155.7424015774801,ForwardDiff:2.6502386521762986,MooncakeForward:35.818598307337204,MooncakeReverse:6.25112709011014,ReverseDiff:60.44241607025551,ReverseDiffCompiled:7.058330425071544,Zygote:"error"},Li={__category__:"DynamicPPL demo models",EnzymeForward:5.036409715949011,EnzymeReverse:4.315117732861013,FiniteDifferences:66.6976230748687,ForwardDiff:1.2911369980674257,MooncakeForward:31.51884037575203,MooncakeReverse:6.788359426631116,ReverseDiff:48.50707413695529,ReverseDiffCompiled:3.573535251434966,Zygote:"error"},Pi={__category__:"DynamicPPL demo models",EnzymeForward:4.874837394086419,EnzymeReverse:5.13948609688019,FiniteDifferences:65.75907474562545,ForwardDiff:1.3515981735159817,MooncakeForward:29.864409141583053,MooncakeReverse:7.413748547207219,ReverseDiff:53.33304589610024,ReverseDiffCompiled:3.26362939542014,Zygote:"error"},zi={__category__:"DynamicPPL demo models",EnzymeForward:4.50920245398773,EnzymeReverse:4.714812715647963,FiniteDifferences:63.87163814180929,ForwardDiff:1.3964826645610509,MooncakeForward:25.57011216566005,MooncakeReverse:5.884641868628907,ReverseDiff:46.316086481148375,ReverseDiffCompiled:2.8256189189844956,Zygote:"error"},Vi={__category__:"Core Turing syntax",EnzymeForward:3.6017011948501034,EnzymeReverse:2.1225780051150895,FiniteDifferences:85.56263848644963,ForwardDiff:1.5420502146993549,MooncakeForward:23.64491396671731,MooncakeReverse:6.08303349017437,ReverseDiff:31.03456824128908,ReverseDiffCompiled:2.7665685710451866,Zygote:"error"},Bi={__category__:"Core Turing syntax",EnzymeForward:3.5712061983193712,EnzymeReverse:2.850264301751966,FiniteDifferences:31.741952942516953,ForwardDiff:1.8417035996108528,MooncakeForward:12.039871382636656,MooncakeReverse:7.815572236341785,ReverseDiff:73.55461367426348,ReverseDiffCompiled:6.86837439798981,Zygote:"error"},ji={__category__:"DynamicPPL arXiV paper",EnzymeForward:1.390973442982899,EnzymeReverse:1.6187754516384705,FiniteDifferences:23.901977352306695,ForwardDiff:1.3868329462497253,MooncakeForward:5.130625339785625,MooncakeReverse:6.126453334530747,ReverseDiff:90.52674428610197,ReverseDiffCompiled:15.755499375980033,Zygote:14.8341435843261},Ui={__category__:"DynamicPPL arXiV paper",EnzymeForward:5.00764263059345,EnzymeReverse:2.4437763994063704,FiniteDifferences:166.54322212083946,ForwardDiff:3.5059848093211916,MooncakeForward:41.12742803650831,MooncakeReverse:4.3793549313986055,ReverseDiff:30.568900617020454,ReverseDiffCompiled:2.363661117161973,Zygote:800.9183121449825},$i={__category__:"DynamicPPL arXiV paper",EnzymeForward:12496.397597030615,EnzymeReverse:2.4314127545779183,FiniteDifferences:130712.75161446356,ForwardDiff:3403.384953976824,MooncakeForward:20658.376049928385,MooncakeReverse:3.59928204107795,ReverseDiff:1.8390936457570581,ReverseDiffCompiled:.43773686152195057,Zygote:6.718938895925861},qi={__category__:"DynamicPPL arXiV paper",EnzymeForward:38.37449646858618,EnzymeReverse:9.011527394223553,FiniteDifferences:"NaN",ForwardDiff:32.0399877146178,MooncakeForward:187.40331848408547,MooncakeReverse:4.037800006228748,ReverseDiff:74.78567269356688,ReverseDiffCompiled:11.51647082409477,Zygote:"error"},Hi={__category__:"DynamicPPL arXiV paper",EnzymeForward:"error",EnzymeReverse:2.990074979413167,FiniteDifferences:3162.3974957471223,ForwardDiff:214.0653614024063,MooncakeForward:2478.9017248454525,MooncakeReverse:9.629992790194665,ReverseDiff:81.04731786997714,ReverseDiffCompiled:10.21653395965879,Zygote:"error"},Ki={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:4.580524291712239,FiniteDifferences:39.58285295042449,ForwardDiff:1.1908482212893063,MooncakeForward:19.357204221894943,MooncakeReverse:9.813937505727113,ReverseDiff:19.04137342254888,ReverseDiffCompiled:1.4778313765828397,Zygote:886.6086819091771},Zi={__category__:"DynamicPPL arXiV paper",EnzymeForward:42.194679047883454,EnzymeReverse:3.2393176342857544,FiniteDifferences:1089.8971663282982,ForwardDiff:51.460779030012255,MooncakeForward:607.813571969172,MooncakeReverse:4.966875732550752,ReverseDiff:61.6139068676426,ReverseDiffCompiled:7.540137761131057,Zygote:172.8717131587973},Gi={__category__:"DynamicPPL arXiV paper",EnzymeForward:216.51360479457284,EnzymeReverse:.9801487018251568,FiniteDifferences:2771.947844165938,ForwardDiff:250.60375163795885,MooncakeForward:421.62786235043916,MooncakeReverse:4.510011413620607,ReverseDiff:143.50583718483858,ReverseDiffCompiled:21.93282924067227,Zygote:5031.155859613018},Wi={__category__:"DynamicPPL arXiV paper",EnzymeForward:306.59969735909783,EnzymeReverse:2.7534960862924778,FiniteDifferences:6728.847282713899,ForwardDiff:102.51402477227818,MooncakeForward:1679.0324817387352,MooncakeReverse:4.598767804385944,ReverseDiff:49.80061933092754,ReverseDiffCompiled:4.720789460915134,Zygote:"error"},Xi={__category__:"Core Turing syntax",EnzymeForward:3.3034352274371077,EnzymeReverse:2.8980324572741636,FiniteDifferences:39.898989898989896,ForwardDiff:1.436428260673272,MooncakeForward:12.279127642493979,MooncakeReverse:7.183103892935559,ReverseDiff:43.983803842685724,ReverseDiffCompiled:3.570071317523382,Zygote:2064.573474727999},Ji={__category__:"Integrations with other packages",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:25.212854198410167,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},Yi={__category__:"Core Turing syntax",EnzymeForward:3.7840992731622043,EnzymeReverse:2.74737215629066,FiniteDifferences:62.75605278058992,ForwardDiff:1.378481374745363,MooncakeForward:25.91783671346854,MooncakeReverse:16.56182472989196,ReverseDiff:39.40962823368169,ReverseDiffCompiled:3.249292737330203,Zygote:"error"},Qi={__category__:"Base Julia features",EnzymeForward:2.8237827491326715,EnzymeReverse:12.486268451767938,FiniteDifferences:15.543371257968206,ForwardDiff:.942434276139945,MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:4.71853923342655,ReverseDiffCompiled:"wrong",Zygote:"error"},ea={__category__:"Effect of model size",EnzymeForward:5.519858353006527,EnzymeReverse:1.9833233209179384,FiniteDifferences:149.6573305548688,ForwardDiff:1.9909638554216869,MooncakeForward:36.03445540456646,MooncakeReverse:5.916556842616355,ReverseDiff:30.09322496926649,ReverseDiffCompiled:3.3401944366917853,Zygote:"error"},na={__category__:"Effect of model size",EnzymeForward:25.31710811505823,EnzymeReverse:1.8582218783390443,FiniteDifferences:631.6660632828904,ForwardDiff:10.573940906889227,MooncakeForward:142.03482731156325,MooncakeReverse:5.623955733969838,ReverseDiff:31.244832713754644,ReverseDiffCompiled:2.726718628790957,Zygote:"error"},ta={__category__:"Effect of model size",EnzymeForward:57.01489648207373,EnzymeReverse:2.186808564337694,FiniteDifferences:1077.3091966720751,ForwardDiff:19.372579363419632,MooncakeForward:288.52867308497275,MooncakeReverse:5.866480003343224,ReverseDiff:35.07102488401518,ReverseDiffCompiled:3.0397493967743303,Zygote:"error"},ra={__category__:"Distributions",EnzymeForward:3.4736994422210627,EnzymeReverse:2.6505634877873563,FiniteDifferences:33.059479680326476,ForwardDiff:1.6068907850860845,MooncakeForward:9.896056590825106,MooncakeReverse:7.371807205988075,ReverseDiff:26.949103627069725,ReverseDiffCompiled:2.782782470298942,Zygote:2649.724944887231},oa={__category__:"Effect of model size",EnzymeForward:249.61803035833134,EnzymeReverse:1.8090267983074753,FiniteDifferences:6770.479029614249,ForwardDiff:98.66806287244148,MooncakeForward:1494.1015846882076,MooncakeReverse:5.62245942707766,ReverseDiff:30.338402630554235,ReverseDiffCompiled:2.861957113312289,Zygote:"error"},sa={__category__:"Distributions",EnzymeForward:2.875857049144973,EnzymeReverse:3.1267354791351414,FiniteDifferences:24.13590775738555,ForwardDiff:1.8001250610220998,MooncakeForward:6.796832387913166,MooncakeReverse:5.984207063806265,ReverseDiff:41.04214808231354,ReverseDiffCompiled:3.8383421885875046,Zygote:"error"},ia={__category__:"Distributions",EnzymeForward:2.079966437354635,EnzymeReverse:6.398931757188258,FiniteDifferences:18.974659136288434,ForwardDiff:1.231078689382397,MooncakeForward:6.239953367164999,MooncakeReverse:7.738274867016654,ReverseDiff:13.730305466237942,ReverseDiffCompiled:2.792804337111878,Zygote:"error"},aa={__category__:"Core Turing syntax",EnzymeForward:3.392799888478428,EnzymeReverse:3.0787990724762726,FiniteDifferences:32.1398619760983,ForwardDiff:1.7981404426760048,MooncakeForward:11.454526992722965,MooncakeReverse:8.121826271402364,ReverseDiff:73.0581474544526,ReverseDiffCompiled:6.854228161712381,Zygote:"error"},la={__category__:"Core Turing syntax",EnzymeForward:3.53502312329323,EnzymeReverse:3.0489810129864363,FiniteDifferences:35.02872905873646,ForwardDiff:1.6907248880860755,MooncakeForward:11.132429423199676,MooncakeReverse:8.451121157957452,ReverseDiff:47.9627441440189,ReverseDiffCompiled:4.819577771828507,Zygote:4005.2455245593023},ca={__category__:"Core Turing syntax",EnzymeForward:3.225705764028577,EnzymeReverse:3.037558861719935,FiniteDifferences:56.99355498721228,ForwardDiff:1.446293992997973,MooncakeForward:17.74581478755593,MooncakeReverse:6.218306472534912,ReverseDiff:33.64808170024841,ReverseDiffCompiled:3.0185661625946705,Zygote:"error"},fa={__category__:"Core Turing syntax",EnzymeForward:3.216587656839229,EnzymeReverse:2.813642037474823,FiniteDifferences:30.13572071760061,ForwardDiff:1.7404884802078349,MooncakeForward:9.596001686231272,MooncakeReverse:6.975016223231668,ReverseDiff:39.23526379102939,ReverseDiffCompiled:3.7232987729041653,Zygote:4253.0933803693715},ua={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:22.992343101955246,ForwardDiff:"NaN",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"NaN",ReverseDiffCompiled:3.6710474558848722,Zygote:2417.283942202835},da={__category__:"Integrations with other packages",EnzymeForward:"error",EnzymeReverse:"error",FiniteDifferences:62.545234521575985,ForwardDiff:4.94506989748369,MooncakeForward:"error",MooncakeReverse:54.04937103944009,ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},_a={__category__:"PosteriorDB",EnzymeForward:8.154749423359194,EnzymeReverse:3.033507816116512,FiniteDifferences:141.94646204311152,ForwardDiff:1.965213488189418,MooncakeForward:54.865953947368425,MooncakeReverse:6.422081465138899,ReverseDiff:47.392544378698226,ReverseDiffCompiled:4.775014801657786,Zygote:"error"},ma={__category__:"Core Turing syntax",EnzymeForward:3.040230928433971,EnzymeReverse:2.2820831727568933,FiniteDifferences:41.76227025538652,ForwardDiff:1.3603965949077275,MooncakeForward:16.870610237583985,MooncakeReverse:6.474960088845701,ReverseDiff:20.290692118542346,ReverseDiffCompiled:1.7671881826364484,Zygote:2464.5044350042485},pa={__category__:"PosteriorDB",EnzymeForward:7.802472302010669,EnzymeReverse:2.9051994014636557,FiniteDifferences:141.24113850386203,ForwardDiff:2.172710576401017,MooncakeForward:56.93105381165919,MooncakeReverse:6.45958750400741,ReverseDiff:45.32316694742442,ReverseDiffCompiled:3.8733784156776156,Zygote:"error"},va={__category__:"Distributions",EnzymeForward:"error",EnzymeReverse:11.534266391812231,FiniteDifferences:44.54856895056375,ForwardDiff:1.131577115685434,MooncakeForward:18.426182782034058,MooncakeReverse:12.115698982633614,ReverseDiff:17.522144253997467,ReverseDiffCompiled:4.389083046822387,Zygote:389.272186642269},ga={__category__:"Core Turing syntax",EnzymeForward:3.7992949443501227,EnzymeReverse:3.644721270257549,FiniteDifferences:41.75596217105264,ForwardDiff:1.4805476668744662,MooncakeForward:20.4030124461132,MooncakeReverse:7.643926613243358,ReverseDiff:41.47610396869759,ReverseDiffCompiled:4.090694228614796,Zygote:"error"},ha={__category__:"Base Julia features",EnzymeForward:3.610692841334273,EnzymeReverse:2.834318597820535,FiniteDifferences:32.4681511608202,ForwardDiff:"error",MooncakeForward:"error",MooncakeReverse:"error",ReverseDiff:"error",ReverseDiffCompiled:"error",Zygote:"error"},ba={__category__:"Base Julia features",EnzymeForward:3.1122191425534167,EnzymeReverse:2.9777487004074783,FiniteDifferences:41.088539629484764,ForwardDiff:1.6885272028208855,MooncakeForward:21.172274516515493,MooncakeReverse:6.983080965941978,ReverseDiff:23.02235684407904,ReverseDiffCompiled:"wrong",Zygote:1998.603681588524},ya={assume_beta:Di,assume_dirichlet:Ri,demo_assume_dot_observe:Mi,demo_assume_dot_observe_literal:xi,demo_assume_index_observe:Ti,demo_assume_matrix_observe_matrix_index:Si,demo_assume_multivariate_observe:Fi,demo_assume_multivariate_observe_literal:Ni,demo_assume_observe_literal:Ci,demo_assume_submodel_observe_index_literal:Ai,demo_dot_assume_observe:ki,demo_dot_assume_observe_index:Oi,assume_lkjcholu:Ii,demo_dot_assume_observe_index_literal:Li,demo_dot_assume_observe_matrix_index:Pi,demo_dot_assume_observe_submodel:zi,dot_assume:Vi,dot_observe:Bi,dppl_gauss_unknown:ji,dppl_hier_poisson:Ui,dppl_high_dim_gauss:$i,dppl_hmm_semisup:qi,dppl_lda:Hi,assume_mvnormal:Ki,dppl_logistic_regression:Zi,dppl_naive_bayes:Gi,dppl_sto_volatility:Wi,dynamic_constraint:Xi,metabayesian_MH:Ji,multiple_constraints_same_var:Yi,multithreaded:Qi,n010:ea,n050:na,n100:ta,assume_normal:ra,n500:oa,observe_bernoulli:sa,observe_categorical:ia,observe_index:aa,observe_literal:la,observe_multivariate:ca,observe_submodel:fa,observe_von_mises:ua,ordinary_diffeq:da,pdb_eight_schools_centered:_a,assume_submodel:ma,pdb_eight_schools_noncentered:pa,assume_wishart:va,broadcast_macro:ga,call_C:ha,control_flow:ba},wa=`@model function assume_beta()
    a ~ Beta(2, 2)
end
